...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	276040ef          	jal	ra,ffffffffc02042c4 <memset>
...
ffffffffc0200072:	53a030ef          	jal	ra,ffffffffc02035ac <vmm_init>
...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	52b030ef          	jal	ra,ffffffffc0203ddc <vprintfmt>
    return cnt;
}
...
ffffffffc02000e4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e6:	4f7030ef          	jal	ra,ffffffffc0203ddc <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	24050513          	addi	a0,a0,576 # ffffffffc0204348 <etext+0x5a>
void print_kerninfo(void) {
...
ffffffffc0200122:	24a50513          	addi	a0,a0,586 # ffffffffc0204368 <etext+0x7a>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	1c458593          	addi	a1,a1,452 # ffffffffc02042ee <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	25650513          	addi	a0,a0,598 # ffffffffc0204388 <etext+0x9a>
...
ffffffffc020014a:	26250513          	addi	a0,a0,610 # ffffffffc02043a8 <etext+0xba>
...
ffffffffc020015e:	26e50513          	addi	a0,a0,622 # ffffffffc02043c8 <etext+0xda>
...
ffffffffc020018c:	26050513          	addi	a0,a0,608 # ffffffffc02043e8 <etext+0xfa>
}
...
ffffffffc020019c:	18060613          	addi	a2,a2,384 # ffffffffc0204318 <etext+0x2a>
ffffffffc02001a0:	04e00593          	li	a1,78
ffffffffc02001a4:	00004517          	auipc	a0,0x4
ffffffffc02001a8:	18c50513          	addi	a0,a0,396 # ffffffffc0204330 <etext+0x42>
void print_stackframe(void) {
...
ffffffffc02001b8:	33c60613          	addi	a2,a2,828 # ffffffffc02044f0 <commands+0xd8>
ffffffffc02001bc:	00004597          	auipc	a1,0x4
ffffffffc02001c0:	35458593          	addi	a1,a1,852 # ffffffffc0204510 <commands+0xf8>
ffffffffc02001c4:	00004517          	auipc	a0,0x4
ffffffffc02001c8:	35450513          	addi	a0,a0,852 # ffffffffc0204518 <commands+0x100>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d6:	35660613          	addi	a2,a2,854 # ffffffffc0204528 <commands+0x110>
ffffffffc02001da:	00004597          	auipc	a1,0x4
ffffffffc02001de:	37658593          	addi	a1,a1,886 # ffffffffc0204550 <commands+0x138>
ffffffffc02001e2:	00004517          	auipc	a0,0x4
ffffffffc02001e6:	33650513          	addi	a0,a0,822 # ffffffffc0204518 <commands+0x100>
ffffffffc02001ea:	ed5ff0ef          	jal	ra,ffffffffc02000be <cprintf>
ffffffffc02001ee:	00004617          	auipc	a2,0x4
ffffffffc02001f2:	37260613          	addi	a2,a2,882 # ffffffffc0204560 <commands+0x148>
ffffffffc02001f6:	00004597          	auipc	a1,0x4
ffffffffc02001fa:	38a58593          	addi	a1,a1,906 # ffffffffc0204580 <commands+0x168>
ffffffffc02001fe:	00004517          	auipc	a0,0x4
ffffffffc0200202:	31a50513          	addi	a0,a0,794 # ffffffffc0204518 <commands+0x100>
...
ffffffffc020023c:	22850513          	addi	a0,a0,552 # ffffffffc0204460 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020025e:	22e50513          	addi	a0,a0,558 # ffffffffc0204488 <commands+0x70>
...
ffffffffc0200274:	1a8c8c93          	addi	s9,s9,424 # ffffffffc0204418 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200278:	00005997          	auipc	s3,0x5
ffffffffc020027c:	73898993          	addi	s3,s3,1848 # ffffffffc02059b0 <default_pmm_manager+0x990>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200280:	00004917          	auipc	s2,0x4
ffffffffc0200284:	23090913          	addi	s2,s2,560 # ffffffffc02044b0 <commands+0x98>
        if (argc == MAXARGS - 1) {
ffffffffc0200288:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020028a:	00004b17          	auipc	s6,0x4
ffffffffc020028e:	22eb0b13          	addi	s6,s6,558 # ffffffffc02044b8 <commands+0xa0>
    if (argc == 0) {
ffffffffc0200292:	00004a97          	auipc	s5,0x4
ffffffffc0200296:	27ea8a93          	addi	s5,s5,638 # ffffffffc0204510 <commands+0xf8>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc020029a:	4b8d                	li	s7,3
        if ((buf = readline("")) != NULL) {
ffffffffc020029c:	854e                	mv	a0,s3
ffffffffc020029e:	6cb030ef          	jal	ra,ffffffffc0204168 <readline>
...
ffffffffc02002b0:	7f7030ef          	jal	ra,ffffffffc02042a6 <strchr>
...
ffffffffc02002ca:	152d0d13          	addi	s10,s10,338 # ffffffffc0204418 <commands>
    if (argc == 0) {
...
ffffffffc02002d4:	7a9030ef          	jal	ra,ffffffffc020427c <strcmp>
...
ffffffffc02002e8:	795030ef          	jal	ra,ffffffffc020427c <strcmp>
...
ffffffffc020034e:	759030ef          	jal	ra,ffffffffc02042a6 <strchr>
...
ffffffffc020036a:	17250513          	addi	a0,a0,370 # ffffffffc02044d8 <commands+0xc0>
...
ffffffffc02003aa:	1ea50513          	addi	a0,a0,490 # ffffffffc0204590 <commands+0x178>
    va_start(ap, fmt);
...
ffffffffc02003c0:	14c50513          	addi	a0,a0,332 # ffffffffc0205508 <default_pmm_manager+0x4e8>
...
ffffffffc02003fe:	1b650513          	addi	a0,a0,438 # ffffffffc02045b0 <commands+0x198>
    ticks = 0;
...
ffffffffc02004c0:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004c2:	615030ef          	jal	ra,ffffffffc02042d6 <memcpy>
    return 0;
}
...
ffffffffc02004e6:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004e8:	5ef030ef          	jal	ra,ffffffffc02042d6 <memcpy>
    return 0;
}
...
ffffffffc0200534:	37850513          	addi	a0,a0,888 # ffffffffc02048a8 <commands+0x490>
...
ffffffffc0200554:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200556:	5940306f          	j	ffffffffc0203aea <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020055a:	00004617          	auipc	a2,0x4
ffffffffc020055e:	36e60613          	addi	a2,a2,878 # ffffffffc02048c8 <commands+0x4b0>
ffffffffc0200562:	07800593          	li	a1,120
ffffffffc0200566:	00004517          	auipc	a0,0x4
ffffffffc020056a:	37a50513          	addi	a0,a0,890 # ffffffffc02048e0 <commands+0x4c8>
...
ffffffffc020059c:	36050513          	addi	a0,a0,864 # ffffffffc02048f8 <commands+0x4e0>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200742:	48a50513          	addi	a0,a0,1162 # ffffffffc0204bc8 <commands+0x7b0>
...
ffffffffc0200754:	49050513          	addi	a0,a0,1168 # ffffffffc0204be0 <commands+0x7c8>
}
...
ffffffffc020076a:	49250513          	addi	a0,a0,1170 # ffffffffc0204bf8 <commands+0x7e0>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200782:	49250513          	addi	a0,a0,1170 # ffffffffc0204c10 <commands+0x7f8>
ffffffffc0200786:	939ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020078a:	10843583          	ld	a1,264(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	49a50513          	addi	a0,a0,1178 # ffffffffc0204c28 <commands+0x810>
...
ffffffffc02007a2:	4a250513          	addi	a0,a0,1186 # ffffffffc0204c40 <commands+0x828>
...
ffffffffc02007b6:	4a650513          	addi	a0,a0,1190 # ffffffffc0204c58 <commands+0x840>
}
...
ffffffffc02007d4:	dfc70713          	addi	a4,a4,-516 # ffffffffc02045cc <commands+0x1b4>
...
ffffffffc02007e6:	07650513          	addi	a0,a0,118 # ffffffffc0204858 <commands+0x440>
ffffffffc02007ea:	8d5ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007ee:	00004517          	auipc	a0,0x4
ffffffffc02007f2:	04a50513          	addi	a0,a0,74 # ffffffffc0204838 <commands+0x420>
ffffffffc02007f6:	8c9ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007fa:	00004517          	auipc	a0,0x4
ffffffffc02007fe:	ffe50513          	addi	a0,a0,-2 # ffffffffc02047f8 <commands+0x3e0>
ffffffffc0200802:	8bdff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200806:	00004517          	auipc	a0,0x4
ffffffffc020080a:	01250513          	addi	a0,a0,18 # ffffffffc0204818 <commands+0x400>
...
ffffffffc0200816:	07650513          	addi	a0,a0,118 # ffffffffc0204888 <commands+0x470>
...
ffffffffc0200858:	02450513          	addi	a0,a0,36 # ffffffffc0204878 <commands+0x460>
}
...
ffffffffc0200870:	d9070713          	addi	a4,a4,-624 # ffffffffc02045fc <commands+0x1e4>
...
ffffffffc020088c:	f5850513          	addi	a0,a0,-168 # ffffffffc02047e0 <commands+0x3c8>
...
ffffffffc02008ae:	d9650513          	addi	a0,a0,-618 # ffffffffc0204640 <commands+0x228>
}
...
ffffffffc0200908:	ddc60613          	addi	a2,a2,-548 # ffffffffc02046e0 <commands+0x2c8>
ffffffffc020090c:	0ca00593          	li	a1,202
ffffffffc0200910:	00004517          	auipc	a0,0x4
ffffffffc0200914:	fd050513          	addi	a0,a0,-48 # ffffffffc02048e0 <commands+0x4c8>
ffffffffc0200918:	a5dff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc020091c:	00004517          	auipc	a0,0x4
ffffffffc0200920:	de450513          	addi	a0,a0,-540 # ffffffffc0204700 <commands+0x2e8>
ffffffffc0200924:	b779                	j	ffffffffc02008b2 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200926:	00004517          	auipc	a0,0x4
ffffffffc020092a:	df250513          	addi	a0,a0,-526 # ffffffffc0204718 <commands+0x300>
...
ffffffffc02009b2:	d3260613          	addi	a2,a2,-718 # ffffffffc02046e0 <commands+0x2c8>
ffffffffc02009b6:	0ea00593          	li	a1,234
ffffffffc02009ba:	00004517          	auipc	a0,0x4
ffffffffc02009be:	f2650513          	addi	a0,a0,-218 # ffffffffc02048e0 <commands+0x4c8>
...
ffffffffc02009e2:	d0260613          	addi	a2,a2,-766 # ffffffffc02046e0 <commands+0x2c8>
ffffffffc02009e6:	0f100593          	li	a1,241
ffffffffc02009ea:	00004517          	auipc	a0,0x4
ffffffffc02009ee:	ef650513          	addi	a0,a0,-266 # ffffffffc02048e0 <commands+0x4c8>
...
ffffffffc0200b9a:	0da70713          	addi	a4,a4,218 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0200bae:	55668693          	addi	a3,a3,1366 # ffffffffc0206100 <nbase>
...
ffffffffc0200e38:	e4468693          	addi	a3,a3,-444 # ffffffffc0204c78 <commands+0x860>
ffffffffc0200e3c:	00004617          	auipc	a2,0x4
ffffffffc0200e40:	e4c60613          	addi	a2,a2,-436 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200e44:	0f000593          	li	a1,240
ffffffffc0200e48:	00004517          	auipc	a0,0x4
ffffffffc0200e4c:	e5850513          	addi	a0,a0,-424 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200e50:	d24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e54:	00004697          	auipc	a3,0x4
ffffffffc0200e58:	ee468693          	addi	a3,a3,-284 # ffffffffc0204d38 <commands+0x920>
ffffffffc0200e5c:	00004617          	auipc	a2,0x4
ffffffffc0200e60:	e2c60613          	addi	a2,a2,-468 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200e64:	0bd00593          	li	a1,189
ffffffffc0200e68:	00004517          	auipc	a0,0x4
ffffffffc0200e6c:	e3850513          	addi	a0,a0,-456 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200e70:	d04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e74:	00004697          	auipc	a3,0x4
ffffffffc0200e78:	eec68693          	addi	a3,a3,-276 # ffffffffc0204d60 <commands+0x948>
ffffffffc0200e7c:	00004617          	auipc	a2,0x4
ffffffffc0200e80:	e0c60613          	addi	a2,a2,-500 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200e84:	0be00593          	li	a1,190
ffffffffc0200e88:	00004517          	auipc	a0,0x4
ffffffffc0200e8c:	e1850513          	addi	a0,a0,-488 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200e90:	ce4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e94:	00004697          	auipc	a3,0x4
ffffffffc0200e98:	f0c68693          	addi	a3,a3,-244 # ffffffffc0204da0 <commands+0x988>
ffffffffc0200e9c:	00004617          	auipc	a2,0x4
ffffffffc0200ea0:	dec60613          	addi	a2,a2,-532 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200ea4:	0c000593          	li	a1,192
ffffffffc0200ea8:	00004517          	auipc	a0,0x4
ffffffffc0200eac:	df850513          	addi	a0,a0,-520 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200eb0:	cc4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200eb4:	00004697          	auipc	a3,0x4
ffffffffc0200eb8:	f7468693          	addi	a3,a3,-140 # ffffffffc0204e28 <commands+0xa10>
ffffffffc0200ebc:	00004617          	auipc	a2,0x4
ffffffffc0200ec0:	dcc60613          	addi	a2,a2,-564 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200ec4:	0d900593          	li	a1,217
ffffffffc0200ec8:	00004517          	auipc	a0,0x4
ffffffffc0200ecc:	dd850513          	addi	a0,a0,-552 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200ed0:	ca4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200ed4:	00004697          	auipc	a3,0x4
ffffffffc0200ed8:	e0468693          	addi	a3,a3,-508 # ffffffffc0204cd8 <commands+0x8c0>
ffffffffc0200edc:	00004617          	auipc	a2,0x4
ffffffffc0200ee0:	dac60613          	addi	a2,a2,-596 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200ee4:	0d200593          	li	a1,210
ffffffffc0200ee8:	00004517          	auipc	a0,0x4
ffffffffc0200eec:	db850513          	addi	a0,a0,-584 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200ef0:	c84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200ef4:	00004697          	auipc	a3,0x4
ffffffffc0200ef8:	f2468693          	addi	a3,a3,-220 # ffffffffc0204e18 <commands+0xa00>
ffffffffc0200efc:	00004617          	auipc	a2,0x4
ffffffffc0200f00:	d8c60613          	addi	a2,a2,-628 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200f04:	0d000593          	li	a1,208
ffffffffc0200f08:	00004517          	auipc	a0,0x4
ffffffffc0200f0c:	d9850513          	addi	a0,a0,-616 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200f10:	c64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f14:	00004697          	auipc	a3,0x4
ffffffffc0200f18:	eec68693          	addi	a3,a3,-276 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc0200f1c:	00004617          	auipc	a2,0x4
ffffffffc0200f20:	d6c60613          	addi	a2,a2,-660 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200f24:	0cb00593          	li	a1,203
ffffffffc0200f28:	00004517          	auipc	a0,0x4
ffffffffc0200f2c:	d7850513          	addi	a0,a0,-648 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200f30:	c44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f34:	00004697          	auipc	a3,0x4
ffffffffc0200f38:	eac68693          	addi	a3,a3,-340 # ffffffffc0204de0 <commands+0x9c8>
ffffffffc0200f3c:	00004617          	auipc	a2,0x4
ffffffffc0200f40:	d4c60613          	addi	a2,a2,-692 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200f44:	0c200593          	li	a1,194
ffffffffc0200f48:	00004517          	auipc	a0,0x4
ffffffffc0200f4c:	d5850513          	addi	a0,a0,-680 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200f50:	c24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200f54:	00004697          	auipc	a3,0x4
ffffffffc0200f58:	f1c68693          	addi	a3,a3,-228 # ffffffffc0204e70 <commands+0xa58>
ffffffffc0200f5c:	00004617          	auipc	a2,0x4
ffffffffc0200f60:	d2c60613          	addi	a2,a2,-724 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200f64:	0f800593          	li	a1,248
ffffffffc0200f68:	00004517          	auipc	a0,0x4
ffffffffc0200f6c:	d3850513          	addi	a0,a0,-712 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200f70:	c04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f74:	00004697          	auipc	a3,0x4
ffffffffc0200f78:	eec68693          	addi	a3,a3,-276 # ffffffffc0204e60 <commands+0xa48>
ffffffffc0200f7c:	00004617          	auipc	a2,0x4
ffffffffc0200f80:	d0c60613          	addi	a2,a2,-756 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200f84:	0df00593          	li	a1,223
ffffffffc0200f88:	00004517          	auipc	a0,0x4
ffffffffc0200f8c:	d1850513          	addi	a0,a0,-744 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200f90:	be4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f94:	00004697          	auipc	a3,0x4
ffffffffc0200f98:	e6c68693          	addi	a3,a3,-404 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc0200f9c:	00004617          	auipc	a2,0x4
ffffffffc0200fa0:	cec60613          	addi	a2,a2,-788 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200fa4:	0dd00593          	li	a1,221
ffffffffc0200fa8:	00004517          	auipc	a0,0x4
ffffffffc0200fac:	cf850513          	addi	a0,a0,-776 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200fb0:	bc4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200fb4:	00004697          	auipc	a3,0x4
ffffffffc0200fb8:	e8c68693          	addi	a3,a3,-372 # ffffffffc0204e40 <commands+0xa28>
ffffffffc0200fbc:	00004617          	auipc	a2,0x4
ffffffffc0200fc0:	ccc60613          	addi	a2,a2,-820 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200fc4:	0dc00593          	li	a1,220
ffffffffc0200fc8:	00004517          	auipc	a0,0x4
ffffffffc0200fcc:	cd850513          	addi	a0,a0,-808 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200fd0:	ba4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200fd4:	00004697          	auipc	a3,0x4
ffffffffc0200fd8:	d0468693          	addi	a3,a3,-764 # ffffffffc0204cd8 <commands+0x8c0>
ffffffffc0200fdc:	00004617          	auipc	a2,0x4
ffffffffc0200fe0:	cac60613          	addi	a2,a2,-852 # ffffffffc0204c88 <commands+0x870>
ffffffffc0200fe4:	0b900593          	li	a1,185
ffffffffc0200fe8:	00004517          	auipc	a0,0x4
ffffffffc0200fec:	cb850513          	addi	a0,a0,-840 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0200ff0:	b84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ff4:	00004697          	auipc	a3,0x4
ffffffffc0200ff8:	e0c68693          	addi	a3,a3,-500 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc0200ffc:	00004617          	auipc	a2,0x4
ffffffffc0201000:	c8c60613          	addi	a2,a2,-884 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201004:	0d600593          	li	a1,214
ffffffffc0201008:	00004517          	auipc	a0,0x4
ffffffffc020100c:	c9850513          	addi	a0,a0,-872 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201010:	b64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201014:	00004697          	auipc	a3,0x4
ffffffffc0201018:	d0468693          	addi	a3,a3,-764 # ffffffffc0204d18 <commands+0x900>
ffffffffc020101c:	00004617          	auipc	a2,0x4
ffffffffc0201020:	c6c60613          	addi	a2,a2,-916 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201024:	0d400593          	li	a1,212
ffffffffc0201028:	00004517          	auipc	a0,0x4
ffffffffc020102c:	c7850513          	addi	a0,a0,-904 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201030:	b44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201034:	00004697          	auipc	a3,0x4
ffffffffc0201038:	cc468693          	addi	a3,a3,-828 # ffffffffc0204cf8 <commands+0x8e0>
ffffffffc020103c:	00004617          	auipc	a2,0x4
ffffffffc0201040:	c4c60613          	addi	a2,a2,-948 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201044:	0d300593          	li	a1,211
ffffffffc0201048:	00004517          	auipc	a0,0x4
ffffffffc020104c:	c5850513          	addi	a0,a0,-936 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201050:	b24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201054:	00004697          	auipc	a3,0x4
ffffffffc0201058:	cc468693          	addi	a3,a3,-828 # ffffffffc0204d18 <commands+0x900>
ffffffffc020105c:	00004617          	auipc	a2,0x4
ffffffffc0201060:	c2c60613          	addi	a2,a2,-980 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201064:	0bb00593          	li	a1,187
ffffffffc0201068:	00004517          	auipc	a0,0x4
ffffffffc020106c:	c3850513          	addi	a0,a0,-968 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201070:	b04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201074:	00004697          	auipc	a3,0x4
ffffffffc0201078:	f4c68693          	addi	a3,a3,-180 # ffffffffc0204fc0 <commands+0xba8>
ffffffffc020107c:	00004617          	auipc	a2,0x4
ffffffffc0201080:	c0c60613          	addi	a2,a2,-1012 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201084:	12500593          	li	a1,293
ffffffffc0201088:	00004517          	auipc	a0,0x4
ffffffffc020108c:	c1850513          	addi	a0,a0,-1000 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201090:	ae4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201094:	00004697          	auipc	a3,0x4
ffffffffc0201098:	dcc68693          	addi	a3,a3,-564 # ffffffffc0204e60 <commands+0xa48>
ffffffffc020109c:	00004617          	auipc	a2,0x4
ffffffffc02010a0:	bec60613          	addi	a2,a2,-1044 # ffffffffc0204c88 <commands+0x870>
ffffffffc02010a4:	11a00593          	li	a1,282
ffffffffc02010a8:	00004517          	auipc	a0,0x4
ffffffffc02010ac:	bf850513          	addi	a0,a0,-1032 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02010b0:	ac4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010b4:	00004697          	auipc	a3,0x4
ffffffffc02010b8:	d4c68693          	addi	a3,a3,-692 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc02010bc:	00004617          	auipc	a2,0x4
ffffffffc02010c0:	bcc60613          	addi	a2,a2,-1076 # ffffffffc0204c88 <commands+0x870>
ffffffffc02010c4:	11800593          	li	a1,280
ffffffffc02010c8:	00004517          	auipc	a0,0x4
ffffffffc02010cc:	bd850513          	addi	a0,a0,-1064 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02010d0:	aa4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02010d4:	00004697          	auipc	a3,0x4
ffffffffc02010d8:	cec68693          	addi	a3,a3,-788 # ffffffffc0204dc0 <commands+0x9a8>
ffffffffc02010dc:	00004617          	auipc	a2,0x4
ffffffffc02010e0:	bac60613          	addi	a2,a2,-1108 # ffffffffc0204c88 <commands+0x870>
ffffffffc02010e4:	0c100593          	li	a1,193
ffffffffc02010e8:	00004517          	auipc	a0,0x4
ffffffffc02010ec:	bb850513          	addi	a0,a0,-1096 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02010f0:	a84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02010f4:	00004697          	auipc	a3,0x4
ffffffffc02010f8:	e8c68693          	addi	a3,a3,-372 # ffffffffc0204f80 <commands+0xb68>
ffffffffc02010fc:	00004617          	auipc	a2,0x4
ffffffffc0201100:	b8c60613          	addi	a2,a2,-1140 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201104:	11200593          	li	a1,274
ffffffffc0201108:	00004517          	auipc	a0,0x4
ffffffffc020110c:	b9850513          	addi	a0,a0,-1128 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201110:	a64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201114:	00004697          	auipc	a3,0x4
ffffffffc0201118:	e4c68693          	addi	a3,a3,-436 # ffffffffc0204f60 <commands+0xb48>
ffffffffc020111c:	00004617          	auipc	a2,0x4
ffffffffc0201120:	b6c60613          	addi	a2,a2,-1172 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201124:	11000593          	li	a1,272
ffffffffc0201128:	00004517          	auipc	a0,0x4
ffffffffc020112c:	b7850513          	addi	a0,a0,-1160 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201130:	a44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201134:	00004697          	auipc	a3,0x4
ffffffffc0201138:	e0468693          	addi	a3,a3,-508 # ffffffffc0204f38 <commands+0xb20>
ffffffffc020113c:	00004617          	auipc	a2,0x4
ffffffffc0201140:	b4c60613          	addi	a2,a2,-1204 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201144:	10e00593          	li	a1,270
ffffffffc0201148:	00004517          	auipc	a0,0x4
ffffffffc020114c:	b5850513          	addi	a0,a0,-1192 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201150:	a24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201154:	00004697          	auipc	a3,0x4
ffffffffc0201158:	dbc68693          	addi	a3,a3,-580 # ffffffffc0204f10 <commands+0xaf8>
ffffffffc020115c:	00004617          	auipc	a2,0x4
ffffffffc0201160:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201164:	10d00593          	li	a1,269
ffffffffc0201168:	00004517          	auipc	a0,0x4
ffffffffc020116c:	b3850513          	addi	a0,a0,-1224 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201170:	a04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201174:	00004697          	auipc	a3,0x4
ffffffffc0201178:	d8c68693          	addi	a3,a3,-628 # ffffffffc0204f00 <commands+0xae8>
ffffffffc020117c:	00004617          	auipc	a2,0x4
ffffffffc0201180:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201184:	10800593          	li	a1,264
ffffffffc0201188:	00004517          	auipc	a0,0x4
ffffffffc020118c:	b1850513          	addi	a0,a0,-1256 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201190:	9e4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201194:	00004697          	auipc	a3,0x4
ffffffffc0201198:	c6c68693          	addi	a3,a3,-916 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc020119c:	00004617          	auipc	a2,0x4
ffffffffc02011a0:	aec60613          	addi	a2,a2,-1300 # ffffffffc0204c88 <commands+0x870>
ffffffffc02011a4:	10700593          	li	a1,263
ffffffffc02011a8:	00004517          	auipc	a0,0x4
ffffffffc02011ac:	af850513          	addi	a0,a0,-1288 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02011b0:	9c4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011b4:	00004697          	auipc	a3,0x4
ffffffffc02011b8:	d2c68693          	addi	a3,a3,-724 # ffffffffc0204ee0 <commands+0xac8>
ffffffffc02011bc:	00004617          	auipc	a2,0x4
ffffffffc02011c0:	acc60613          	addi	a2,a2,-1332 # ffffffffc0204c88 <commands+0x870>
ffffffffc02011c4:	10600593          	li	a1,262
ffffffffc02011c8:	00004517          	auipc	a0,0x4
ffffffffc02011cc:	ad850513          	addi	a0,a0,-1320 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02011d0:	9a4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02011d4:	00004697          	auipc	a3,0x4
ffffffffc02011d8:	cdc68693          	addi	a3,a3,-804 # ffffffffc0204eb0 <commands+0xa98>
ffffffffc02011dc:	00004617          	auipc	a2,0x4
ffffffffc02011e0:	aac60613          	addi	a2,a2,-1364 # ffffffffc0204c88 <commands+0x870>
ffffffffc02011e4:	10500593          	li	a1,261
ffffffffc02011e8:	00004517          	auipc	a0,0x4
ffffffffc02011ec:	ab850513          	addi	a0,a0,-1352 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02011f0:	984ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02011f4:	00004697          	auipc	a3,0x4
ffffffffc02011f8:	ca468693          	addi	a3,a3,-860 # ffffffffc0204e98 <commands+0xa80>
ffffffffc02011fc:	00004617          	auipc	a2,0x4
ffffffffc0201200:	a8c60613          	addi	a2,a2,-1396 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201204:	10400593          	li	a1,260
ffffffffc0201208:	00004517          	auipc	a0,0x4
ffffffffc020120c:	a9850513          	addi	a0,a0,-1384 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201210:	964ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201214:	00004697          	auipc	a3,0x4
ffffffffc0201218:	bec68693          	addi	a3,a3,-1044 # ffffffffc0204e00 <commands+0x9e8>
ffffffffc020121c:	00004617          	auipc	a2,0x4
ffffffffc0201220:	a6c60613          	addi	a2,a2,-1428 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201224:	0fe00593          	li	a1,254
ffffffffc0201228:	00004517          	auipc	a0,0x4
ffffffffc020122c:	a7850513          	addi	a0,a0,-1416 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201230:	944ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201234:	00004697          	auipc	a3,0x4
ffffffffc0201238:	c4c68693          	addi	a3,a3,-948 # ffffffffc0204e80 <commands+0xa68>
ffffffffc020123c:	00004617          	auipc	a2,0x4
ffffffffc0201240:	a4c60613          	addi	a2,a2,-1460 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201244:	0f900593          	li	a1,249
ffffffffc0201248:	00004517          	auipc	a0,0x4
ffffffffc020124c:	a5850513          	addi	a0,a0,-1448 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201250:	924ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201254:	00004697          	auipc	a3,0x4
ffffffffc0201258:	d4c68693          	addi	a3,a3,-692 # ffffffffc0204fa0 <commands+0xb88>
ffffffffc020125c:	00004617          	auipc	a2,0x4
ffffffffc0201260:	a2c60613          	addi	a2,a2,-1492 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201264:	11700593          	li	a1,279
ffffffffc0201268:	00004517          	auipc	a0,0x4
ffffffffc020126c:	a3850513          	addi	a0,a0,-1480 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201270:	904ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201274:	00004697          	auipc	a3,0x4
ffffffffc0201278:	d5c68693          	addi	a3,a3,-676 # ffffffffc0204fd0 <commands+0xbb8>
ffffffffc020127c:	00004617          	auipc	a2,0x4
ffffffffc0201280:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201284:	12600593          	li	a1,294
ffffffffc0201288:	00004517          	auipc	a0,0x4
ffffffffc020128c:	a1850513          	addi	a0,a0,-1512 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201290:	8e4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201294:	00004697          	auipc	a3,0x4
ffffffffc0201298:	a2468693          	addi	a3,a3,-1500 # ffffffffc0204cb8 <commands+0x8a0>
ffffffffc020129c:	00004617          	auipc	a2,0x4
ffffffffc02012a0:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0204c88 <commands+0x870>
ffffffffc02012a4:	0f300593          	li	a1,243
ffffffffc02012a8:	00004517          	auipc	a0,0x4
ffffffffc02012ac:	9f850513          	addi	a0,a0,-1544 # ffffffffc0204ca0 <commands+0x888>
ffffffffc02012b0:	8c4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012b4:	00004697          	auipc	a3,0x4
ffffffffc02012b8:	a4468693          	addi	a3,a3,-1468 # ffffffffc0204cf8 <commands+0x8e0>
ffffffffc02012bc:	00004617          	auipc	a2,0x4
ffffffffc02012c0:	9cc60613          	addi	a2,a2,-1588 # ffffffffc0204c88 <commands+0x870>
ffffffffc02012c4:	0ba00593          	li	a1,186
ffffffffc02012c8:	00004517          	auipc	a0,0x4
ffffffffc02012cc:	9d850513          	addi	a0,a0,-1576 # ffffffffc0204ca0 <commands+0x888>
...
ffffffffc020143c:	ba868693          	addi	a3,a3,-1112 # ffffffffc0204fe0 <commands+0xbc8>
ffffffffc0201440:	00004617          	auipc	a2,0x4
ffffffffc0201444:	84860613          	addi	a2,a2,-1976 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201448:	08300593          	li	a1,131
ffffffffc020144c:	00004517          	auipc	a0,0x4
ffffffffc0201450:	85450513          	addi	a0,a0,-1964 # ffffffffc0204ca0 <commands+0x888>
ffffffffc0201454:	f21fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201458:	00004697          	auipc	a3,0x4
ffffffffc020145c:	bb068693          	addi	a3,a3,-1104 # ffffffffc0205008 <commands+0xbf0>
ffffffffc0201460:	00004617          	auipc	a2,0x4
ffffffffc0201464:	82860613          	addi	a2,a2,-2008 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201468:	08000593          	li	a1,128
ffffffffc020146c:	00004517          	auipc	a0,0x4
ffffffffc0201470:	83450513          	addi	a0,a0,-1996 # ffffffffc0204ca0 <commands+0x888>
...
ffffffffc020151a:	af268693          	addi	a3,a3,-1294 # ffffffffc0205008 <commands+0xbf0>
ffffffffc020151e:	00003617          	auipc	a2,0x3
ffffffffc0201522:	76a60613          	addi	a2,a2,1898 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201526:	06200593          	li	a1,98
ffffffffc020152a:	00003517          	auipc	a0,0x3
ffffffffc020152e:	77650513          	addi	a0,a0,1910 # ffffffffc0204ca0 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc0201606:	a0e68693          	addi	a3,a3,-1522 # ffffffffc0205010 <commands+0xbf8>
ffffffffc020160a:	00003617          	auipc	a2,0x3
ffffffffc020160e:	67e60613          	addi	a2,a2,1662 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201612:	04900593          	li	a1,73
ffffffffc0201616:	00003517          	auipc	a0,0x3
ffffffffc020161a:	68a50513          	addi	a0,a0,1674 # ffffffffc0204ca0 <commands+0x888>
ffffffffc020161e:	d57fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201622:	00004697          	auipc	a3,0x4
ffffffffc0201626:	9e668693          	addi	a3,a3,-1562 # ffffffffc0205008 <commands+0xbf0>
ffffffffc020162a:	00003617          	auipc	a2,0x3
ffffffffc020162e:	65e60613          	addi	a2,a2,1630 # ffffffffc0204c88 <commands+0x870>
ffffffffc0201632:	04600593          	li	a1,70
ffffffffc0201636:	00003517          	auipc	a0,0x3
ffffffffc020163a:	66a50513          	addi	a0,a0,1642 # ffffffffc0204ca0 <commands+0x888>
...
ffffffffc0201648:	aa460613          	addi	a2,a2,-1372 # ffffffffc02050e8 <default_pmm_manager+0xc8>
ffffffffc020164c:	06500593          	li	a1,101
ffffffffc0201650:	00004517          	auipc	a0,0x4
ffffffffc0201654:	ab850513          	addi	a0,a0,-1352 # ffffffffc0205108 <default_pmm_manager+0xe8>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02017c0:	4b478793          	addi	a5,a5,1204 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0201804:	2c1020ef          	jal	ra,ffffffffc02042c4 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201874:	40078793          	addi	a5,a5,1024 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc02018aa:	21b020ef          	jal	ra,ffffffffc02042c4 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc020190a:	76a60613          	addi	a2,a2,1898 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc020190e:	10200593          	li	a1,258
ffffffffc0201912:	00003517          	auipc	a0,0x3
ffffffffc0201916:	78650513          	addi	a0,a0,1926 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc020191a:	a5bfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc020191e:	00003617          	auipc	a2,0x3
ffffffffc0201922:	75260613          	addi	a2,a2,1874 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0201926:	10f00593          	li	a1,271
ffffffffc020192a:	00003517          	auipc	a0,0x3
ffffffffc020192e:	76e50513          	addi	a0,a0,1902 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc020193c:	73860613          	addi	a2,a2,1848 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0201940:	10b00593          	li	a1,267
ffffffffc0201944:	00003517          	auipc	a0,0x3
ffffffffc0201948:	75450513          	addi	a0,a0,1876 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0201956:	71e60613          	addi	a2,a2,1822 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc020195a:	0ff00593          	li	a1,255
ffffffffc020195e:	00003517          	auipc	a0,0x3
ffffffffc0201962:	73a50513          	addi	a0,a0,1850 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0201a80:	1f470713          	addi	a4,a4,500 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0201b1a:	50a78793          	addi	a5,a5,1290 # ffffffffc0205020 <default_pmm_manager>
...
ffffffffc0201b26:	60e50513          	addi	a0,a0,1550 # ffffffffc0205130 <default_pmm_manager+0x110>
void pmm_init(void) {
...
ffffffffc0201b84:	5c850513          	addi	a0,a0,1480 # ffffffffc0205148 <default_pmm_manager+0x128>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b98:	5e450513          	addi	a0,a0,1508 # ffffffffc0205178 <default_pmm_manager+0x158>
...
ffffffffc0201bb2:	5e250513          	addi	a0,a0,1506 # ffffffffc0205190 <default_pmm_manager+0x170>
...
ffffffffc0201c46:	59e50513          	addi	a0,a0,1438 # ffffffffc02051e0 <default_pmm_manager+0x1c0>
...
ffffffffc0201e4a:	e2aa8a93          	addi	s5,s5,-470 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0201eca:	62a50513          	addi	a0,a0,1578 # ffffffffc02054f0 <default_pmm_manager+0x4d0>
...
ffffffffc0201f76:	6b658593          	addi	a1,a1,1718 # ffffffffc0205628 <default_pmm_manager+0x608>
ffffffffc0201f7a:	10000513          	li	a0,256
ffffffffc0201f7e:	2ec020ef          	jal	ra,ffffffffc020426a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f82:	100b8593          	addi	a1,s7,256
ffffffffc0201f86:	10000513          	li	a0,256
ffffffffc0201f8a:	2f2020ef          	jal	ra,ffffffffc020427c <strcmp>
...
ffffffffc0201fc6:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fdedb68>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fca:	25c020ef          	jal	ra,ffffffffc0204226 <strlen>
...
ffffffffc0202084:	62050513          	addi	a0,a0,1568 # ffffffffc02056a0 <default_pmm_manager+0x680>
}
...
ffffffffc02020c6:	fae60613          	addi	a2,a2,-82 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc02020ca:	1cd00593          	li	a1,461
ffffffffc02020ce:	00003517          	auipc	a0,0x3
ffffffffc02020d2:	fca50513          	addi	a0,a0,-54 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02020d6:	a9efe0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc02020da:	00003697          	auipc	a3,0x3
ffffffffc02020de:	43668693          	addi	a3,a3,1078 # ffffffffc0205510 <default_pmm_manager+0x4f0>
ffffffffc02020e2:	00003617          	auipc	a2,0x3
ffffffffc02020e6:	ba660613          	addi	a2,a2,-1114 # ffffffffc0204c88 <commands+0x870>
ffffffffc02020ea:	1cd00593          	li	a1,461
ffffffffc02020ee:	00003517          	auipc	a0,0x3
ffffffffc02020f2:	faa50513          	addi	a0,a0,-86 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02020f6:	a7efe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc02020fa:	00003697          	auipc	a3,0x3
ffffffffc02020fe:	45668693          	addi	a3,a3,1110 # ffffffffc0205550 <default_pmm_manager+0x530>
ffffffffc0202102:	00003617          	auipc	a2,0x3
ffffffffc0202106:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204c88 <commands+0x870>
ffffffffc020210a:	1ce00593          	li	a1,462
ffffffffc020210e:	00003517          	auipc	a0,0x3
ffffffffc0202112:	f8a50513          	addi	a0,a0,-118 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0202122:	f5260613          	addi	a2,a2,-174 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0202126:	06a00593          	li	a1,106
ffffffffc020212a:	00003517          	auipc	a0,0x3
ffffffffc020212e:	fde50513          	addi	a0,a0,-34 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0202132:	a42fe0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202136:	00003617          	auipc	a2,0x3
ffffffffc020213a:	1aa60613          	addi	a2,a2,426 # ffffffffc02052e0 <default_pmm_manager+0x2c0>
ffffffffc020213e:	07000593          	li	a1,112
ffffffffc0202142:	00003517          	auipc	a0,0x3
ffffffffc0202146:	fc650513          	addi	a0,a0,-58 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc020214a:	a2afe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020214e:	00003697          	auipc	a3,0x3
ffffffffc0202152:	0d268693          	addi	a3,a3,210 # ffffffffc0205220 <default_pmm_manager+0x200>
ffffffffc0202156:	00003617          	auipc	a2,0x3
ffffffffc020215a:	b3260613          	addi	a2,a2,-1230 # ffffffffc0204c88 <commands+0x870>
ffffffffc020215e:	19300593          	li	a1,403
ffffffffc0202162:	00003517          	auipc	a0,0x3
ffffffffc0202166:	f3650513          	addi	a0,a0,-202 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc020216a:	a0afe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc020216e:	00003697          	auipc	a3,0x3
ffffffffc0202172:	0ea68693          	addi	a3,a3,234 # ffffffffc0205258 <default_pmm_manager+0x238>
ffffffffc0202176:	00003617          	auipc	a2,0x3
ffffffffc020217a:	b1260613          	addi	a2,a2,-1262 # ffffffffc0204c88 <commands+0x870>
ffffffffc020217e:	19400593          	li	a1,404
ffffffffc0202182:	00003517          	auipc	a0,0x3
ffffffffc0202186:	f1650513          	addi	a0,a0,-234 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc020218a:	9eafe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020218e:	00003697          	auipc	a3,0x3
ffffffffc0202192:	34268693          	addi	a3,a3,834 # ffffffffc02054d0 <default_pmm_manager+0x4b0>
ffffffffc0202196:	00003617          	auipc	a2,0x3
ffffffffc020219a:	af260613          	addi	a2,a2,-1294 # ffffffffc0204c88 <commands+0x870>
ffffffffc020219e:	1c000593          	li	a1,448
ffffffffc02021a2:	00003517          	auipc	a0,0x3
ffffffffc02021a6:	ef650513          	addi	a0,a0,-266 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02021aa:	9cafe0ef          	jal	ra,ffffffffc0200374 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02021ae:	00003617          	auipc	a2,0x3
ffffffffc02021b2:	00a60613          	addi	a2,a2,10 # ffffffffc02051b8 <default_pmm_manager+0x198>
ffffffffc02021b6:	07700593          	li	a1,119
ffffffffc02021ba:	00003517          	auipc	a0,0x3
ffffffffc02021be:	ede50513          	addi	a0,a0,-290 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02021c2:	9b2fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc02021c6:	00003697          	auipc	a3,0x3
ffffffffc02021ca:	0ea68693          	addi	a3,a3,234 # ffffffffc02052b0 <default_pmm_manager+0x290>
ffffffffc02021ce:	00003617          	auipc	a2,0x3
ffffffffc02021d2:	aba60613          	addi	a2,a2,-1350 # ffffffffc0204c88 <commands+0x870>
ffffffffc02021d6:	19a00593          	li	a1,410
ffffffffc02021da:	00003517          	auipc	a0,0x3
ffffffffc02021de:	ebe50513          	addi	a0,a0,-322 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02021e2:	992fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc02021e6:	00003697          	auipc	a3,0x3
ffffffffc02021ea:	09a68693          	addi	a3,a3,154 # ffffffffc0205280 <default_pmm_manager+0x260>
ffffffffc02021ee:	00003617          	auipc	a2,0x3
ffffffffc02021f2:	a9a60613          	addi	a2,a2,-1382 # ffffffffc0204c88 <commands+0x870>
ffffffffc02021f6:	19800593          	li	a1,408
ffffffffc02021fa:	00003517          	auipc	a0,0x3
ffffffffc02021fe:	e9e50513          	addi	a0,a0,-354 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202202:	972fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202206:	00003697          	auipc	a3,0x3
ffffffffc020220a:	1c268693          	addi	a3,a3,450 # ffffffffc02053c8 <default_pmm_manager+0x3a8>
ffffffffc020220e:	00003617          	auipc	a2,0x3
ffffffffc0202212:	a7a60613          	addi	a2,a2,-1414 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202216:	1a500593          	li	a1,421
ffffffffc020221a:	00003517          	auipc	a0,0x3
ffffffffc020221e:	e7e50513          	addi	a0,a0,-386 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202222:	952fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202226:	00003697          	auipc	a3,0x3
ffffffffc020222a:	17268693          	addi	a3,a3,370 # ffffffffc0205398 <default_pmm_manager+0x378>
ffffffffc020222e:	00003617          	auipc	a2,0x3
ffffffffc0202232:	a5a60613          	addi	a2,a2,-1446 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202236:	1a400593          	li	a1,420
ffffffffc020223a:	00003517          	auipc	a0,0x3
ffffffffc020223e:	e5e50513          	addi	a0,a0,-418 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202242:	932fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202246:	00003697          	auipc	a3,0x3
ffffffffc020224a:	11a68693          	addi	a3,a3,282 # ffffffffc0205360 <default_pmm_manager+0x340>
ffffffffc020224e:	00003617          	auipc	a2,0x3
ffffffffc0202252:	a3a60613          	addi	a2,a2,-1478 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202256:	1a300593          	li	a1,419
ffffffffc020225a:	00003517          	auipc	a0,0x3
ffffffffc020225e:	e3e50513          	addi	a0,a0,-450 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202262:	912fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202266:	00003697          	auipc	a3,0x3
ffffffffc020226a:	0d268693          	addi	a3,a3,210 # ffffffffc0205338 <default_pmm_manager+0x318>
ffffffffc020226e:	00003617          	auipc	a2,0x3
ffffffffc0202272:	a1a60613          	addi	a2,a2,-1510 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202276:	1a000593          	li	a1,416
ffffffffc020227a:	00003517          	auipc	a0,0x3
ffffffffc020227e:	e1e50513          	addi	a0,a0,-482 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc020228c:	de860613          	addi	a2,a2,-536 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0202290:	19f00593          	li	a1,415
ffffffffc0202294:	00003517          	auipc	a0,0x3
ffffffffc0202298:	e0450513          	addi	a0,a0,-508 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc02022a6:	dce60613          	addi	a2,a2,-562 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc02022aa:	19e00593          	li	a1,414
ffffffffc02022ae:	00003517          	auipc	a0,0x3
ffffffffc02022b2:	dea50513          	addi	a0,a0,-534 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02022b6:	8befe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02022ba:	00003697          	auipc	a3,0x3
ffffffffc02022be:	06668693          	addi	a3,a3,102 # ffffffffc0205320 <default_pmm_manager+0x300>
ffffffffc02022c2:	00003617          	auipc	a2,0x3
ffffffffc02022c6:	9c660613          	addi	a2,a2,-1594 # ffffffffc0204c88 <commands+0x870>
ffffffffc02022ca:	19c00593          	li	a1,412
ffffffffc02022ce:	00003517          	auipc	a0,0x3
ffffffffc02022d2:	dca50513          	addi	a0,a0,-566 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02022d6:	89efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02022da:	00003697          	auipc	a3,0x3
ffffffffc02022de:	02e68693          	addi	a3,a3,46 # ffffffffc0205308 <default_pmm_manager+0x2e8>
ffffffffc02022e2:	00003617          	auipc	a2,0x3
ffffffffc02022e6:	9a660613          	addi	a2,a2,-1626 # ffffffffc0204c88 <commands+0x870>
ffffffffc02022ea:	19b00593          	li	a1,411
ffffffffc02022ee:	00003517          	auipc	a0,0x3
ffffffffc02022f2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02022f6:	87efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02022fa:	00003697          	auipc	a3,0x3
ffffffffc02022fe:	00e68693          	addi	a3,a3,14 # ffffffffc0205308 <default_pmm_manager+0x2e8>
ffffffffc0202302:	00003617          	auipc	a2,0x3
ffffffffc0202306:	98660613          	addi	a2,a2,-1658 # ffffffffc0204c88 <commands+0x870>
ffffffffc020230a:	1ae00593          	li	a1,430
ffffffffc020230e:	00003517          	auipc	a0,0x3
ffffffffc0202312:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202316:	85efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020231a:	00003697          	auipc	a3,0x3
ffffffffc020231e:	07e68693          	addi	a3,a3,126 # ffffffffc0205398 <default_pmm_manager+0x378>
ffffffffc0202322:	00003617          	auipc	a2,0x3
ffffffffc0202326:	96660613          	addi	a2,a2,-1690 # ffffffffc0204c88 <commands+0x870>
ffffffffc020232a:	1ad00593          	li	a1,429
ffffffffc020232e:	00003517          	auipc	a0,0x3
ffffffffc0202332:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202336:	83efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020233a:	00003697          	auipc	a3,0x3
ffffffffc020233e:	12668693          	addi	a3,a3,294 # ffffffffc0205460 <default_pmm_manager+0x440>
ffffffffc0202342:	00003617          	auipc	a2,0x3
ffffffffc0202346:	94660613          	addi	a2,a2,-1722 # ffffffffc0204c88 <commands+0x870>
ffffffffc020234a:	1ac00593          	li	a1,428
ffffffffc020234e:	00003517          	auipc	a0,0x3
ffffffffc0202352:	d4a50513          	addi	a0,a0,-694 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202356:	81efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020235a:	00003697          	auipc	a3,0x3
ffffffffc020235e:	0ee68693          	addi	a3,a3,238 # ffffffffc0205448 <default_pmm_manager+0x428>
ffffffffc0202362:	00003617          	auipc	a2,0x3
ffffffffc0202366:	92660613          	addi	a2,a2,-1754 # ffffffffc0204c88 <commands+0x870>
ffffffffc020236a:	1ab00593          	li	a1,427
ffffffffc020236e:	00003517          	auipc	a0,0x3
ffffffffc0202372:	d2a50513          	addi	a0,a0,-726 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202376:	ffffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020237a:	00003697          	auipc	a3,0x3
ffffffffc020237e:	09e68693          	addi	a3,a3,158 # ffffffffc0205418 <default_pmm_manager+0x3f8>
ffffffffc0202382:	00003617          	auipc	a2,0x3
ffffffffc0202386:	90660613          	addi	a2,a2,-1786 # ffffffffc0204c88 <commands+0x870>
ffffffffc020238a:	1aa00593          	li	a1,426
ffffffffc020238e:	00003517          	auipc	a0,0x3
ffffffffc0202392:	d0a50513          	addi	a0,a0,-758 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202396:	fdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc020239a:	00003697          	auipc	a3,0x3
ffffffffc020239e:	06668693          	addi	a3,a3,102 # ffffffffc0205400 <default_pmm_manager+0x3e0>
ffffffffc02023a2:	00003617          	auipc	a2,0x3
ffffffffc02023a6:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204c88 <commands+0x870>
ffffffffc02023aa:	1a800593          	li	a1,424
ffffffffc02023ae:	00003517          	auipc	a0,0x3
ffffffffc02023b2:	cea50513          	addi	a0,a0,-790 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02023b6:	fbffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ba:	00003697          	auipc	a3,0x3
ffffffffc02023be:	02e68693          	addi	a3,a3,46 # ffffffffc02053e8 <default_pmm_manager+0x3c8>
ffffffffc02023c2:	00003617          	auipc	a2,0x3
ffffffffc02023c6:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204c88 <commands+0x870>
ffffffffc02023ca:	1a700593          	li	a1,423
ffffffffc02023ce:	00003517          	auipc	a0,0x3
ffffffffc02023d2:	cca50513          	addi	a0,a0,-822 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02023d6:	f9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02023da:	00003697          	auipc	a3,0x3
ffffffffc02023de:	ffe68693          	addi	a3,a3,-2 # ffffffffc02053d8 <default_pmm_manager+0x3b8>
ffffffffc02023e2:	00003617          	auipc	a2,0x3
ffffffffc02023e6:	8a660613          	addi	a2,a2,-1882 # ffffffffc0204c88 <commands+0x870>
ffffffffc02023ea:	1a600593          	li	a1,422
ffffffffc02023ee:	00003517          	auipc	a0,0x3
ffffffffc02023f2:	caa50513          	addi	a0,a0,-854 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02023f6:	f7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02023fa:	00003697          	auipc	a3,0x3
ffffffffc02023fe:	0d668693          	addi	a3,a3,214 # ffffffffc02054d0 <default_pmm_manager+0x4b0>
ffffffffc0202402:	00003617          	auipc	a2,0x3
ffffffffc0202406:	88660613          	addi	a2,a2,-1914 # ffffffffc0204c88 <commands+0x870>
ffffffffc020240a:	1e800593          	li	a1,488
ffffffffc020240e:	00003517          	auipc	a0,0x3
ffffffffc0202412:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202416:	f5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020241a:	00003697          	auipc	a3,0x3
ffffffffc020241e:	25e68693          	addi	a3,a3,606 # ffffffffc0205678 <default_pmm_manager+0x658>
ffffffffc0202422:	00003617          	auipc	a2,0x3
ffffffffc0202426:	86660613          	addi	a2,a2,-1946 # ffffffffc0204c88 <commands+0x870>
ffffffffc020242a:	1e000593          	li	a1,480
ffffffffc020242e:	00003517          	auipc	a0,0x3
ffffffffc0202432:	c6a50513          	addi	a0,a0,-918 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202436:	f3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020243a:	00003697          	auipc	a3,0x3
ffffffffc020243e:	20668693          	addi	a3,a3,518 # ffffffffc0205640 <default_pmm_manager+0x620>
ffffffffc0202442:	00003617          	auipc	a2,0x3
ffffffffc0202446:	84660613          	addi	a2,a2,-1978 # ffffffffc0204c88 <commands+0x870>
ffffffffc020244a:	1dd00593          	li	a1,477
ffffffffc020244e:	00003517          	auipc	a0,0x3
ffffffffc0202452:	c4a50513          	addi	a0,a0,-950 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202456:	f1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020245a:	00003697          	auipc	a3,0x3
ffffffffc020245e:	1b668693          	addi	a3,a3,438 # ffffffffc0205610 <default_pmm_manager+0x5f0>
ffffffffc0202462:	00003617          	auipc	a2,0x3
ffffffffc0202466:	82660613          	addi	a2,a2,-2010 # ffffffffc0204c88 <commands+0x870>
ffffffffc020246a:	1d900593          	li	a1,473
ffffffffc020246e:	00003517          	auipc	a0,0x3
ffffffffc0202472:	c2a50513          	addi	a0,a0,-982 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202476:	efffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc020247a:	00003697          	auipc	a3,0x3
ffffffffc020247e:	01668693          	addi	a3,a3,22 # ffffffffc0205490 <default_pmm_manager+0x470>
ffffffffc0202482:	00003617          	auipc	a2,0x3
ffffffffc0202486:	80660613          	addi	a2,a2,-2042 # ffffffffc0204c88 <commands+0x870>
ffffffffc020248a:	1b600593          	li	a1,438
ffffffffc020248e:	00003517          	auipc	a0,0x3
ffffffffc0202492:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202496:	edffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020249a:	00003697          	auipc	a3,0x3
ffffffffc020249e:	fc668693          	addi	a3,a3,-58 # ffffffffc0205460 <default_pmm_manager+0x440>
ffffffffc02024a2:	00002617          	auipc	a2,0x2
ffffffffc02024a6:	7e660613          	addi	a2,a2,2022 # ffffffffc0204c88 <commands+0x870>
ffffffffc02024aa:	1b300593          	li	a1,435
ffffffffc02024ae:	00003517          	auipc	a0,0x3
ffffffffc02024b2:	bea50513          	addi	a0,a0,-1046 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02024b6:	ebffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02024ba:	00003697          	auipc	a3,0x3
ffffffffc02024be:	e6668693          	addi	a3,a3,-410 # ffffffffc0205320 <default_pmm_manager+0x300>
ffffffffc02024c2:	00002617          	auipc	a2,0x2
ffffffffc02024c6:	7c660613          	addi	a2,a2,1990 # ffffffffc0204c88 <commands+0x870>
ffffffffc02024ca:	1b200593          	li	a1,434
ffffffffc02024ce:	00003517          	auipc	a0,0x3
ffffffffc02024d2:	bca50513          	addi	a0,a0,-1078 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02024d6:	e9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc02024da:	00003697          	auipc	a3,0x3
ffffffffc02024de:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205478 <default_pmm_manager+0x458>
ffffffffc02024e2:	00002617          	auipc	a2,0x2
ffffffffc02024e6:	7a660613          	addi	a2,a2,1958 # ffffffffc0204c88 <commands+0x870>
ffffffffc02024ea:	1af00593          	li	a1,431
ffffffffc02024ee:	00003517          	auipc	a0,0x3
ffffffffc02024f2:	baa50513          	addi	a0,a0,-1110 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02024f6:	e7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024fa:	00003697          	auipc	a3,0x3
ffffffffc02024fe:	fae68693          	addi	a3,a3,-82 # ffffffffc02054a8 <default_pmm_manager+0x488>
ffffffffc0202502:	00002617          	auipc	a2,0x2
ffffffffc0202506:	78660613          	addi	a2,a2,1926 # ffffffffc0204c88 <commands+0x870>
ffffffffc020250a:	1b900593          	li	a1,441
ffffffffc020250e:	00003517          	auipc	a0,0x3
ffffffffc0202512:	b8a50513          	addi	a0,a0,-1142 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202516:	e5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020251a:	00003697          	auipc	a3,0x3
ffffffffc020251e:	f4668693          	addi	a3,a3,-186 # ffffffffc0205460 <default_pmm_manager+0x440>
ffffffffc0202522:	00002617          	auipc	a2,0x2
ffffffffc0202526:	76660613          	addi	a2,a2,1894 # ffffffffc0204c88 <commands+0x870>
ffffffffc020252a:	1b700593          	li	a1,439
ffffffffc020252e:	00003517          	auipc	a0,0x3
ffffffffc0202532:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202536:	e3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020253a:	00003697          	auipc	a3,0x3
ffffffffc020253e:	cc668693          	addi	a3,a3,-826 # ffffffffc0205200 <default_pmm_manager+0x1e0>
ffffffffc0202542:	00002617          	auipc	a2,0x2
ffffffffc0202546:	74660613          	addi	a2,a2,1862 # ffffffffc0204c88 <commands+0x870>
ffffffffc020254a:	19200593          	li	a1,402
ffffffffc020254e:	00003517          	auipc	a0,0x3
ffffffffc0202552:	b4a50513          	addi	a0,a0,-1206 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc0202556:	e1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc020255a:	00003617          	auipc	a2,0x3
ffffffffc020255e:	c5e60613          	addi	a2,a2,-930 # ffffffffc02051b8 <default_pmm_manager+0x198>
ffffffffc0202562:	0bd00593          	li	a1,189
ffffffffc0202566:	00003517          	auipc	a0,0x3
ffffffffc020256a:	b3250513          	addi	a0,a0,-1230 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc020256e:	e07fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202572:	00003697          	auipc	a3,0x3
ffffffffc0202576:	05e68693          	addi	a3,a3,94 # ffffffffc02055d0 <default_pmm_manager+0x5b0>
ffffffffc020257a:	00002617          	auipc	a2,0x2
ffffffffc020257e:	70e60613          	addi	a2,a2,1806 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202582:	1d800593          	li	a1,472
ffffffffc0202586:	00003517          	auipc	a0,0x3
ffffffffc020258a:	b1250513          	addi	a0,a0,-1262 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc020258e:	de7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202592:	00003697          	auipc	a3,0x3
ffffffffc0202596:	02668693          	addi	a3,a3,38 # ffffffffc02055b8 <default_pmm_manager+0x598>
ffffffffc020259a:	00002617          	auipc	a2,0x2
ffffffffc020259e:	6ee60613          	addi	a2,a2,1774 # ffffffffc0204c88 <commands+0x870>
ffffffffc02025a2:	1d700593          	li	a1,471
ffffffffc02025a6:	00003517          	auipc	a0,0x3
ffffffffc02025aa:	af250513          	addi	a0,a0,-1294 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02025ae:	dc7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc02025b2:	00003697          	auipc	a3,0x3
ffffffffc02025b6:	fce68693          	addi	a3,a3,-50 # ffffffffc0205580 <default_pmm_manager+0x560>
ffffffffc02025ba:	00002617          	auipc	a2,0x2
ffffffffc02025be:	6ce60613          	addi	a2,a2,1742 # ffffffffc0204c88 <commands+0x870>
ffffffffc02025c2:	1d600593          	li	a1,470
ffffffffc02025c6:	00003517          	auipc	a0,0x3
ffffffffc02025ca:	ad250513          	addi	a0,a0,-1326 # ffffffffc0205098 <default_pmm_manager+0x78>
ffffffffc02025ce:	da7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025d2:	00003697          	auipc	a3,0x3
ffffffffc02025d6:	f9668693          	addi	a3,a3,-106 # ffffffffc0205568 <default_pmm_manager+0x548>
ffffffffc02025da:	00002617          	auipc	a2,0x2
ffffffffc02025de:	6ae60613          	addi	a2,a2,1710 # ffffffffc0204c88 <commands+0x870>
ffffffffc02025e2:	1d200593          	li	a1,466
ffffffffc02025e6:	00003517          	auipc	a0,0x3
ffffffffc02025ea:	ab250513          	addi	a0,a0,-1358 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0202662:	aba68693          	addi	a3,a3,-1350 # ffffffffc0205118 <default_pmm_manager+0xf8>
ffffffffc0202666:	00002617          	auipc	a2,0x2
ffffffffc020266a:	62260613          	addi	a2,a2,1570 # ffffffffc0204c88 <commands+0x870>
ffffffffc020266e:	17a00593          	li	a1,378
ffffffffc0202672:	00003517          	auipc	a0,0x3
ffffffffc0202676:	a2650513          	addi	a0,a0,-1498 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc02026b8:	5bc78793          	addi	a5,a5,1468 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc02026f6:	9c668693          	addi	a3,a3,-1594 # ffffffffc02050b8 <default_pmm_manager+0x98>
ffffffffc02026fa:	00002617          	auipc	a2,0x2
ffffffffc02026fe:	58e60613          	addi	a2,a2,1422 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202702:	1f000593          	li	a1,496
ffffffffc0202706:	00003517          	auipc	a0,0x3
ffffffffc020270a:	99250513          	addi	a0,a0,-1646 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0202718:	95c60613          	addi	a2,a2,-1700 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc020271c:	06a00593          	li	a1,106
ffffffffc0202720:	00003517          	auipc	a0,0x3
ffffffffc0202724:	9e850513          	addi	a0,a0,-1560 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0202728:	c4dfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc020272c:	00003697          	auipc	a3,0x3
ffffffffc0202730:	9ac68693          	addi	a3,a3,-1620 # ffffffffc02050d8 <default_pmm_manager+0xb8>
ffffffffc0202734:	00002617          	auipc	a2,0x2
ffffffffc0202738:	55460613          	addi	a2,a2,1364 # ffffffffc0204c88 <commands+0x870>
ffffffffc020273c:	1f300593          	li	a1,499
ffffffffc0202740:	00003517          	auipc	a0,0x3
ffffffffc0202744:	95850513          	addi	a0,a0,-1704 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc02027b2:	90a68693          	addi	a3,a3,-1782 # ffffffffc02050b8 <default_pmm_manager+0x98>
ffffffffc02027b6:	00002617          	auipc	a2,0x2
ffffffffc02027ba:	4d260613          	addi	a2,a2,1234 # ffffffffc0204c88 <commands+0x870>
ffffffffc02027be:	1f900593          	li	a1,505
ffffffffc02027c2:	00003517          	auipc	a0,0x3
ffffffffc02027c6:	8d650513          	addi	a0,a0,-1834 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc02027d8:	9e460613          	addi	a2,a2,-1564 # ffffffffc02051b8 <default_pmm_manager+0x198>
ffffffffc02027dc:	06c00593          	li	a1,108
ffffffffc02027e0:	00003517          	auipc	a0,0x3
ffffffffc02027e4:	92850513          	addi	a0,a0,-1752 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc02027e8:	b8dfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02027ec:	00003697          	auipc	a3,0x3
ffffffffc02027f0:	8bc68693          	addi	a3,a3,-1860 # ffffffffc02050a8 <default_pmm_manager+0x88>
ffffffffc02027f4:	00002617          	auipc	a2,0x2
ffffffffc02027f8:	49460613          	addi	a2,a2,1172 # ffffffffc0204c88 <commands+0x870>
ffffffffc02027fc:	1fa00593          	li	a1,506
ffffffffc0202800:	00003517          	auipc	a0,0x3
ffffffffc0202804:	89850513          	addi	a0,a0,-1896 # ffffffffc0205098 <default_pmm_manager+0x78>
...
ffffffffc0202826:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202828:	3c4010ef          	jal	ra,ffffffffc0203bec <swapfs_init>
...
ffffffffc020288a:	eba50513          	addi	a0,a0,-326 # ffffffffc0205740 <default_pmm_manager+0x720>
    return listelm->next;
...
ffffffffc02028e8:	e7450513          	addi	a0,a0,-396 # ffffffffc0205758 <default_pmm_manager+0x738>
ffffffffc02028ec:	fd2fd0ef          	jal	ra,ffffffffc02000be <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02028f0:	301000ef          	jal	ra,ffffffffc02033f0 <mm_create>
...
ffffffffc020292a:	313000ef          	jal	ra,ffffffffc020343c <vma_create>
...
ffffffffc0202936:	373000ef          	jal	ra,ffffffffc02034a8 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc020293a:	00003517          	auipc	a0,0x3
ffffffffc020293e:	e8e50513          	addi	a0,a0,-370 # ffffffffc02057c8 <default_pmm_manager+0x7a8>
...
ffffffffc020295a:	ec250513          	addi	a0,a0,-318 # ffffffffc0205818 <default_pmm_manager+0x7f8>
...
ffffffffc02029da:	eca50513          	addi	a0,a0,-310 # ffffffffc02058a0 <default_pmm_manager+0x880>
...
ffffffffc0202aba:	64ad0d13          	addi	s10,s10,1610 # ffffffffc0206100 <nbase>
...
ffffffffc0202b1e:	e2e50513          	addi	a0,a0,-466 # ffffffffc0205948 <default_pmm_manager+0x928>
...
ffffffffc0202b4a:	22d000ef          	jal	ra,ffffffffc0203576 <mm_destroy>
...
ffffffffc0202b86:	df650513          	addi	a0,a0,-522 # ffffffffc0205978 <default_pmm_manager+0x958>
ffffffffc0202b8a:	d34fd0ef          	jal	ra,ffffffffc02000be <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202b8e:	00003517          	auipc	a0,0x3
ffffffffc0202b92:	e0a50513          	addi	a0,a0,-502 # ffffffffc0205998 <default_pmm_manager+0x978>
...
ffffffffc0202ba8:	0d468693          	addi	a3,a3,212 # ffffffffc0204c78 <commands+0x860>
ffffffffc0202bac:	00002617          	auipc	a2,0x2
ffffffffc0202bb0:	0dc60613          	addi	a2,a2,220 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202bb4:	0ba00593          	li	a1,186
ffffffffc0202bb8:	00003517          	auipc	a0,0x3
ffffffffc0202bbc:	b7850513          	addi	a0,a0,-1160 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202bc0:	fb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202bc4:	00003697          	auipc	a3,0x3
ffffffffc0202bc8:	d5c68693          	addi	a3,a3,-676 # ffffffffc0205920 <default_pmm_manager+0x900>
ffffffffc0202bcc:	00002617          	auipc	a2,0x2
ffffffffc0202bd0:	0bc60613          	addi	a2,a2,188 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202bd4:	0fa00593          	li	a1,250
ffffffffc0202bd8:	00003517          	auipc	a0,0x3
ffffffffc0202bdc:	b5850513          	addi	a0,a0,-1192 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202be0:	f94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202be4:	00002617          	auipc	a2,0x2
ffffffffc0202be8:	6fc60613          	addi	a2,a2,1788 # ffffffffc02052e0 <default_pmm_manager+0x2c0>
ffffffffc0202bec:	07000593          	li	a1,112
ffffffffc0202bf0:	00002517          	auipc	a0,0x2
ffffffffc0202bf4:	51850513          	addi	a0,a0,1304 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0202bf8:	f7cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202bfc:	00002617          	auipc	a2,0x2
ffffffffc0202c00:	4ec60613          	addi	a2,a2,1260 # ffffffffc02050e8 <default_pmm_manager+0xc8>
ffffffffc0202c04:	06500593          	li	a1,101
ffffffffc0202c08:	00002517          	auipc	a0,0x2
ffffffffc0202c0c:	50050513          	addi	a0,a0,1280 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0202c10:	f64fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202c14:	00003697          	auipc	a3,0x3
ffffffffc0202c18:	c4468693          	addi	a3,a3,-956 # ffffffffc0205858 <default_pmm_manager+0x838>
ffffffffc0202c1c:	00002617          	auipc	a2,0x2
ffffffffc0202c20:	06c60613          	addi	a2,a2,108 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202c24:	0db00593          	li	a1,219
ffffffffc0202c28:	00003517          	auipc	a0,0x3
ffffffffc0202c2c:	b0850513          	addi	a0,a0,-1272 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202c30:	f44fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202c34:	00003697          	auipc	a3,0x3
ffffffffc0202c38:	c0c68693          	addi	a3,a3,-1012 # ffffffffc0205840 <default_pmm_manager+0x820>
ffffffffc0202c3c:	00002617          	auipc	a2,0x2
ffffffffc0202c40:	04c60613          	addi	a2,a2,76 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202c44:	0da00593          	li	a1,218
ffffffffc0202c48:	00003517          	auipc	a0,0x3
ffffffffc0202c4c:	ae850513          	addi	a0,a0,-1304 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202c50:	f24fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202c54:	00003697          	auipc	a3,0x3
ffffffffc0202c58:	cb468693          	addi	a3,a3,-844 # ffffffffc0205908 <default_pmm_manager+0x8e8>
ffffffffc0202c5c:	00002617          	auipc	a2,0x2
ffffffffc0202c60:	02c60613          	addi	a2,a2,44 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202c64:	0f900593          	li	a1,249
ffffffffc0202c68:	00003517          	auipc	a0,0x3
ffffffffc0202c6c:	ac850513          	addi	a0,a0,-1336 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202c70:	f04fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202c74:	00003617          	auipc	a2,0x3
ffffffffc0202c78:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0205710 <default_pmm_manager+0x6f0>
ffffffffc0202c7c:	02700593          	li	a1,39
ffffffffc0202c80:	00003517          	auipc	a0,0x3
ffffffffc0202c84:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202c88:	eecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202c8c:	00003697          	auipc	a3,0x3
ffffffffc0202c90:	c4c68693          	addi	a3,a3,-948 # ffffffffc02058d8 <default_pmm_manager+0x8b8>
ffffffffc0202c94:	00002617          	auipc	a2,0x2
ffffffffc0202c98:	ff460613          	addi	a2,a2,-12 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202c9c:	09500593          	li	a1,149
ffffffffc0202ca0:	00003517          	auipc	a0,0x3
ffffffffc0202ca4:	a9050513          	addi	a0,a0,-1392 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202ca8:	eccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202cac:	00003697          	auipc	a3,0x3
ffffffffc0202cb0:	c2c68693          	addi	a3,a3,-980 # ffffffffc02058d8 <default_pmm_manager+0x8b8>
ffffffffc0202cb4:	00002617          	auipc	a2,0x2
ffffffffc0202cb8:	fd460613          	addi	a2,a2,-44 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202cbc:	09700593          	li	a1,151
ffffffffc0202cc0:	00003517          	auipc	a0,0x3
ffffffffc0202cc4:	a7050513          	addi	a0,a0,-1424 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202cc8:	eacfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ccc:	00003697          	auipc	a3,0x3
ffffffffc0202cd0:	c1c68693          	addi	a3,a3,-996 # ffffffffc02058e8 <default_pmm_manager+0x8c8>
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	fb460613          	addi	a2,a2,-76 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202cdc:	09900593          	li	a1,153
ffffffffc0202ce0:	00003517          	auipc	a0,0x3
ffffffffc0202ce4:	a5050513          	addi	a0,a0,-1456 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	bfc68693          	addi	a3,a3,-1028 # ffffffffc02058e8 <default_pmm_manager+0x8c8>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	f9460613          	addi	a2,a2,-108 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202cfc:	09b00593          	li	a1,155
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	a3050513          	addi	a0,a0,-1488 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	bbc68693          	addi	a3,a3,-1092 # ffffffffc02058c8 <default_pmm_manager+0x8a8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	f7460613          	addi	a2,a2,-140 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202d1c:	09100593          	li	a1,145
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a1050513          	addi	a0,a0,-1520 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202d2c:	00003697          	auipc	a3,0x3
ffffffffc0202d30:	b9c68693          	addi	a3,a3,-1124 # ffffffffc02058c8 <default_pmm_manager+0x8a8>
ffffffffc0202d34:	00002617          	auipc	a2,0x2
ffffffffc0202d38:	f5460613          	addi	a2,a2,-172 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202d3c:	09300593          	li	a1,147
ffffffffc0202d40:	00003517          	auipc	a0,0x3
ffffffffc0202d44:	9f050513          	addi	a0,a0,-1552 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202d48:	e2cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202d4c:	00003697          	auipc	a3,0x3
ffffffffc0202d50:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0205878 <default_pmm_manager+0x858>
ffffffffc0202d54:	00002617          	auipc	a2,0x2
ffffffffc0202d58:	f3460613          	addi	a2,a2,-204 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202d5c:	0e800593          	li	a1,232
ffffffffc0202d60:	00003517          	auipc	a0,0x3
ffffffffc0202d64:	9d050513          	addi	a0,a0,-1584 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202d68:	e0cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202d6c:	00003697          	auipc	a3,0x3
ffffffffc0202d70:	a9468693          	addi	a3,a3,-1388 # ffffffffc0205800 <default_pmm_manager+0x7e0>
ffffffffc0202d74:	00002617          	auipc	a2,0x2
ffffffffc0202d78:	f1460613          	addi	a2,a2,-236 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202d7c:	0d500593          	li	a1,213
ffffffffc0202d80:	00003517          	auipc	a0,0x3
ffffffffc0202d84:	9b050513          	addi	a0,a0,-1616 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202d88:	decfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d8c:	00003697          	auipc	a3,0x3
ffffffffc0202d90:	b6c68693          	addi	a3,a3,-1172 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc0202d94:	00002617          	auipc	a2,0x2
ffffffffc0202d98:	ef460613          	addi	a2,a2,-268 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202d9c:	09d00593          	li	a1,157
ffffffffc0202da0:	00003517          	auipc	a0,0x3
ffffffffc0202da4:	99050513          	addi	a0,a0,-1648 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202da8:	dccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202dac:	00003697          	auipc	a3,0x3
ffffffffc0202db0:	b4c68693          	addi	a3,a3,-1204 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc0202db4:	00002617          	auipc	a2,0x2
ffffffffc0202db8:	ed460613          	addi	a2,a2,-300 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202dbc:	09f00593          	li	a1,159
ffffffffc0202dc0:	00003517          	auipc	a0,0x3
ffffffffc0202dc4:	97050513          	addi	a0,a0,-1680 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202dc8:	dacfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202dcc:	00002697          	auipc	a3,0x2
ffffffffc0202dd0:	09468693          	addi	a3,a3,148 # ffffffffc0204e60 <commands+0xa48>
ffffffffc0202dd4:	00002617          	auipc	a2,0x2
ffffffffc0202dd8:	eb460613          	addi	a2,a2,-332 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202ddc:	0f100593          	li	a1,241
ffffffffc0202de0:	00003517          	auipc	a0,0x3
ffffffffc0202de4:	95050513          	addi	a0,a0,-1712 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202de8:	d8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dec:	00003697          	auipc	a3,0x3
ffffffffc0202df0:	b8468693          	addi	a3,a3,-1148 # ffffffffc0205970 <default_pmm_manager+0x950>
ffffffffc0202df4:	00002617          	auipc	a2,0x2
ffffffffc0202df8:	e9460613          	addi	a2,a2,-364 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202dfc:	10000593          	li	a1,256
ffffffffc0202e00:	00003517          	auipc	a0,0x3
ffffffffc0202e04:	93050513          	addi	a0,a0,-1744 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202e08:	d6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202e0c:	00003697          	auipc	a3,0x3
ffffffffc0202e10:	97468693          	addi	a3,a3,-1676 # ffffffffc0205780 <default_pmm_manager+0x760>
ffffffffc0202e14:	00002617          	auipc	a2,0x2
ffffffffc0202e18:	e7460613          	addi	a2,a2,-396 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202e1c:	0c200593          	li	a1,194
ffffffffc0202e20:	00003517          	auipc	a0,0x3
ffffffffc0202e24:	91050513          	addi	a0,a0,-1776 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202e28:	d4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202e2c:	00003697          	auipc	a3,0x3
ffffffffc0202e30:	96468693          	addi	a3,a3,-1692 # ffffffffc0205790 <default_pmm_manager+0x770>
ffffffffc0202e34:	00002617          	auipc	a2,0x2
ffffffffc0202e38:	e5460613          	addi	a2,a2,-428 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202e3c:	0c500593          	li	a1,197
ffffffffc0202e40:	00003517          	auipc	a0,0x3
ffffffffc0202e44:	8f050513          	addi	a0,a0,-1808 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202e48:	d2cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202e4c:	00003697          	auipc	a3,0x3
ffffffffc0202e50:	95c68693          	addi	a3,a3,-1700 # ffffffffc02057a8 <default_pmm_manager+0x788>
ffffffffc0202e54:	00002617          	auipc	a2,0x2
ffffffffc0202e58:	e3460613          	addi	a2,a2,-460 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202e5c:	0ca00593          	li	a1,202
ffffffffc0202e60:	00003517          	auipc	a0,0x3
ffffffffc0202e64:	8d050513          	addi	a0,a0,-1840 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202e68:	d0cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e6c:	00003697          	auipc	a3,0x3
ffffffffc0202e70:	94c68693          	addi	a3,a3,-1716 # ffffffffc02057b8 <default_pmm_manager+0x798>
ffffffffc0202e74:	00002617          	auipc	a2,0x2
ffffffffc0202e78:	e1460613          	addi	a2,a2,-492 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202e7c:	0cd00593          	li	a1,205
ffffffffc0202e80:	00003517          	auipc	a0,0x3
ffffffffc0202e84:	8b050513          	addi	a0,a0,-1872 # ffffffffc0205730 <default_pmm_manager+0x710>
ffffffffc0202e88:	cecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e8c:	00002697          	auipc	a3,0x2
ffffffffc0202e90:	e2c68693          	addi	a3,a3,-468 # ffffffffc0204cb8 <commands+0x8a0>
ffffffffc0202e94:	00002617          	auipc	a2,0x2
ffffffffc0202e98:	df460613          	addi	a2,a2,-524 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202e9c:	0bd00593          	li	a1,189
ffffffffc0202ea0:	00003517          	auipc	a0,0x3
ffffffffc0202ea4:	89050513          	addi	a0,a0,-1904 # ffffffffc0205730 <default_pmm_manager+0x710>
...
ffffffffc0202ef8:	b24b0b13          	addi	s6,s6,-1244 # ffffffffc0205a18 <default_pmm_manager+0x9f8>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202efc:	00003b97          	auipc	s7,0x3
ffffffffc0202f00:	b04b8b93          	addi	s7,s7,-1276 # ffffffffc0205a00 <default_pmm_manager+0x9e0>
...
ffffffffc0202f70:	55b000ef          	jal	ra,ffffffffc0203cca <swapfs_write>
...
ffffffffc0202fb2:	a0a50513          	addi	a0,a0,-1526 # ffffffffc02059b8 <default_pmm_manager+0x998>
...
ffffffffc0202fc4:	a2868693          	addi	a3,a3,-1496 # ffffffffc02059e8 <default_pmm_manager+0x9c8>
ffffffffc0202fc8:	00002617          	auipc	a2,0x2
ffffffffc0202fcc:	cc060613          	addi	a2,a2,-832 # ffffffffc0204c88 <commands+0x870>
ffffffffc0202fd0:	06600593          	li	a1,102
ffffffffc0202fd4:	00002517          	auipc	a0,0x2
ffffffffc0202fd8:	75c50513          	addi	a0,a0,1884 # ffffffffc0205730 <default_pmm_manager+0x710>
...
ffffffffc020300e:	417000ef          	jal	ra,ffffffffc0203c24 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203012:	00093583          	ld	a1,0(s2)
ffffffffc0203016:	8626                	mv	a2,s1
ffffffffc0203018:	00002517          	auipc	a0,0x2
ffffffffc020301c:	6b850513          	addi	a0,a0,1720 # ffffffffc02056d0 <default_pmm_manager+0x6b0>
...
ffffffffc020303e:	68668693          	addi	a3,a3,1670 # ffffffffc02056c0 <default_pmm_manager+0x6a0>
ffffffffc0203042:	00002617          	auipc	a2,0x2
ffffffffc0203046:	c4660613          	addi	a2,a2,-954 # ffffffffc0204c88 <commands+0x870>
ffffffffc020304a:	07c00593          	li	a1,124
ffffffffc020304e:	00002517          	auipc	a0,0x2
ffffffffc0203052:	6e250513          	addi	a0,a0,1762 # ffffffffc0205730 <default_pmm_manager+0x710>
...
{     
     /*LAB3 EXERCISE 4: 2111258 2111527 2113879*/ 
...
ffffffffc020313c:	7c068693          	addi	a3,a3,1984 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc0203140:	00002617          	auipc	a2,0x2
ffffffffc0203144:	b4860613          	addi	a2,a2,-1208 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203148:	08e00593          	li	a1,142
ffffffffc020314c:	00003517          	auipc	a0,0x3
ffffffffc0203150:	90c50513          	addi	a0,a0,-1780 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203154:	a20fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203158:	00003697          	auipc	a3,0x3
ffffffffc020315c:	95068693          	addi	a3,a3,-1712 # ffffffffc0205aa8 <default_pmm_manager+0xa88>
ffffffffc0203160:	00002617          	auipc	a2,0x2
ffffffffc0203164:	b2860613          	addi	a2,a2,-1240 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203168:	0a500593          	li	a1,165
ffffffffc020316c:	00003517          	auipc	a0,0x3
ffffffffc0203170:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203174:	a00fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203178:	00003697          	auipc	a3,0x3
ffffffffc020317c:	90868693          	addi	a3,a3,-1784 # ffffffffc0205a80 <default_pmm_manager+0xa60>
ffffffffc0203180:	00002617          	auipc	a2,0x2
ffffffffc0203184:	b0860613          	addi	a2,a2,-1272 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203188:	0a300593          	li	a1,163
ffffffffc020318c:	00003517          	auipc	a0,0x3
ffffffffc0203190:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203194:	9e0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203198:	00003697          	auipc	a3,0x3
ffffffffc020319c:	8d868693          	addi	a3,a3,-1832 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc02031a0:	00002617          	auipc	a2,0x2
ffffffffc02031a4:	ae860613          	addi	a2,a2,-1304 # ffffffffc0204c88 <commands+0x870>
ffffffffc02031a8:	0a200593          	li	a1,162
ffffffffc02031ac:	00003517          	auipc	a0,0x3
ffffffffc02031b0:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc02031b4:	9c0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031b8:	00003697          	auipc	a3,0x3
ffffffffc02031bc:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc02031c0:	00002617          	auipc	a2,0x2
ffffffffc02031c4:	ac860613          	addi	a2,a2,-1336 # ffffffffc0204c88 <commands+0x870>
ffffffffc02031c8:	0a000593          	li	a1,160
ffffffffc02031cc:	00003517          	auipc	a0,0x3
ffffffffc02031d0:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc02031d4:	9a0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031d8:	00003697          	auipc	a3,0x3
ffffffffc02031dc:	89868693          	addi	a3,a3,-1896 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc02031e0:	00002617          	auipc	a2,0x2
ffffffffc02031e4:	aa860613          	addi	a2,a2,-1368 # ffffffffc0204c88 <commands+0x870>
ffffffffc02031e8:	09e00593          	li	a1,158
ffffffffc02031ec:	00003517          	auipc	a0,0x3
ffffffffc02031f0:	86c50513          	addi	a0,a0,-1940 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc02031f4:	980fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031f8:	00003697          	auipc	a3,0x3
ffffffffc02031fc:	87868693          	addi	a3,a3,-1928 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc0203200:	00002617          	auipc	a2,0x2
ffffffffc0203204:	a8860613          	addi	a2,a2,-1400 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203208:	09c00593          	li	a1,156
ffffffffc020320c:	00003517          	auipc	a0,0x3
ffffffffc0203210:	84c50513          	addi	a0,a0,-1972 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203214:	960fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203218:	00003697          	auipc	a3,0x3
ffffffffc020321c:	85868693          	addi	a3,a3,-1960 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc0203220:	00002617          	auipc	a2,0x2
ffffffffc0203224:	a6860613          	addi	a2,a2,-1432 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203228:	09a00593          	li	a1,154
ffffffffc020322c:	00003517          	auipc	a0,0x3
ffffffffc0203230:	82c50513          	addi	a0,a0,-2004 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203234:	940fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203238:	00003697          	auipc	a3,0x3
ffffffffc020323c:	83868693          	addi	a3,a3,-1992 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc0203240:	00002617          	auipc	a2,0x2
ffffffffc0203244:	a4860613          	addi	a2,a2,-1464 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203248:	09800593          	li	a1,152
ffffffffc020324c:	00003517          	auipc	a0,0x3
ffffffffc0203250:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203254:	920fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203258:	00003697          	auipc	a3,0x3
ffffffffc020325c:	81868693          	addi	a3,a3,-2024 # ffffffffc0205a70 <default_pmm_manager+0xa50>
ffffffffc0203260:	00002617          	auipc	a2,0x2
ffffffffc0203264:	a2860613          	addi	a2,a2,-1496 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203268:	09600593          	li	a1,150
ffffffffc020326c:	00002517          	auipc	a0,0x2
ffffffffc0203270:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203274:	900fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203278:	00002697          	auipc	a3,0x2
ffffffffc020327c:	68068693          	addi	a3,a3,1664 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc0203280:	00002617          	auipc	a2,0x2
ffffffffc0203284:	a0860613          	addi	a2,a2,-1528 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203288:	09400593          	li	a1,148
ffffffffc020328c:	00002517          	auipc	a0,0x2
ffffffffc0203290:	7cc50513          	addi	a0,a0,1996 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203294:	8e0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203298:	00002697          	auipc	a3,0x2
ffffffffc020329c:	66068693          	addi	a3,a3,1632 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc02032a0:	00002617          	auipc	a2,0x2
ffffffffc02032a4:	9e860613          	addi	a2,a2,-1560 # ffffffffc0204c88 <commands+0x870>
ffffffffc02032a8:	09200593          	li	a1,146
ffffffffc02032ac:	00002517          	auipc	a0,0x2
ffffffffc02032b0:	7ac50513          	addi	a0,a0,1964 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc02032b4:	8c0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02032b8:	00002697          	auipc	a3,0x2
ffffffffc02032bc:	64068693          	addi	a3,a3,1600 # ffffffffc02058f8 <default_pmm_manager+0x8d8>
ffffffffc02032c0:	00002617          	auipc	a2,0x2
ffffffffc02032c4:	9c860613          	addi	a2,a2,-1592 # ffffffffc0204c88 <commands+0x870>
ffffffffc02032c8:	09000593          	li	a1,144
ffffffffc02032cc:	00002517          	auipc	a0,0x2
ffffffffc02032d0:	78c50513          	addi	a0,a0,1932 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc02032d4:	8a0fd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02032d8 <_clock_swap_out_victim>:
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02032d8:	7508                	ld	a0,40(a0)
{
ffffffffc02032da:	1141                	addi	sp,sp,-16
ffffffffc02032dc:	e406                	sd	ra,8(sp)
        assert(head != NULL);
ffffffffc02032de:	c539                	beqz	a0,ffffffffc020332c <_clock_swap_out_victim+0x54>
    assert(in_tick==0);
ffffffffc02032e0:	e635                	bnez	a2,ffffffffc020334c <_clock_swap_out_victim+0x74>
ffffffffc02032e2:	0000e797          	auipc	a5,0xe
ffffffffc02032e6:	2a678793          	addi	a5,a5,678 # ffffffffc0211588 <curr_ptr>
ffffffffc02032ea:	639c                	ld	a5,0(a5)
ffffffffc02032ec:	a039                	j	ffffffffc02032fa <_clock_swap_out_victim+0x22>
        if(page->visited==0)
ffffffffc02032ee:	fe07b603          	ld	a2,-32(a5)
ffffffffc02032f2:	ce01                	beqz	a2,ffffffffc020330a <_clock_swap_out_victim+0x32>
            page->visited=0;
ffffffffc02032f4:	fe07b023          	sd	zero,-32(a5)
    while (1) {
ffffffffc02032f8:	87b6                	mv	a5,a3
    return listelm->next;
ffffffffc02032fa:	6798                	ld	a4,8(a5)
        if(curr_ptr==head)
ffffffffc02032fc:	86ba                	mv	a3,a4
ffffffffc02032fe:	fee518e3          	bne	a0,a4,ffffffffc02032ee <_clock_swap_out_victim+0x16>
        if(page->visited==0)
ffffffffc0203302:	fe07b603          	ld	a2,-32(a5)
ffffffffc0203306:	6514                	ld	a3,8(a0)
ffffffffc0203308:	f675                	bnez	a2,ffffffffc02032f4 <_clock_swap_out_victim+0x1c>
    __list_del(listelm->prev, listelm->next);
ffffffffc020330a:	6390                	ld	a2,0(a5)
ffffffffc020330c:	0000e517          	auipc	a0,0xe
ffffffffc0203310:	26d53e23          	sd	a3,636(a0) # ffffffffc0211588 <curr_ptr>
            page->visited=1;
ffffffffc0203314:	4685                	li	a3,1
ffffffffc0203316:	fed7b023          	sd	a3,-32(a5)
    prev->next = next;
ffffffffc020331a:	e618                	sd	a4,8(a2)
}
ffffffffc020331c:	60a2                	ld	ra,8(sp)
    next->prev = prev;
ffffffffc020331e:	e310                	sd	a2,0(a4)
        struct Page *page=le2page(le,pra_page_link);
ffffffffc0203320:	fd078793          	addi	a5,a5,-48
            *ptr_page=page;
ffffffffc0203324:	e19c                	sd	a5,0(a1)
}
ffffffffc0203326:	4501                	li	a0,0
ffffffffc0203328:	0141                	addi	sp,sp,16
ffffffffc020332a:	8082                	ret
        assert(head != NULL);
ffffffffc020332c:	00002697          	auipc	a3,0x2
ffffffffc0203330:	7b468693          	addi	a3,a3,1972 # ffffffffc0205ae0 <default_pmm_manager+0xac0>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	95460613          	addi	a2,a2,-1708 # ffffffffc0204c88 <commands+0x870>
ffffffffc020333c:	04800593          	li	a1,72
ffffffffc0203340:	00002517          	auipc	a0,0x2
ffffffffc0203344:	71850513          	addi	a0,a0,1816 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(in_tick==0);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	7a468693          	addi	a3,a3,1956 # ffffffffc0205af0 <default_pmm_manager+0xad0>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	93460613          	addi	a2,a2,-1740 # ffffffffc0204c88 <commands+0x870>
ffffffffc020335c:	04900593          	li	a1,73
ffffffffc0203360:	00002517          	auipc	a0,0x2
ffffffffc0203364:	6f850513          	addi	a0,a0,1784 # ffffffffc0205a58 <default_pmm_manager+0xa38>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020336c <_clock_map_swappable>:
    list_entry_t *entry=&(page->pra_page_link);
ffffffffc020336c:	03060793          	addi	a5,a2,48
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203370:	cf85                	beqz	a5,ffffffffc02033a8 <_clock_map_swappable+0x3c>
ffffffffc0203372:	0000e717          	auipc	a4,0xe
ffffffffc0203376:	21670713          	addi	a4,a4,534 # ffffffffc0211588 <curr_ptr>
ffffffffc020337a:	6318                	ld	a4,0(a4)
ffffffffc020337c:	c715                	beqz	a4,ffffffffc02033a8 <_clock_map_swappable+0x3c>
    __list_add(elm, listelm, listelm->next);
ffffffffc020337e:	0000e717          	auipc	a4,0xe
ffffffffc0203382:	1fa70713          	addi	a4,a4,506 # ffffffffc0211578 <pra_list_head>
ffffffffc0203386:	6714                	ld	a3,8(a4)
}
ffffffffc0203388:	4501                	li	a0,0
    prev->next = next->prev = elm;
ffffffffc020338a:	e29c                	sd	a5,0(a3)
    curr_ptr=list_prev(&pra_list_head);
ffffffffc020338c:	630c                	ld	a1,0(a4)
ffffffffc020338e:	0000e817          	auipc	a6,0xe
ffffffffc0203392:	1ef83923          	sd	a5,498(a6) # ffffffffc0211580 <pra_list_head+0x8>
    elm->next = next;
ffffffffc0203396:	fe14                	sd	a3,56(a2)
ffffffffc0203398:	0000e797          	auipc	a5,0xe
ffffffffc020339c:	1eb7b823          	sd	a1,496(a5) # ffffffffc0211588 <curr_ptr>
    page->visited=1;
ffffffffc02033a0:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc02033a2:	fa18                	sd	a4,48(a2)
ffffffffc02033a4:	ea1c                	sd	a5,16(a2)
}
ffffffffc02033a6:	8082                	ret
{
ffffffffc02033a8:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033aa:	00002697          	auipc	a3,0x2
ffffffffc02033ae:	70e68693          	addi	a3,a3,1806 # ffffffffc0205ab8 <default_pmm_manager+0xa98>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204c88 <commands+0x870>
ffffffffc02033ba:	03500593          	li	a1,53
ffffffffc02033be:	00002517          	auipc	a0,0x2
ffffffffc02033c2:	69a50513          	addi	a0,a0,1690 # ffffffffc0205a58 <default_pmm_manager+0xa38>
{
ffffffffc02033c6:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033c8:	fadfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033cc <check_vma_overlap.isra.0.part.1>:
}
...
ffffffffc02033cc:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc02033ce:	00002697          	auipc	a3,0x2
ffffffffc02033d2:	74a68693          	addi	a3,a3,1866 # ffffffffc0205b18 <default_pmm_manager+0xaf8>
ffffffffc02033d6:	00002617          	auipc	a2,0x2
ffffffffc02033da:	8b260613          	addi	a2,a2,-1870 # ffffffffc0204c88 <commands+0x870>
ffffffffc02033de:	07d00593          	li	a1,125
ffffffffc02033e2:	00002517          	auipc	a0,0x2
ffffffffc02033e6:	75650513          	addi	a0,a0,1878 # ffffffffc0205b38 <default_pmm_manager+0xb18>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02033ea:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02033ec:	f89fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033f0 <mm_create>:
mm_create(void) {
ffffffffc02033f0:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02033f2:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02033f6:	e022                	sd	s0,0(sp)
ffffffffc02033f8:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02033fa:	a90ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc02033fe:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203400:	c115                	beqz	a0,ffffffffc0203424 <mm_create+0x34>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203402:	0000e797          	auipc	a5,0xe
ffffffffc0203406:	06678793          	addi	a5,a5,102 # ffffffffc0211468 <swap_init_ok>
ffffffffc020340a:	439c                	lw	a5,0(a5)
    elm->prev = elm->next = elm;
ffffffffc020340c:	e408                	sd	a0,8(s0)
ffffffffc020340e:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203410:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203414:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203418:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020341c:	2781                	sext.w	a5,a5
ffffffffc020341e:	eb81                	bnez	a5,ffffffffc020342e <mm_create+0x3e>
        else mm->sm_priv = NULL;
ffffffffc0203420:	02053423          	sd	zero,40(a0)
}
...
ffffffffc020342c:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020342e:	a7fff0ef          	jal	ra,ffffffffc0202eac <swap_init_mm>
}
...
ffffffffc020343c <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020343c:	1101                	addi	sp,sp,-32
ffffffffc020343e:	e04a                	sd	s2,0(sp)
ffffffffc0203440:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203442:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203446:	e822                	sd	s0,16(sp)
ffffffffc0203448:	e426                	sd	s1,8(sp)
ffffffffc020344a:	ec06                	sd	ra,24(sp)
ffffffffc020344c:	84ae                	mv	s1,a1
ffffffffc020344e:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203450:	a3aff0ef          	jal	ra,ffffffffc020268a <kmalloc>
    if (vma != NULL) {
ffffffffc0203454:	c509                	beqz	a0,ffffffffc020345e <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203456:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020345a:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020345c:	ed00                	sd	s0,24(a0)
}
ffffffffc020345e:	60e2                	ld	ra,24(sp)
ffffffffc0203460:	6442                	ld	s0,16(sp)
ffffffffc0203462:	64a2                	ld	s1,8(sp)
ffffffffc0203464:	6902                	ld	s2,0(sp)
ffffffffc0203466:	6105                	addi	sp,sp,32
ffffffffc0203468:	8082                	ret

ffffffffc020346a <find_vma>:
    if (mm != NULL) {
ffffffffc020346a:	c51d                	beqz	a0,ffffffffc0203498 <find_vma+0x2e>
        vma = mm->mmap_cache;
ffffffffc020346c:	691c                	ld	a5,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020346e:	c781                	beqz	a5,ffffffffc0203476 <find_vma+0xc>
ffffffffc0203470:	6798                	ld	a4,8(a5)
ffffffffc0203472:	02e5f663          	bleu	a4,a1,ffffffffc020349e <find_vma+0x34>
                list_entry_t *list = &(mm->mmap_list), *le = list;
ffffffffc0203476:	87aa                	mv	a5,a0
    return listelm->next;
ffffffffc0203478:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc020347a:	00f50f63          	beq	a0,a5,ffffffffc0203498 <find_vma+0x2e>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020347e:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203482:	fee5ebe3          	bltu	a1,a4,ffffffffc0203478 <find_vma+0xe>
ffffffffc0203486:	ff07b703          	ld	a4,-16(a5)
ffffffffc020348a:	fee5f7e3          	bleu	a4,a1,ffffffffc0203478 <find_vma+0xe>
                    vma = le2vma(le, list_link);
ffffffffc020348e:	1781                	addi	a5,a5,-32
        if (vma != NULL) {
ffffffffc0203490:	c781                	beqz	a5,ffffffffc0203498 <find_vma+0x2e>
            mm->mmap_cache = vma;
ffffffffc0203492:	e91c                	sd	a5,16(a0)
}
ffffffffc0203494:	853e                	mv	a0,a5
ffffffffc0203496:	8082                	ret
    struct vma_struct *vma = NULL;
ffffffffc0203498:	4781                	li	a5,0
}
ffffffffc020349a:	853e                	mv	a0,a5
ffffffffc020349c:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020349e:	6b98                	ld	a4,16(a5)
ffffffffc02034a0:	fce5fbe3          	bleu	a4,a1,ffffffffc0203476 <find_vma+0xc>
            mm->mmap_cache = vma;
ffffffffc02034a4:	e91c                	sd	a5,16(a0)
    return vma;
ffffffffc02034a6:	b7fd                	j	ffffffffc0203494 <find_vma+0x2a>

ffffffffc02034a8 <insert_vma_struct>:
...
ffffffffc02034a8:	6590                	ld	a2,8(a1)
ffffffffc02034aa:	0105b803          	ld	a6,16(a1) # 1010 <BASE_ADDRESS-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02034ae:	1141                	addi	sp,sp,-16
ffffffffc02034b0:	e406                	sd	ra,8(sp)
ffffffffc02034b2:	872a                	mv	a4,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02034b4:	01066863          	bltu	a2,a6,ffffffffc02034c4 <insert_vma_struct+0x1c>
ffffffffc02034b8:	a8b9                	j	ffffffffc0203516 <insert_vma_struct+0x6e>
...
ffffffffc02034ba:	fe87b683          	ld	a3,-24(a5)
ffffffffc02034be:	04d66763          	bltu	a2,a3,ffffffffc020350c <insert_vma_struct+0x64>
ffffffffc02034c2:	873e                	mv	a4,a5
ffffffffc02034c4:	671c                	ld	a5,8(a4)
        while ((le = list_next(le)) != list) {
ffffffffc02034c6:	fef51ae3          	bne	a0,a5,ffffffffc02034ba <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02034ca:	02a70463          	beq	a4,a0,ffffffffc02034f2 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02034ce:	ff073683          	ld	a3,-16(a4)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02034d2:	fe873883          	ld	a7,-24(a4)
ffffffffc02034d6:	08d8f063          	bleu	a3,a7,ffffffffc0203556 <insert_vma_struct+0xae>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034da:	04d66e63          	bltu	a2,a3,ffffffffc0203536 <insert_vma_struct+0x8e>
    }
    if (le_next != list) {
ffffffffc02034de:	00f50a63          	beq	a0,a5,ffffffffc02034f2 <insert_vma_struct+0x4a>
ffffffffc02034e2:	fe87b683          	ld	a3,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034e6:	0506e863          	bltu	a3,a6,ffffffffc0203536 <insert_vma_struct+0x8e>
    assert(next->vm_start < next->vm_end);
ffffffffc02034ea:	ff07b603          	ld	a2,-16(a5)
ffffffffc02034ee:	02c6f263          	bleu	a2,a3,ffffffffc0203512 <insert_vma_struct+0x6a>
    }
    ...
    mm->map_count ++;
ffffffffc02034f2:	5114                	lw	a3,32(a0)
    vma->vm_mm = mm;
ffffffffc02034f4:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02034f6:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02034fa:	e390                	sd	a2,0(a5)
ffffffffc02034fc:	e710                	sd	a2,8(a4)
}
ffffffffc02034fe:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203500:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203502:	f198                	sd	a4,32(a1)
    mm->map_count ++;
ffffffffc0203504:	2685                	addiw	a3,a3,1
ffffffffc0203506:	d114                	sw	a3,32(a0)
}
ffffffffc0203508:	0141                	addi	sp,sp,16
ffffffffc020350a:	8082                	ret
    if (le_prev != list) {
ffffffffc020350c:	fca711e3          	bne	a4,a0,ffffffffc02034ce <insert_vma_struct+0x26>
ffffffffc0203510:	bfd9                	j	ffffffffc02034e6 <insert_vma_struct+0x3e>
ffffffffc0203512:	ebbff0ef          	jal	ra,ffffffffc02033cc <check_vma_overlap.isra.0.part.1>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203516:	00002697          	auipc	a3,0x2
ffffffffc020351a:	6e268693          	addi	a3,a3,1762 # ffffffffc0205bf8 <default_pmm_manager+0xbd8>
ffffffffc020351e:	00001617          	auipc	a2,0x1
ffffffffc0203522:	76a60613          	addi	a2,a2,1898 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203526:	08400593          	li	a1,132
ffffffffc020352a:	00002517          	auipc	a0,0x2
ffffffffc020352e:	60e50513          	addi	a0,a0,1550 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203532:	e43fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203536:	00002697          	auipc	a3,0x2
ffffffffc020353a:	70268693          	addi	a3,a3,1794 # ffffffffc0205c38 <default_pmm_manager+0xc18>
ffffffffc020353e:	00001617          	auipc	a2,0x1
ffffffffc0203542:	74a60613          	addi	a2,a2,1866 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203546:	07c00593          	li	a1,124
ffffffffc020354a:	00002517          	auipc	a0,0x2
ffffffffc020354e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203552:	e23fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203556:	00002697          	auipc	a3,0x2
ffffffffc020355a:	6c268693          	addi	a3,a3,1730 # ffffffffc0205c18 <default_pmm_manager+0xbf8>
ffffffffc020355e:	00001617          	auipc	a2,0x1
ffffffffc0203562:	72a60613          	addi	a2,a2,1834 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203566:	07b00593          	li	a1,123
ffffffffc020356a:	00002517          	auipc	a0,0x2
ffffffffc020356e:	5ce50513          	addi	a0,a0,1486 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203572:	e03fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203576 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203576:	1141                	addi	sp,sp,-16
ffffffffc0203578:	e022                	sd	s0,0(sp)
ffffffffc020357a:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020357c:	6508                	ld	a0,8(a0)
ffffffffc020357e:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203580:	00a40e63          	beq	s0,a0,ffffffffc020359c <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203584:	6118                	ld	a4,0(a0)
ffffffffc0203586:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203588:	03000593          	li	a1,48
ffffffffc020358c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020358e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203590:	e398                	sd	a4,0(a5)
ffffffffc0203592:	9baff0ef          	jal	ra,ffffffffc020274c <kfree>
    return listelm->next;
ffffffffc0203596:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203598:	fea416e3          	bne	s0,a0,ffffffffc0203584 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020359c:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc020359e:	6402                	ld	s0,0(sp)
ffffffffc02035a0:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02035a2:	03000593          	li	a1,48
}
ffffffffc02035a6:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02035a8:	9a4ff06f          	j	ffffffffc020274c <kfree>

ffffffffc02035ac <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02035ac:	715d                	addi	sp,sp,-80
ffffffffc02035ae:	e486                	sd	ra,72(sp)
ffffffffc02035b0:	e0a2                	sd	s0,64(sp)
ffffffffc02035b2:	fc26                	sd	s1,56(sp)
ffffffffc02035b4:	f84a                	sd	s2,48(sp)
ffffffffc02035b6:	f052                	sd	s4,32(sp)
ffffffffc02035b8:	f44e                	sd	s3,40(sp)
ffffffffc02035ba:	ec56                	sd	s5,24(sp)
ffffffffc02035bc:	e85a                	sd	s6,16(sp)
ffffffffc02035be:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02035c0:	96cfe0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02035c6:	966fe0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc02035ca:	8a2a                	mv	s4,a0

    struct mm_struct *mm = mm_create();
ffffffffc02035cc:	e25ff0ef          	jal	ra,ffffffffc02033f0 <mm_create>
    assert(mm != NULL);
ffffffffc02035d0:	842a                	mv	s0,a0
ffffffffc02035d2:	03200493          	li	s1,50
ffffffffc02035d6:	e919                	bnez	a0,ffffffffc02035ec <vmm_init+0x40>
ffffffffc02035d8:	aeed                	j	ffffffffc02039d2 <vmm_init+0x426>
        vma->vm_start = vm_start;
ffffffffc02035da:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035dc:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035de:	00053c23          	sd	zero,24(a0)
    ...
    for (i = step1; i >= 1; i --) {
        ...
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02035e2:	14ed                	addi	s1,s1,-5
ffffffffc02035e4:	8522                	mv	a0,s0
ffffffffc02035e6:	ec3ff0ef          	jal	ra,ffffffffc02034a8 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02035ea:	c88d                	beqz	s1,ffffffffc020361c <vmm_init+0x70>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035ec:	03000513          	li	a0,48
ffffffffc02035f0:	89aff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc02035f4:	85aa                	mv	a1,a0
ffffffffc02035f6:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc02035fa:	f165                	bnez	a0,ffffffffc02035da <vmm_init+0x2e>
        assert(vma != NULL);
ffffffffc02035fc:	00002697          	auipc	a3,0x2
ffffffffc0203600:	1bc68693          	addi	a3,a3,444 # ffffffffc02057b8 <default_pmm_manager+0x798>
ffffffffc0203604:	00001617          	auipc	a2,0x1
ffffffffc0203608:	68460613          	addi	a2,a2,1668 # ffffffffc0204c88 <commands+0x870>
ffffffffc020360c:	0ce00593          	li	a1,206
ffffffffc0203610:	00002517          	auipc	a0,0x2
ffffffffc0203614:	52850513          	addi	a0,a0,1320 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203618:	d5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i = step1; i >= 1; i --) {
ffffffffc020361c:	03700493          	li	s1,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203620:	1f900993          	li	s3,505
ffffffffc0203624:	a819                	j	ffffffffc020363a <vmm_init+0x8e>
        vma->vm_start = vm_start;
ffffffffc0203626:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203628:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020362a:	00053c23          	sd	zero,24(a0)
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020362e:	0495                	addi	s1,s1,5
ffffffffc0203630:	8522                	mv	a0,s0
ffffffffc0203632:	e77ff0ef          	jal	ra,ffffffffc02034a8 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203636:	03348a63          	beq	s1,s3,ffffffffc020366a <vmm_init+0xbe>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020363a:	03000513          	li	a0,48
ffffffffc020363e:	84cff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc0203642:	85aa                	mv	a1,a0
ffffffffc0203644:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc0203648:	fd79                	bnez	a0,ffffffffc0203626 <vmm_init+0x7a>
        assert(vma != NULL);
ffffffffc020364a:	00002697          	auipc	a3,0x2
ffffffffc020364e:	16e68693          	addi	a3,a3,366 # ffffffffc02057b8 <default_pmm_manager+0x798>
ffffffffc0203652:	00001617          	auipc	a2,0x1
ffffffffc0203656:	63660613          	addi	a2,a2,1590 # ffffffffc0204c88 <commands+0x870>
ffffffffc020365a:	0d400593          	li	a1,212
ffffffffc020365e:	00002517          	auipc	a0,0x2
ffffffffc0203662:	4da50513          	addi	a0,a0,1242 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203666:	d0ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc020366a:	6418                	ld	a4,8(s0)
ffffffffc020366c:	479d                	li	a5,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020366e:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203672:	2ae40063          	beq	s0,a4,ffffffffc0203912 <vmm_init+0x366>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203676:	fe873603          	ld	a2,-24(a4)
ffffffffc020367a:	ffe78693          	addi	a3,a5,-2
ffffffffc020367e:	20d61a63          	bne	a2,a3,ffffffffc0203892 <vmm_init+0x2e6>
ffffffffc0203682:	ff073683          	ld	a3,-16(a4)
ffffffffc0203686:	20d79663          	bne	a5,a3,ffffffffc0203892 <vmm_init+0x2e6>
ffffffffc020368a:	0795                	addi	a5,a5,5
ffffffffc020368c:	6718                	ld	a4,8(a4)
    for (i = 1; i <= step2; i ++) {
ffffffffc020368e:	feb792e3          	bne	a5,a1,ffffffffc0203672 <vmm_init+0xc6>
ffffffffc0203692:	499d                	li	s3,7
ffffffffc0203694:	4495                	li	s1,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203696:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020369a:	85a6                	mv	a1,s1
ffffffffc020369c:	8522                	mv	a0,s0
ffffffffc020369e:	dcdff0ef          	jal	ra,ffffffffc020346a <find_vma>
ffffffffc02036a2:	8b2a                	mv	s6,a0
        assert(vma1 != NULL);
ffffffffc02036a4:	2e050763          	beqz	a0,ffffffffc0203992 <vmm_init+0x3e6>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02036a8:	00148593          	addi	a1,s1,1
ffffffffc02036ac:	8522                	mv	a0,s0
ffffffffc02036ae:	dbdff0ef          	jal	ra,ffffffffc020346a <find_vma>
ffffffffc02036b2:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02036b4:	2a050f63          	beqz	a0,ffffffffc0203972 <vmm_init+0x3c6>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02036b8:	85ce                	mv	a1,s3
ffffffffc02036ba:	8522                	mv	a0,s0
ffffffffc02036bc:	dafff0ef          	jal	ra,ffffffffc020346a <find_vma>
        assert(vma3 == NULL);
ffffffffc02036c0:	28051963          	bnez	a0,ffffffffc0203952 <vmm_init+0x3a6>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02036c4:	00348593          	addi	a1,s1,3
ffffffffc02036c8:	8522                	mv	a0,s0
ffffffffc02036ca:	da1ff0ef          	jal	ra,ffffffffc020346a <find_vma>
        assert(vma4 == NULL);
ffffffffc02036ce:	26051263          	bnez	a0,ffffffffc0203932 <vmm_init+0x386>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02036d2:	00448593          	addi	a1,s1,4
ffffffffc02036d6:	8522                	mv	a0,s0
ffffffffc02036d8:	d93ff0ef          	jal	ra,ffffffffc020346a <find_vma>
        assert(vma5 == NULL);
ffffffffc02036dc:	2c051b63          	bnez	a0,ffffffffc02039b2 <vmm_init+0x406>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02036e0:	008b3783          	ld	a5,8(s6)
ffffffffc02036e4:	1c979763          	bne	a5,s1,ffffffffc02038b2 <vmm_init+0x306>
ffffffffc02036e8:	010b3783          	ld	a5,16(s6)
ffffffffc02036ec:	1d379363          	bne	a5,s3,ffffffffc02038b2 <vmm_init+0x306>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02036f0:	008ab783          	ld	a5,8(s5)
ffffffffc02036f4:	1c979f63          	bne	a5,s1,ffffffffc02038d2 <vmm_init+0x326>
ffffffffc02036f8:	010ab783          	ld	a5,16(s5)
ffffffffc02036fc:	1d379b63          	bne	a5,s3,ffffffffc02038d2 <vmm_init+0x326>
ffffffffc0203700:	0495                	addi	s1,s1,5
ffffffffc0203702:	0995                	addi	s3,s3,5
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203704:	f9749be3          	bne	s1,s7,ffffffffc020369a <vmm_init+0xee>
ffffffffc0203708:	4491                	li	s1,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020370a:	59fd                	li	s3,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020370c:	85a6                	mv	a1,s1
ffffffffc020370e:	8522                	mv	a0,s0
ffffffffc0203710:	d5bff0ef          	jal	ra,ffffffffc020346a <find_vma>
ffffffffc0203714:	0004859b          	sext.w	a1,s1
        if (vma_below_5 != NULL ) {
ffffffffc0203718:	c90d                	beqz	a0,ffffffffc020374a <vmm_init+0x19e>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020371a:	6914                	ld	a3,16(a0)
ffffffffc020371c:	6510                	ld	a2,8(a0)
ffffffffc020371e:	00002517          	auipc	a0,0x2
ffffffffc0203722:	63a50513          	addi	a0,a0,1594 # ffffffffc0205d58 <default_pmm_manager+0xd38>
ffffffffc0203726:	999fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020372a:	00002697          	auipc	a3,0x2
ffffffffc020372e:	65668693          	addi	a3,a3,1622 # ffffffffc0205d80 <default_pmm_manager+0xd60>
ffffffffc0203732:	00001617          	auipc	a2,0x1
ffffffffc0203736:	55660613          	addi	a2,a2,1366 # ffffffffc0204c88 <commands+0x870>
ffffffffc020373a:	0f600593          	li	a1,246
ffffffffc020373e:	00002517          	auipc	a0,0x2
ffffffffc0203742:	3fa50513          	addi	a0,a0,1018 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203746:	c2ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc020374a:	14fd                	addi	s1,s1,-1
    for (i =4; i>=0; i--) {
ffffffffc020374c:	fd3490e3          	bne	s1,s3,ffffffffc020370c <vmm_init+0x160>
    }

    mm_destroy(mm);
ffffffffc0203750:	8522                	mv	a0,s0
ffffffffc0203752:	e25ff0ef          	jal	ra,ffffffffc0203576 <mm_destroy>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203756:	fd7fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc020375a:	28aa1c63          	bne	s4,a0,ffffffffc02039f2 <vmm_init+0x446>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020375e:	00002517          	auipc	a0,0x2
ffffffffc0203762:	66250513          	addi	a0,a0,1634 # ffffffffc0205dc0 <default_pmm_manager+0xda0>
ffffffffc0203766:	959fc0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc020376e:	89aa                	mv	s3,a0

    check_mm_struct = mm_create();
ffffffffc0203770:	c81ff0ef          	jal	ra,ffffffffc02033f0 <mm_create>
ffffffffc0203774:	0000e797          	auipc	a5,0xe
ffffffffc0203778:	e0a7be23          	sd	a0,-484(a5) # ffffffffc0211590 <check_mm_struct>
ffffffffc020377c:	842a                	mv	s0,a0

    assert(check_mm_struct != NULL);
ffffffffc020377e:	2a050a63          	beqz	a0,ffffffffc0203a32 <vmm_init+0x486>
    struct mm_struct *mm = check_mm_struct;
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203782:	0000e797          	auipc	a5,0xe
ffffffffc0203786:	cce78793          	addi	a5,a5,-818 # ffffffffc0211450 <boot_pgdir>
ffffffffc020378a:	6384                	ld	s1,0(a5)
    assert(pgdir[0] == 0);
ffffffffc020378c:	609c                	ld	a5,0(s1)
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020378e:	ed04                	sd	s1,24(a0)
    assert(pgdir[0] == 0);
ffffffffc0203790:	32079d63          	bnez	a5,ffffffffc0203aca <vmm_init+0x51e>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203794:	03000513          	li	a0,48
ffffffffc0203798:	ef3fe0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc020379c:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc020379e:	14050a63          	beqz	a0,ffffffffc02038f2 <vmm_init+0x346>
        vma->vm_end = vm_end;
ffffffffc02037a2:	002007b7          	lui	a5,0x200
ffffffffc02037a6:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02037aa:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02037ac:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02037ae:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02037b2:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02037b4:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02037b8:	cf1ff0ef          	jal	ra,ffffffffc02034a8 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02037bc:	10000593          	li	a1,256
ffffffffc02037c0:	8522                	mv	a0,s0
ffffffffc02037c2:	ca9ff0ef          	jal	ra,ffffffffc020346a <find_vma>
ffffffffc02037c6:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02037ca:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02037ce:	2aaa1263          	bne	s4,a0,ffffffffc0203a72 <vmm_init+0x4c6>
        *(char *)(addr + i) = i;
ffffffffc02037d2:	00f78023          	sb	a5,0(a5) # 200000 <BASE_ADDRESS-0xffffffffc0000000>
        sum += i;
ffffffffc02037d6:	0785                	addi	a5,a5,1
    for (i = 0; i < 100; i ++) {
ffffffffc02037d8:	fee79de3          	bne	a5,a4,ffffffffc02037d2 <vmm_init+0x226>
        sum += i;
ffffffffc02037dc:	6705                	lui	a4,0x1
    for (i = 0; i < 100; i ++) {
ffffffffc02037de:	10000793          	li	a5,256
        sum += i;
ffffffffc02037e2:	35670713          	addi	a4,a4,854 # 1356 <BASE_ADDRESS-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02037e6:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02037ea:	0007c683          	lbu	a3,0(a5)
ffffffffc02037ee:	0785                	addi	a5,a5,1
ffffffffc02037f0:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02037f2:	fec79ce3          	bne	a5,a2,ffffffffc02037ea <vmm_init+0x23e>
    }
    assert(sum == 0);
ffffffffc02037f6:	2a071a63          	bnez	a4,ffffffffc0203aaa <vmm_init+0x4fe>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02037fa:	4581                	li	a1,0
ffffffffc02037fc:	8526                	mv	a0,s1
ffffffffc02037fe:	9d4fe0ef          	jal	ra,ffffffffc02019d2 <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203802:	609c                	ld	a5,0(s1)
    if (PPN(pa) >= npage) {
ffffffffc0203804:	0000e717          	auipc	a4,0xe
ffffffffc0203808:	c5470713          	addi	a4,a4,-940 # ffffffffc0211458 <npage>
ffffffffc020380c:	6318                	ld	a4,0(a4)
    return pa2page(PDE_ADDR(pde));
ffffffffc020380e:	078a                	slli	a5,a5,0x2
ffffffffc0203810:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203812:	28e7f063          	bleu	a4,a5,ffffffffc0203a92 <vmm_init+0x4e6>
    return &pages[PPN(pa) - nbase];
ffffffffc0203816:	00003717          	auipc	a4,0x3
ffffffffc020381a:	8ea70713          	addi	a4,a4,-1814 # ffffffffc0206100 <nbase>
ffffffffc020381e:	6318                	ld	a4,0(a4)
ffffffffc0203820:	0000e697          	auipc	a3,0xe
ffffffffc0203824:	c8868693          	addi	a3,a3,-888 # ffffffffc02114a8 <pages>
ffffffffc0203828:	6288                	ld	a0,0(a3)
...
ffffffffc0203834:	953e                	add	a0,a0,a5
ffffffffc0203836:	4585                	li	a1,1
ffffffffc0203838:	eaffd0ef          	jal	ra,ffffffffc02016e6 <free_pages>

    pgdir[0] = 0;
ffffffffc020383c:	0004b023          	sd	zero,0(s1)

    mm->pgdir = NULL;
    mm_destroy(mm);
ffffffffc0203840:	8522                	mv	a0,s0
    mm->pgdir = NULL;
ffffffffc0203842:	00043c23          	sd	zero,24(s0)
    mm_destroy(mm);
ffffffffc0203846:	d31ff0ef          	jal	ra,ffffffffc0203576 <mm_destroy>

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc020384a:	19fd                	addi	s3,s3,-1
    check_mm_struct = NULL;
ffffffffc020384c:	0000e797          	auipc	a5,0xe
ffffffffc0203850:	d407b223          	sd	zero,-700(a5) # ffffffffc0211590 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203854:	ed9fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc0203858:	1aa99d63          	bne	s3,a0,ffffffffc0203a12 <vmm_init+0x466>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc020385c:	00002517          	auipc	a0,0x2
ffffffffc0203860:	5cc50513          	addi	a0,a0,1484 # ffffffffc0205e28 <default_pmm_manager+0xe08>
ffffffffc0203864:	85bfc0ef          	jal	ra,ffffffffc02000be <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203868:	ec5fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc020386c:	197d                	addi	s2,s2,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020386e:	1ea91263          	bne	s2,a0,ffffffffc0203a52 <vmm_init+0x4a6>
}
ffffffffc0203872:	6406                	ld	s0,64(sp)
ffffffffc0203874:	60a6                	ld	ra,72(sp)
ffffffffc0203876:	74e2                	ld	s1,56(sp)
ffffffffc0203878:	7942                	ld	s2,48(sp)
ffffffffc020387a:	79a2                	ld	s3,40(sp)
ffffffffc020387c:	7a02                	ld	s4,32(sp)
ffffffffc020387e:	6ae2                	ld	s5,24(sp)
ffffffffc0203880:	6b42                	ld	s6,16(sp)
ffffffffc0203882:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203884:	00002517          	auipc	a0,0x2
ffffffffc0203888:	5c450513          	addi	a0,a0,1476 # ffffffffc0205e48 <default_pmm_manager+0xe28>
}
ffffffffc020388c:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc020388e:	831fc06f          	j	ffffffffc02000be <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203892:	00002697          	auipc	a3,0x2
ffffffffc0203896:	3de68693          	addi	a3,a3,990 # ffffffffc0205c70 <default_pmm_manager+0xc50>
ffffffffc020389a:	00001617          	auipc	a2,0x1
ffffffffc020389e:	3ee60613          	addi	a2,a2,1006 # ffffffffc0204c88 <commands+0x870>
ffffffffc02038a2:	0dd00593          	li	a1,221
ffffffffc02038a6:	00002517          	auipc	a0,0x2
ffffffffc02038aa:	29250513          	addi	a0,a0,658 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02038ae:	ac7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038b2:	00002697          	auipc	a3,0x2
ffffffffc02038b6:	44668693          	addi	a3,a3,1094 # ffffffffc0205cf8 <default_pmm_manager+0xcd8>
ffffffffc02038ba:	00001617          	auipc	a2,0x1
ffffffffc02038be:	3ce60613          	addi	a2,a2,974 # ffffffffc0204c88 <commands+0x870>
ffffffffc02038c2:	0ed00593          	li	a1,237
ffffffffc02038c6:	00002517          	auipc	a0,0x2
ffffffffc02038ca:	27250513          	addi	a0,a0,626 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02038ce:	aa7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038d2:	00002697          	auipc	a3,0x2
ffffffffc02038d6:	45668693          	addi	a3,a3,1110 # ffffffffc0205d28 <default_pmm_manager+0xd08>
ffffffffc02038da:	00001617          	auipc	a2,0x1
ffffffffc02038de:	3ae60613          	addi	a2,a2,942 # ffffffffc0204c88 <commands+0x870>
ffffffffc02038e2:	0ee00593          	li	a1,238
ffffffffc02038e6:	00002517          	auipc	a0,0x2
ffffffffc02038ea:	25250513          	addi	a0,a0,594 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02038ee:	a87fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc02038f2:	00002697          	auipc	a3,0x2
ffffffffc02038f6:	ec668693          	addi	a3,a3,-314 # ffffffffc02057b8 <default_pmm_manager+0x798>
ffffffffc02038fa:	00001617          	auipc	a2,0x1
ffffffffc02038fe:	38e60613          	addi	a2,a2,910 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203902:	11100593          	li	a1,273
ffffffffc0203906:	00002517          	auipc	a0,0x2
ffffffffc020390a:	23250513          	addi	a0,a0,562 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc020390e:	a67fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203912:	00002697          	auipc	a3,0x2
ffffffffc0203916:	34668693          	addi	a3,a3,838 # ffffffffc0205c58 <default_pmm_manager+0xc38>
ffffffffc020391a:	00001617          	auipc	a2,0x1
ffffffffc020391e:	36e60613          	addi	a2,a2,878 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203922:	0db00593          	li	a1,219
ffffffffc0203926:	00002517          	auipc	a0,0x2
ffffffffc020392a:	21250513          	addi	a0,a0,530 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc020392e:	a47fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203932:	00002697          	auipc	a3,0x2
ffffffffc0203936:	3a668693          	addi	a3,a3,934 # ffffffffc0205cd8 <default_pmm_manager+0xcb8>
ffffffffc020393a:	00001617          	auipc	a2,0x1
ffffffffc020393e:	34e60613          	addi	a2,a2,846 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203942:	0e900593          	li	a1,233
ffffffffc0203946:	00002517          	auipc	a0,0x2
ffffffffc020394a:	1f250513          	addi	a0,a0,498 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc020394e:	a27fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203952:	00002697          	auipc	a3,0x2
ffffffffc0203956:	37668693          	addi	a3,a3,886 # ffffffffc0205cc8 <default_pmm_manager+0xca8>
ffffffffc020395a:	00001617          	auipc	a2,0x1
ffffffffc020395e:	32e60613          	addi	a2,a2,814 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203962:	0e700593          	li	a1,231
ffffffffc0203966:	00002517          	auipc	a0,0x2
ffffffffc020396a:	1d250513          	addi	a0,a0,466 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc020396e:	a07fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203972:	00002697          	auipc	a3,0x2
ffffffffc0203976:	34668693          	addi	a3,a3,838 # ffffffffc0205cb8 <default_pmm_manager+0xc98>
ffffffffc020397a:	00001617          	auipc	a2,0x1
ffffffffc020397e:	30e60613          	addi	a2,a2,782 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203982:	0e500593          	li	a1,229
ffffffffc0203986:	00002517          	auipc	a0,0x2
ffffffffc020398a:	1b250513          	addi	a0,a0,434 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc020398e:	9e7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203992:	00002697          	auipc	a3,0x2
ffffffffc0203996:	31668693          	addi	a3,a3,790 # ffffffffc0205ca8 <default_pmm_manager+0xc88>
ffffffffc020399a:	00001617          	auipc	a2,0x1
ffffffffc020399e:	2ee60613          	addi	a2,a2,750 # ffffffffc0204c88 <commands+0x870>
ffffffffc02039a2:	0e300593          	li	a1,227
ffffffffc02039a6:	00002517          	auipc	a0,0x2
ffffffffc02039aa:	19250513          	addi	a0,a0,402 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02039ae:	9c7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc02039b2:	00002697          	auipc	a3,0x2
ffffffffc02039b6:	33668693          	addi	a3,a3,822 # ffffffffc0205ce8 <default_pmm_manager+0xcc8>
ffffffffc02039ba:	00001617          	auipc	a2,0x1
ffffffffc02039be:	2ce60613          	addi	a2,a2,718 # ffffffffc0204c88 <commands+0x870>
ffffffffc02039c2:	0eb00593          	li	a1,235
ffffffffc02039c6:	00002517          	auipc	a0,0x2
ffffffffc02039ca:	17250513          	addi	a0,a0,370 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02039ce:	9a7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc02039d2:	00002697          	auipc	a3,0x2
ffffffffc02039d6:	dae68693          	addi	a3,a3,-594 # ffffffffc0205780 <default_pmm_manager+0x760>
ffffffffc02039da:	00001617          	auipc	a2,0x1
ffffffffc02039de:	2ae60613          	addi	a2,a2,686 # ffffffffc0204c88 <commands+0x870>
ffffffffc02039e2:	0c700593          	li	a1,199
ffffffffc02039e6:	00002517          	auipc	a0,0x2
ffffffffc02039ea:	15250513          	addi	a0,a0,338 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc02039ee:	987fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039f2:	00002697          	auipc	a3,0x2
ffffffffc02039f6:	3a668693          	addi	a3,a3,934 # ffffffffc0205d98 <default_pmm_manager+0xd78>
ffffffffc02039fa:	00001617          	auipc	a2,0x1
ffffffffc02039fe:	28e60613          	addi	a2,a2,654 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203a02:	0fb00593          	li	a1,251
ffffffffc0203a06:	00002517          	auipc	a0,0x2
ffffffffc0203a0a:	13250513          	addi	a0,a0,306 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203a0e:	967fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a12:	00002697          	auipc	a3,0x2
ffffffffc0203a16:	38668693          	addi	a3,a3,902 # ffffffffc0205d98 <default_pmm_manager+0xd78>
ffffffffc0203a1a:	00001617          	auipc	a2,0x1
ffffffffc0203a1e:	26e60613          	addi	a2,a2,622 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203a22:	12e00593          	li	a1,302
ffffffffc0203a26:	00002517          	auipc	a0,0x2
ffffffffc0203a2a:	11250513          	addi	a0,a0,274 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203a2e:	947fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203a32:	00002697          	auipc	a3,0x2
ffffffffc0203a36:	3ae68693          	addi	a3,a3,942 # ffffffffc0205de0 <default_pmm_manager+0xdc0>
ffffffffc0203a3a:	00001617          	auipc	a2,0x1
ffffffffc0203a3e:	24e60613          	addi	a2,a2,590 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203a42:	10a00593          	li	a1,266
ffffffffc0203a46:	00002517          	auipc	a0,0x2
ffffffffc0203a4a:	0f250513          	addi	a0,a0,242 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203a4e:	927fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a52:	00002697          	auipc	a3,0x2
ffffffffc0203a56:	34668693          	addi	a3,a3,838 # ffffffffc0205d98 <default_pmm_manager+0xd78>
ffffffffc0203a5a:	00001617          	auipc	a2,0x1
ffffffffc0203a5e:	22e60613          	addi	a2,a2,558 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203a62:	0bd00593          	li	a1,189
ffffffffc0203a66:	00002517          	auipc	a0,0x2
ffffffffc0203a6a:	0d250513          	addi	a0,a0,210 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203a6e:	907fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a72:	00002697          	auipc	a3,0x2
ffffffffc0203a76:	38668693          	addi	a3,a3,902 # ffffffffc0205df8 <default_pmm_manager+0xdd8>
ffffffffc0203a7a:	00001617          	auipc	a2,0x1
ffffffffc0203a7e:	20e60613          	addi	a2,a2,526 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203a82:	11600593          	li	a1,278
ffffffffc0203a86:	00002517          	auipc	a0,0x2
ffffffffc0203a8a:	0b250513          	addi	a0,a0,178 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203a8e:	8e7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203a92:	00001617          	auipc	a2,0x1
ffffffffc0203a96:	65660613          	addi	a2,a2,1622 # ffffffffc02050e8 <default_pmm_manager+0xc8>
ffffffffc0203a9a:	06500593          	li	a1,101
ffffffffc0203a9e:	00001517          	auipc	a0,0x1
ffffffffc0203aa2:	66a50513          	addi	a0,a0,1642 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0203aa6:	8cffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203aaa:	00002697          	auipc	a3,0x2
ffffffffc0203aae:	36e68693          	addi	a3,a3,878 # ffffffffc0205e18 <default_pmm_manager+0xdf8>
ffffffffc0203ab2:	00001617          	auipc	a2,0x1
ffffffffc0203ab6:	1d660613          	addi	a2,a2,470 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203aba:	12000593          	li	a1,288
ffffffffc0203abe:	00002517          	auipc	a0,0x2
ffffffffc0203ac2:	07a50513          	addi	a0,a0,122 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203ac6:	8affc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203aca:	00002697          	auipc	a3,0x2
ffffffffc0203ace:	cde68693          	addi	a3,a3,-802 # ffffffffc02057a8 <default_pmm_manager+0x788>
ffffffffc0203ad2:	00001617          	auipc	a2,0x1
ffffffffc0203ad6:	1b660613          	addi	a2,a2,438 # ffffffffc0204c88 <commands+0x870>
ffffffffc0203ada:	10d00593          	li	a1,269
ffffffffc0203ade:	00002517          	auipc	a0,0x2
ffffffffc0203ae2:	05a50513          	addi	a0,a0,90 # ffffffffc0205b38 <default_pmm_manager+0xb18>
ffffffffc0203ae6:	88ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203aea <do_pgfault>:
...
ffffffffc0203aee:	a9e78793          	addi	a5,a5,-1378 # ffffffffc0211588 <curr_ptr>
ffffffffc0203af2:	638c                	ld	a1,0(a5)
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203af4:	7139                	addi	sp,sp,-64
ffffffffc0203af6:	f426                	sd	s1,40(sp)
ffffffffc0203af8:	84aa                	mv	s1,a0
    cprintf("curr_ptr %p\n", (void*)curr_ptr);
ffffffffc0203afa:	00002517          	auipc	a0,0x2
ffffffffc0203afe:	04e50513          	addi	a0,a0,78 # ffffffffc0205b48 <default_pmm_manager+0xb28>
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203b02:	fc06                	sd	ra,56(sp)
ffffffffc0203b04:	f822                	sd	s0,48(sp)
ffffffffc0203b06:	f04a                	sd	s2,32(sp)
ffffffffc0203b08:	8432                	mv	s0,a2
ffffffffc0203b0a:	ec4e                	sd	s3,24(sp)
    cprintf("curr_ptr %p\n", (void*)curr_ptr);
ffffffffc0203b0c:	db2fc0ef          	jal	ra,ffffffffc02000be <cprintf>

    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203b10:	85a2                	mv	a1,s0
ffffffffc0203b12:	8526                	mv	a0,s1
ffffffffc0203b14:	957ff0ef          	jal	ra,ffffffffc020346a <find_vma>
...
ffffffffc0203b2c:	c559                	beqz	a0,ffffffffc0203bba <do_pgfault+0xd0>
ffffffffc0203b2e:	651c                	ld	a5,8(a0)
ffffffffc0203b30:	08f46563          	bltu	s0,a5,ffffffffc0203bba <do_pgfault+0xd0>
     * THEN
     *    continue process
     */
...
ffffffffc0203b34:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203b36:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203b38:	8b89                	andi	a5,a5,2
ffffffffc0203b3a:	efb9                	bnez	a5,ffffffffc0203b98 <do_pgfault+0xae>
        perm |= (PTE_R | PTE_W);
    }
...
ffffffffc0203b4c:	c9a1                	beqz	a1,ffffffffc0203b9c <do_pgfault+0xb2>
...
ffffffffc0203b5a:	cbad                	beqz	a5,ffffffffc0203bcc <do_pgfault+0xe2>
...
ffffffffc0203b6a:	e92d                	bnez	a0,ffffffffc0203bdc <do_pgfault+0xf2>
            {
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203b6c:	65a2                	ld	a1,8(sp)
ffffffffc0203b6e:	6c88                	ld	a0,24(s1)
ffffffffc0203b70:	86ce                	mv	a3,s3
ffffffffc0203b72:	8622                	mv	a2,s0
ffffffffc0203b74:	ed1fd0ef          	jal	ra,ffffffffc0201a44 <page_insert>
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203b78:	6622                	ld	a2,8(sp)
ffffffffc0203b7a:	4685                	li	a3,1
ffffffffc0203b7c:	85a2                	mv	a1,s0
ffffffffc0203b7e:	8526                	mv	a0,s1
ffffffffc0203b80:	b3cff0ef          	jal	ra,ffffffffc0202ebc <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203b84:	67a2                	ld	a5,8(sp)
ffffffffc0203b86:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203b88:	70e2                	ld	ra,56(sp)
ffffffffc0203b8a:	7442                	ld	s0,48(sp)
ffffffffc0203b8c:	854a                	mv	a0,s2
ffffffffc0203b8e:	74a2                	ld	s1,40(sp)
ffffffffc0203b90:	7902                	ld	s2,32(sp)
ffffffffc0203b92:	69e2                	ld	s3,24(sp)
ffffffffc0203b94:	6121                	addi	sp,sp,64
ffffffffc0203b96:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203b98:	49d9                	li	s3,22
ffffffffc0203b9a:	b74d                	j	ffffffffc0203b3c <do_pgfault+0x52>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203b9c:	6c88                	ld	a0,24(s1)
ffffffffc0203b9e:	864e                	mv	a2,s3
ffffffffc0203ba0:	85a2                	mv	a1,s0
ffffffffc0203ba2:	a57fe0ef          	jal	ra,ffffffffc02025f8 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203ba6:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203ba8:	f165                	bnez	a0,ffffffffc0203b88 <do_pgfault+0x9e>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203baa:	00002517          	auipc	a0,0x2
ffffffffc0203bae:	fde50513          	addi	a0,a0,-34 # ffffffffc0205b88 <default_pmm_manager+0xb68>
ffffffffc0203bb2:	d0cfc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203bb6:	5971                	li	s2,-4
            goto failed;
ffffffffc0203bb8:	bfc1                	j	ffffffffc0203b88 <do_pgfault+0x9e>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203bba:	85a2                	mv	a1,s0
ffffffffc0203bbc:	00002517          	auipc	a0,0x2
ffffffffc0203bc0:	f9c50513          	addi	a0,a0,-100 # ffffffffc0205b58 <default_pmm_manager+0xb38>
ffffffffc0203bc4:	cfafc0ef          	jal	ra,ffffffffc02000be <cprintf>
    int ret = -E_INVAL;
ffffffffc0203bc8:	5975                	li	s2,-3
        goto failed;
ffffffffc0203bca:	bf7d                	j	ffffffffc0203b88 <do_pgfault+0x9e>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203bcc:	00002517          	auipc	a0,0x2
ffffffffc0203bd0:	00450513          	addi	a0,a0,4 # ffffffffc0205bd0 <default_pmm_manager+0xbb0>
ffffffffc0203bd4:	ceafc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203bd8:	5971                	li	s2,-4
            goto failed;
ffffffffc0203bda:	b77d                	j	ffffffffc0203b88 <do_pgfault+0x9e>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203bdc:	00002517          	auipc	a0,0x2
ffffffffc0203be0:	fd450513          	addi	a0,a0,-44 # ffffffffc0205bb0 <default_pmm_manager+0xb90>
ffffffffc0203be4:	cdafc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203be8:	5971                	li	s2,-4
ffffffffc0203bea:	bf79                	j	ffffffffc0203b88 <do_pgfault+0x9e>
...
ffffffffc0203c32:	90a70713          	addi	a4,a4,-1782 # ffffffffc0211538 <max_swap_offset>
...
ffffffffc0203c40:	86c70713          	addi	a4,a4,-1940 # ffffffffc02114a8 <pages>
ffffffffc0203c44:	6310                	ld	a2,0(a4)
ffffffffc0203c46:	00001717          	auipc	a4,0x1
ffffffffc0203c4a:	02a70713          	addi	a4,a4,42 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0203c84:	81878793          	addi	a5,a5,-2024 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203c92:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c94:	817fc06f          	j	ffffffffc02004aa <ide_read_secs>
ffffffffc0203c98:	86aa                	mv	a3,a0
ffffffffc0203c9a:	00002617          	auipc	a2,0x2
ffffffffc0203c9e:	1fe60613          	addi	a2,a2,510 # ffffffffc0205e98 <default_pmm_manager+0xe78>
ffffffffc0203ca2:	45d1                	li	a1,20
ffffffffc0203ca4:	00002517          	auipc	a0,0x2
ffffffffc0203ca8:	1dc50513          	addi	a0,a0,476 # ffffffffc0205e80 <default_pmm_manager+0xe60>
...
ffffffffc0203cba:	3ba60613          	addi	a2,a2,954 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0203cbe:	00001517          	auipc	a0,0x1
ffffffffc0203cc2:	44a50513          	addi	a0,a0,1098 # ffffffffc0205108 <default_pmm_manager+0xe8>
...
ffffffffc0203cd8:	86470713          	addi	a4,a4,-1948 # ffffffffc0211538 <max_swap_offset>
...
ffffffffc0203ce6:	7c670713          	addi	a4,a4,1990 # ffffffffc02114a8 <pages>
ffffffffc0203cea:	6310                	ld	a2,0(a4)
ffffffffc0203cec:	00001717          	auipc	a4,0x1
ffffffffc0203cf0:	f8470713          	addi	a4,a4,-124 # ffffffffc0204c70 <commands+0x858>
...
ffffffffc0203d2a:	77278793          	addi	a5,a5,1906 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203d38:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d3a:	f94fc06f          	j	ffffffffc02004ce <ide_write_secs>
ffffffffc0203d3e:	86aa                	mv	a3,a0
ffffffffc0203d40:	00002617          	auipc	a2,0x2
ffffffffc0203d44:	15860613          	addi	a2,a2,344 # ffffffffc0205e98 <default_pmm_manager+0xe78>
ffffffffc0203d48:	45e5                	li	a1,25
ffffffffc0203d4a:	00002517          	auipc	a0,0x2
ffffffffc0203d4e:	13650513          	addi	a0,a0,310 # ffffffffc0205e80 <default_pmm_manager+0xe60>
...
ffffffffc0203d60:	31460613          	addi	a2,a2,788 # ffffffffc0205070 <default_pmm_manager+0x50>
ffffffffc0203d64:	00001517          	auipc	a0,0x1
ffffffffc0203d68:	3a450513          	addi	a0,a0,932 # ffffffffc0205108 <default_pmm_manager+0xe8>
ffffffffc0203d6c:	e08fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d70 <printnum>:
 * */
static void
...
ffffffffc0203d70:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d74:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203d76:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d7a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203d7c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d80:	f022                	sd	s0,32(sp)
ffffffffc0203d82:	ec26                	sd	s1,24(sp)
ffffffffc0203d84:	e84a                	sd	s2,16(sp)
ffffffffc0203d86:	f406                	sd	ra,40(sp)
ffffffffc0203d88:	e44e                	sd	s3,8(sp)
ffffffffc0203d8a:	84aa                	mv	s1,a0
ffffffffc0203d8c:	892e                	mv	s2,a1
ffffffffc0203d8e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203d92:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0203d94:	03067e63          	bleu	a6,a2,ffffffffc0203dd0 <printnum+0x60>
ffffffffc0203d98:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc0203d9a:	00805763          	blez	s0,ffffffffc0203da8 <printnum+0x38>
ffffffffc0203d9e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203da0:	85ca                	mv	a1,s2
ffffffffc0203da2:	854e                	mv	a0,s3
ffffffffc0203da4:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203da6:	fc65                	bnez	s0,ffffffffc0203d9e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203da8:	1a02                	slli	s4,s4,0x20
ffffffffc0203daa:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203dae:	00002797          	auipc	a5,0x2
ffffffffc0203db2:	29a78793          	addi	a5,a5,666 # ffffffffc0206048 <error_string+0x38>
ffffffffc0203db6:	9a3e                	add	s4,s4,a5
}
ffffffffc0203db8:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203dba:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203dbe:	70a2                	ld	ra,40(sp)
ffffffffc0203dc0:	69a2                	ld	s3,8(sp)
ffffffffc0203dc2:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203dc4:	85ca                	mv	a1,s2
ffffffffc0203dc6:	8326                	mv	t1,s1
}
ffffffffc0203dc8:	6942                	ld	s2,16(sp)
ffffffffc0203dca:	64e2                	ld	s1,24(sp)
ffffffffc0203dcc:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203dce:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203dd0:	03065633          	divu	a2,a2,a6
ffffffffc0203dd4:	8722                	mv	a4,s0
ffffffffc0203dd6:	f9bff0ef          	jal	ra,ffffffffc0203d70 <printnum>
ffffffffc0203dda:	b7f9                	j	ffffffffc0203da8 <printnum+0x38>

ffffffffc0203ddc <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203ddc:	7119                	addi	sp,sp,-128
ffffffffc0203dde:	f4a6                	sd	s1,104(sp)
ffffffffc0203de0:	f0ca                	sd	s2,96(sp)
ffffffffc0203de2:	e8d2                	sd	s4,80(sp)
ffffffffc0203de4:	e4d6                	sd	s5,72(sp)
ffffffffc0203de6:	e0da                	sd	s6,64(sp)
ffffffffc0203de8:	fc5e                	sd	s7,56(sp)
ffffffffc0203dea:	f862                	sd	s8,48(sp)
ffffffffc0203dec:	f06a                	sd	s10,32(sp)
ffffffffc0203dee:	fc86                	sd	ra,120(sp)
ffffffffc0203df0:	f8a2                	sd	s0,112(sp)
ffffffffc0203df2:	ecce                	sd	s3,88(sp)
ffffffffc0203df4:	f466                	sd	s9,40(sp)
ffffffffc0203df6:	ec6e                	sd	s11,24(sp)
ffffffffc0203df8:	892a                	mv	s2,a0
ffffffffc0203dfa:	84ae                	mv	s1,a1
ffffffffc0203dfc:	8d32                	mv	s10,a2
ffffffffc0203dfe:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203e00:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e02:	00002a17          	auipc	s4,0x2
ffffffffc0203e06:	0b6a0a13          	addi	s4,s4,182 # ffffffffc0205eb8 <default_pmm_manager+0xe98>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203e0a:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203e0e:	00002c17          	auipc	s8,0x2
ffffffffc0203e12:	202c0c13          	addi	s8,s8,514 # ffffffffc0206010 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e16:	000d4503          	lbu	a0,0(s10)
ffffffffc0203e1a:	02500793          	li	a5,37
ffffffffc0203e1e:	001d0413          	addi	s0,s10,1
ffffffffc0203e22:	00f50e63          	beq	a0,a5,ffffffffc0203e3e <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0203e26:	c521                	beqz	a0,ffffffffc0203e6e <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e28:	02500993          	li	s3,37
ffffffffc0203e2c:	a011                	j	ffffffffc0203e30 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0203e2e:	c121                	beqz	a0,ffffffffc0203e6e <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0203e30:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e32:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203e34:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e36:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203e3a:	ff351ae3          	bne	a0,s3,ffffffffc0203e2e <vprintfmt+0x52>
ffffffffc0203e3e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203e42:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203e46:	4981                	li	s3,0
ffffffffc0203e48:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0203e4a:	5cfd                	li	s9,-1
ffffffffc0203e4c:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e4e:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0203e52:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e54:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0203e58:	0ff6f693          	andi	a3,a3,255
ffffffffc0203e5c:	00140d13          	addi	s10,s0,1
ffffffffc0203e60:	20d5e563          	bltu	a1,a3,ffffffffc020406a <vprintfmt+0x28e>
ffffffffc0203e64:	068a                	slli	a3,a3,0x2
ffffffffc0203e66:	96d2                	add	a3,a3,s4
ffffffffc0203e68:	4294                	lw	a3,0(a3)
ffffffffc0203e6a:	96d2                	add	a3,a3,s4
ffffffffc0203e6c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203e6e:	70e6                	ld	ra,120(sp)
ffffffffc0203e70:	7446                	ld	s0,112(sp)
ffffffffc0203e72:	74a6                	ld	s1,104(sp)
ffffffffc0203e74:	7906                	ld	s2,96(sp)
ffffffffc0203e76:	69e6                	ld	s3,88(sp)
ffffffffc0203e78:	6a46                	ld	s4,80(sp)
ffffffffc0203e7a:	6aa6                	ld	s5,72(sp)
ffffffffc0203e7c:	6b06                	ld	s6,64(sp)
ffffffffc0203e7e:	7be2                	ld	s7,56(sp)
ffffffffc0203e80:	7c42                	ld	s8,48(sp)
ffffffffc0203e82:	7ca2                	ld	s9,40(sp)
ffffffffc0203e84:	7d02                	ld	s10,32(sp)
ffffffffc0203e86:	6de2                	ld	s11,24(sp)
ffffffffc0203e88:	6109                	addi	sp,sp,128
ffffffffc0203e8a:	8082                	ret
    if (lflag >= 2) {
ffffffffc0203e8c:	4705                	li	a4,1
ffffffffc0203e8e:	008a8593          	addi	a1,s5,8
ffffffffc0203e92:	01074463          	blt	a4,a6,ffffffffc0203e9a <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0203e96:	26080363          	beqz	a6,ffffffffc02040fc <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0203e9a:	000ab603          	ld	a2,0(s5)
ffffffffc0203e9e:	46c1                	li	a3,16
ffffffffc0203ea0:	8aae                	mv	s5,a1
ffffffffc0203ea2:	a06d                	j	ffffffffc0203f4c <vprintfmt+0x170>
            goto reswitch;
ffffffffc0203ea4:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203ea8:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203eaa:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203eac:	b765                	j	ffffffffc0203e54 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0203eae:	000aa503          	lw	a0,0(s5)
ffffffffc0203eb2:	85a6                	mv	a1,s1
ffffffffc0203eb4:	0aa1                	addi	s5,s5,8
ffffffffc0203eb6:	9902                	jalr	s2
            break;
ffffffffc0203eb8:	bfb9                	j	ffffffffc0203e16 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203eba:	4705                	li	a4,1
ffffffffc0203ebc:	008a8993          	addi	s3,s5,8
ffffffffc0203ec0:	01074463          	blt	a4,a6,ffffffffc0203ec8 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0203ec4:	22080463          	beqz	a6,ffffffffc02040ec <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0203ec8:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0203ecc:	24044463          	bltz	s0,ffffffffc0204114 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0203ed0:	8622                	mv	a2,s0
ffffffffc0203ed2:	8ace                	mv	s5,s3
ffffffffc0203ed4:	46a9                	li	a3,10
ffffffffc0203ed6:	a89d                	j	ffffffffc0203f4c <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0203ed8:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203edc:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203ede:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0203ee0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203ee4:	8fb5                	xor	a5,a5,a3
ffffffffc0203ee6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203eea:	1ad74363          	blt	a4,a3,ffffffffc0204090 <vprintfmt+0x2b4>
ffffffffc0203eee:	00369793          	slli	a5,a3,0x3
ffffffffc0203ef2:	97e2                	add	a5,a5,s8
ffffffffc0203ef4:	639c                	ld	a5,0(a5)
ffffffffc0203ef6:	18078d63          	beqz	a5,ffffffffc0204090 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203efa:	86be                	mv	a3,a5
ffffffffc0203efc:	00002617          	auipc	a2,0x2
ffffffffc0203f00:	1fc60613          	addi	a2,a2,508 # ffffffffc02060f8 <error_string+0xe8>
ffffffffc0203f04:	85a6                	mv	a1,s1
ffffffffc0203f06:	854a                	mv	a0,s2
ffffffffc0203f08:	240000ef          	jal	ra,ffffffffc0204148 <printfmt>
ffffffffc0203f0c:	b729                	j	ffffffffc0203e16 <vprintfmt+0x3a>
            lflag ++;
ffffffffc0203f0e:	00144603          	lbu	a2,1(s0)
ffffffffc0203f12:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f14:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203f16:	bf3d                	j	ffffffffc0203e54 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0203f18:	4705                	li	a4,1
ffffffffc0203f1a:	008a8593          	addi	a1,s5,8
ffffffffc0203f1e:	01074463          	blt	a4,a6,ffffffffc0203f26 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0203f22:	1e080263          	beqz	a6,ffffffffc0204106 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0203f26:	000ab603          	ld	a2,0(s5)
ffffffffc0203f2a:	46a1                	li	a3,8
ffffffffc0203f2c:	8aae                	mv	s5,a1
ffffffffc0203f2e:	a839                	j	ffffffffc0203f4c <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0203f30:	03000513          	li	a0,48
ffffffffc0203f34:	85a6                	mv	a1,s1
ffffffffc0203f36:	e03e                	sd	a5,0(sp)
ffffffffc0203f38:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203f3a:	85a6                	mv	a1,s1
ffffffffc0203f3c:	07800513          	li	a0,120
ffffffffc0203f40:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203f42:	0aa1                	addi	s5,s5,8
ffffffffc0203f44:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0203f48:	6782                	ld	a5,0(sp)
ffffffffc0203f4a:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203f4c:	876e                	mv	a4,s11
ffffffffc0203f4e:	85a6                	mv	a1,s1
ffffffffc0203f50:	854a                	mv	a0,s2
ffffffffc0203f52:	e1fff0ef          	jal	ra,ffffffffc0203d70 <printnum>
            break;
ffffffffc0203f56:	b5c1                	j	ffffffffc0203e16 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203f58:	000ab603          	ld	a2,0(s5)
ffffffffc0203f5c:	0aa1                	addi	s5,s5,8
ffffffffc0203f5e:	1c060663          	beqz	a2,ffffffffc020412a <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0203f62:	00160413          	addi	s0,a2,1
ffffffffc0203f66:	17b05c63          	blez	s11,ffffffffc02040de <vprintfmt+0x302>
ffffffffc0203f6a:	02d00593          	li	a1,45
ffffffffc0203f6e:	14b79263          	bne	a5,a1,ffffffffc02040b2 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f72:	00064783          	lbu	a5,0(a2)
ffffffffc0203f76:	0007851b          	sext.w	a0,a5
ffffffffc0203f7a:	c905                	beqz	a0,ffffffffc0203faa <vprintfmt+0x1ce>
ffffffffc0203f7c:	000cc563          	bltz	s9,ffffffffc0203f86 <vprintfmt+0x1aa>
ffffffffc0203f80:	3cfd                	addiw	s9,s9,-1
ffffffffc0203f82:	036c8263          	beq	s9,s6,ffffffffc0203fa6 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0203f86:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203f88:	18098463          	beqz	s3,ffffffffc0204110 <vprintfmt+0x334>
ffffffffc0203f8c:	3781                	addiw	a5,a5,-32
ffffffffc0203f8e:	18fbf163          	bleu	a5,s7,ffffffffc0204110 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0203f92:	03f00513          	li	a0,63
ffffffffc0203f96:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f98:	0405                	addi	s0,s0,1
ffffffffc0203f9a:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f9e:	3dfd                	addiw	s11,s11,-1
ffffffffc0203fa0:	0007851b          	sext.w	a0,a5
ffffffffc0203fa4:	fd61                	bnez	a0,ffffffffc0203f7c <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0203fa6:	e7b058e3          	blez	s11,ffffffffc0203e16 <vprintfmt+0x3a>
ffffffffc0203faa:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203fac:	85a6                	mv	a1,s1
ffffffffc0203fae:	02000513          	li	a0,32
ffffffffc0203fb2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203fb4:	e60d81e3          	beqz	s11,ffffffffc0203e16 <vprintfmt+0x3a>
ffffffffc0203fb8:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203fba:	85a6                	mv	a1,s1
ffffffffc0203fbc:	02000513          	li	a0,32
ffffffffc0203fc0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203fc2:	fe0d94e3          	bnez	s11,ffffffffc0203faa <vprintfmt+0x1ce>
ffffffffc0203fc6:	bd81                	j	ffffffffc0203e16 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203fc8:	4705                	li	a4,1
ffffffffc0203fca:	008a8593          	addi	a1,s5,8
ffffffffc0203fce:	01074463          	blt	a4,a6,ffffffffc0203fd6 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0203fd2:	12080063          	beqz	a6,ffffffffc02040f2 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0203fd6:	000ab603          	ld	a2,0(s5)
ffffffffc0203fda:	46a9                	li	a3,10
ffffffffc0203fdc:	8aae                	mv	s5,a1
ffffffffc0203fde:	b7bd                	j	ffffffffc0203f4c <vprintfmt+0x170>
ffffffffc0203fe0:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0203fe4:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fe8:	846a                	mv	s0,s10
ffffffffc0203fea:	b5ad                	j	ffffffffc0203e54 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0203fec:	85a6                	mv	a1,s1
ffffffffc0203fee:	02500513          	li	a0,37
ffffffffc0203ff2:	9902                	jalr	s2
            break;
ffffffffc0203ff4:	b50d                	j	ffffffffc0203e16 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0203ff6:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0203ffa:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203ffe:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204000:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204002:	e40dd9e3          	bgez	s11,ffffffffc0203e54 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204006:	8de6                	mv	s11,s9
ffffffffc0204008:	5cfd                	li	s9,-1
ffffffffc020400a:	b5a9                	j	ffffffffc0203e54 <vprintfmt+0x78>
            goto reswitch;
ffffffffc020400c:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204010:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204014:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204016:	bd3d                	j	ffffffffc0203e54 <vprintfmt+0x78>
...
ffffffffc0204026:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020402a:	fcd56ce3          	bltu	a0,a3,ffffffffc0204002 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
...
ffffffffc020404c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204050:	fcd57fe3          	bleu	a3,a0,ffffffffc020402e <vprintfmt+0x252>
ffffffffc0204054:	b77d                	j	ffffffffc0204002 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204056:	fffdc693          	not	a3,s11
ffffffffc020405a:	96fd                	srai	a3,a3,0x3f
ffffffffc020405c:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204060:	00144603          	lbu	a2,1(s0)
ffffffffc0204064:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204066:	846a                	mv	s0,s10
ffffffffc0204068:	b3f5                	j	ffffffffc0203e54 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc020406a:	85a6                	mv	a1,s1
ffffffffc020406c:	02500513          	li	a0,37
ffffffffc0204070:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204072:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204076:	02500793          	li	a5,37
ffffffffc020407a:	8d22                	mv	s10,s0
ffffffffc020407c:	d8f70de3          	beq	a4,a5,ffffffffc0203e16 <vprintfmt+0x3a>
ffffffffc0204080:	02500713          	li	a4,37
ffffffffc0204084:	1d7d                	addi	s10,s10,-1
ffffffffc0204086:	fffd4783          	lbu	a5,-1(s10)
ffffffffc020408a:	fee79de3          	bne	a5,a4,ffffffffc0204084 <vprintfmt+0x2a8>
ffffffffc020408e:	b361                	j	ffffffffc0203e16 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204090:	00002617          	auipc	a2,0x2
ffffffffc0204094:	05860613          	addi	a2,a2,88 # ffffffffc02060e8 <error_string+0xd8>
ffffffffc0204098:	85a6                	mv	a1,s1
ffffffffc020409a:	854a                	mv	a0,s2
ffffffffc020409c:	0ac000ef          	jal	ra,ffffffffc0204148 <printfmt>
ffffffffc02040a0:	bb9d                	j	ffffffffc0203e16 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02040a2:	00002617          	auipc	a2,0x2
ffffffffc02040a6:	03e60613          	addi	a2,a2,62 # ffffffffc02060e0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc02040aa:	00002417          	auipc	s0,0x2
ffffffffc02040ae:	03740413          	addi	s0,s0,55 # ffffffffc02060e1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040b2:	8532                	mv	a0,a2
ffffffffc02040b4:	85e6                	mv	a1,s9
ffffffffc02040b6:	e032                	sd	a2,0(sp)
ffffffffc02040b8:	e43e                	sd	a5,8(sp)
ffffffffc02040ba:	18a000ef          	jal	ra,ffffffffc0204244 <strnlen>
ffffffffc02040be:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02040c2:	6602                	ld	a2,0(sp)
ffffffffc02040c4:	01b05d63          	blez	s11,ffffffffc02040de <vprintfmt+0x302>
ffffffffc02040c8:	67a2                	ld	a5,8(sp)
ffffffffc02040ca:	2781                	sext.w	a5,a5
ffffffffc02040cc:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02040ce:	6522                	ld	a0,8(sp)
ffffffffc02040d0:	85a6                	mv	a1,s1
ffffffffc02040d2:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040d4:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02040d6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040d8:	6602                	ld	a2,0(sp)
ffffffffc02040da:	fe0d9ae3          	bnez	s11,ffffffffc02040ce <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040de:	00064783          	lbu	a5,0(a2)
ffffffffc02040e2:	0007851b          	sext.w	a0,a5
ffffffffc02040e6:	e8051be3          	bnez	a0,ffffffffc0203f7c <vprintfmt+0x1a0>
ffffffffc02040ea:	b335                	j	ffffffffc0203e16 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02040ec:	000aa403          	lw	s0,0(s5)
ffffffffc02040f0:	bbf1                	j	ffffffffc0203ecc <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02040f2:	000ae603          	lwu	a2,0(s5)
ffffffffc02040f6:	46a9                	li	a3,10
ffffffffc02040f8:	8aae                	mv	s5,a1
ffffffffc02040fa:	bd89                	j	ffffffffc0203f4c <vprintfmt+0x170>
ffffffffc02040fc:	000ae603          	lwu	a2,0(s5)
ffffffffc0204100:	46c1                	li	a3,16
ffffffffc0204102:	8aae                	mv	s5,a1
ffffffffc0204104:	b5a1                	j	ffffffffc0203f4c <vprintfmt+0x170>
ffffffffc0204106:	000ae603          	lwu	a2,0(s5)
ffffffffc020410a:	46a1                	li	a3,8
ffffffffc020410c:	8aae                	mv	s5,a1
ffffffffc020410e:	bd3d                	j	ffffffffc0203f4c <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204110:	9902                	jalr	s2
ffffffffc0204112:	b559                	j	ffffffffc0203f98 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204114:	85a6                	mv	a1,s1
ffffffffc0204116:	02d00513          	li	a0,45
ffffffffc020411a:	e03e                	sd	a5,0(sp)
ffffffffc020411c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020411e:	8ace                	mv	s5,s3
ffffffffc0204120:	40800633          	neg	a2,s0
ffffffffc0204124:	46a9                	li	a3,10
ffffffffc0204126:	6782                	ld	a5,0(sp)
ffffffffc0204128:	b515                	j	ffffffffc0203f4c <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc020412a:	01b05663          	blez	s11,ffffffffc0204136 <vprintfmt+0x35a>
ffffffffc020412e:	02d00693          	li	a3,45
ffffffffc0204132:	f6d798e3          	bne	a5,a3,ffffffffc02040a2 <vprintfmt+0x2c6>
ffffffffc0204136:	00002417          	auipc	s0,0x2
ffffffffc020413a:	fab40413          	addi	s0,s0,-85 # ffffffffc02060e1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020413e:	02800513          	li	a0,40
ffffffffc0204142:	02800793          	li	a5,40
ffffffffc0204146:	bd1d                	j	ffffffffc0203f7c <vprintfmt+0x1a0>

ffffffffc0204148 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204148:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020414a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020414e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204150:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204152:	ec06                	sd	ra,24(sp)
ffffffffc0204154:	f83a                	sd	a4,48(sp)
ffffffffc0204156:	fc3e                	sd	a5,56(sp)
ffffffffc0204158:	e0c2                	sd	a6,64(sp)
ffffffffc020415a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020415c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020415e:	c7fff0ef          	jal	ra,ffffffffc0203ddc <vprintfmt>
}
ffffffffc0204162:	60e2                	ld	ra,24(sp)
ffffffffc0204164:	6161                	addi	sp,sp,80
ffffffffc0204166:	8082                	ret

ffffffffc0204168 <readline>:
...
ffffffffc020416a:	e486                	sd	ra,72(sp)
ffffffffc020416c:	e0a2                	sd	s0,64(sp)
ffffffffc020416e:	fc26                	sd	s1,56(sp)
ffffffffc0204170:	f84a                	sd	s2,48(sp)
ffffffffc0204172:	f44e                	sd	s3,40(sp)
ffffffffc0204174:	f052                	sd	s4,32(sp)
ffffffffc0204176:	ec56                	sd	s5,24(sp)
ffffffffc0204178:	e85a                	sd	s6,16(sp)
ffffffffc020417a:	e45e                	sd	s7,8(sp)
    if (prompt != NULL) {
ffffffffc020417c:	c901                	beqz	a0,ffffffffc020418c <readline+0x24>
        cprintf("%s", prompt);
ffffffffc020417e:	85aa                	mv	a1,a0
ffffffffc0204180:	00002517          	auipc	a0,0x2
ffffffffc0204184:	f7850513          	addi	a0,a0,-136 # ffffffffc02060f8 <error_string+0xe8>
ffffffffc0204188:	f37fb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
ffffffffc020418c:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc020418e:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204190:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204192:	4aa9                	li	s5,10
ffffffffc0204194:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204196:	0000db97          	auipc	s7,0xd
ffffffffc020419a:	eaab8b93          	addi	s7,s7,-342 # ffffffffc0211040 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020419e:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02041a2:	f55fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041a6:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041a8:	00054b63          	bltz	a0,ffffffffc02041be <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02041ac:	00a95b63          	ble	a0,s2,ffffffffc02041c2 <readline+0x5a>
ffffffffc02041b0:	029a5463          	ble	s1,s4,ffffffffc02041d8 <readline+0x70>
        c = getchar();
ffffffffc02041b4:	f43fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041b8:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041ba:	fe0559e3          	bgez	a0,ffffffffc02041ac <readline+0x44>
            return NULL;
ffffffffc02041be:	4501                	li	a0,0
ffffffffc02041c0:	a099                	j	ffffffffc0204206 <readline+0x9e>
        else if (c == '\b' && i > 0) {
ffffffffc02041c2:	03341463          	bne	s0,s3,ffffffffc02041ea <readline+0x82>
ffffffffc02041c6:	e8b9                	bnez	s1,ffffffffc020421c <readline+0xb4>
        c = getchar();
ffffffffc02041c8:	f2ffb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041cc:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041ce:	fe0548e3          	bltz	a0,ffffffffc02041be <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02041d2:	fea958e3          	ble	a0,s2,ffffffffc02041c2 <readline+0x5a>
ffffffffc02041d6:	4481                	li	s1,0
            cputchar(c);
ffffffffc02041d8:	8522                	mv	a0,s0
ffffffffc02041da:	f19fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i ++] = c;
ffffffffc02041de:	009b87b3          	add	a5,s7,s1
ffffffffc02041e2:	00878023          	sb	s0,0(a5)
ffffffffc02041e6:	2485                	addiw	s1,s1,1
ffffffffc02041e8:	bf6d                	j	ffffffffc02041a2 <readline+0x3a>
        else if (c == '\n' || c == '\r') {
ffffffffc02041ea:	01540463          	beq	s0,s5,ffffffffc02041f2 <readline+0x8a>
ffffffffc02041ee:	fb641ae3          	bne	s0,s6,ffffffffc02041a2 <readline+0x3a>
            cputchar(c);
ffffffffc02041f2:	8522                	mv	a0,s0
ffffffffc02041f4:	efffb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i] = '\0';
ffffffffc02041f8:	0000d517          	auipc	a0,0xd
ffffffffc02041fc:	e4850513          	addi	a0,a0,-440 # ffffffffc0211040 <buf>
ffffffffc0204200:	94aa                	add	s1,s1,a0
ffffffffc0204202:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204206:	60a6                	ld	ra,72(sp)
ffffffffc0204208:	6406                	ld	s0,64(sp)
ffffffffc020420a:	74e2                	ld	s1,56(sp)
ffffffffc020420c:	7942                	ld	s2,48(sp)
ffffffffc020420e:	79a2                	ld	s3,40(sp)
ffffffffc0204210:	7a02                	ld	s4,32(sp)
ffffffffc0204212:	6ae2                	ld	s5,24(sp)
ffffffffc0204214:	6b42                	ld	s6,16(sp)
ffffffffc0204216:	6ba2                	ld	s7,8(sp)
ffffffffc0204218:	6161                	addi	sp,sp,80
ffffffffc020421a:	8082                	ret
            cputchar(c);
ffffffffc020421c:	4521                	li	a0,8
ffffffffc020421e:	ed5fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            i --;
ffffffffc0204222:	34fd                	addiw	s1,s1,-1
ffffffffc0204224:	bfbd                	j	ffffffffc02041a2 <readline+0x3a>

ffffffffc0204226 <strlen>:
...
ffffffffc020422a:	cb91                	beqz	a5,ffffffffc020423e <strlen+0x18>
    size_t cnt = 0;
ffffffffc020422c:	4781                	li	a5,0
        cnt ++;
ffffffffc020422e:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204230:	00f50733          	add	a4,a0,a5
ffffffffc0204234:	00074703          	lbu	a4,0(a4)
ffffffffc0204238:	fb7d                	bnez	a4,ffffffffc020422e <strlen+0x8>
    }
    return cnt;
}
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204244:	c185                	beqz	a1,ffffffffc0204264 <strnlen+0x20>
ffffffffc0204246:	00054783          	lbu	a5,0(a0)
ffffffffc020424a:	cf89                	beqz	a5,ffffffffc0204264 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc020424c:	4781                	li	a5,0
ffffffffc020424e:	a021                	j	ffffffffc0204256 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204250:	00074703          	lbu	a4,0(a4)
ffffffffc0204254:	c711                	beqz	a4,ffffffffc0204260 <strnlen+0x1c>
        cnt ++;
ffffffffc0204256:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204258:	00f50733          	add	a4,a0,a5
ffffffffc020425c:	fef59ae3          	bne	a1,a5,ffffffffc0204250 <strnlen+0xc>
    }
    return cnt;
}
...
ffffffffc0204262:	8082                	ret
    size_t cnt = 0;
ffffffffc0204264:	4781                	li	a5,0
}
ffffffffc0204266:	853e                	mv	a0,a5
ffffffffc0204268:	8082                	ret

ffffffffc020426a <strcpy>:
char *
...
ffffffffc020426a:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020426c:	0585                	addi	a1,a1,1
ffffffffc020426e:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204272:	0785                	addi	a5,a5,1
ffffffffc0204274:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204278:	fb75                	bnez	a4,ffffffffc020426c <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020427c:	00054783          	lbu	a5,0(a0)
ffffffffc0204280:	0005c703          	lbu	a4,0(a1)
ffffffffc0204284:	cb91                	beqz	a5,ffffffffc0204298 <strcmp+0x1c>
ffffffffc0204286:	00e79c63          	bne	a5,a4,ffffffffc020429e <strcmp+0x22>
        s1 ++, s2 ++;
...
ffffffffc0204292:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204296:	fbe5                	bnez	a5,ffffffffc0204286 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204298:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020429a:	9d19                	subw	a0,a0,a4
...
ffffffffc02042aa:	cb91                	beqz	a5,ffffffffc02042be <strchr+0x18>
        if (*s == c) {
ffffffffc02042ac:	00b79563          	bne	a5,a1,ffffffffc02042b6 <strchr+0x10>
ffffffffc02042b0:	a809                	j	ffffffffc02042c2 <strchr+0x1c>
ffffffffc02042b2:	00b78763          	beq	a5,a1,ffffffffc02042c0 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc02042b6:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02042b8:	00054783          	lbu	a5,0(a0)
ffffffffc02042bc:	fbfd                	bnez	a5,ffffffffc02042b2 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02042c4:	ca01                	beqz	a2,ffffffffc02042d4 <memset+0x10>
ffffffffc02042c6:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02042c8:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02042ca:	0785                	addi	a5,a5,1
ffffffffc02042cc:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02042d0:	fec79de3          	bne	a5,a2,ffffffffc02042ca <memset+0x6>
    }
    return s;
...
ffffffffc02042d6 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02042d6:	ca19                	beqz	a2,ffffffffc02042ec <memcpy+0x16>
ffffffffc02042d8:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02042da:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02042dc:	0585                	addi	a1,a1,1
ffffffffc02042de:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02042e2:	0785                	addi	a5,a5,1
ffffffffc02042e4:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02042e8:	fec59ae3          	bne	a1,a2,ffffffffc02042dc <memcpy+0x6>
    }
    return dst;
