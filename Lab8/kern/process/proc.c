...
alloc_proc(void) {
    ...
    if (proc != NULL) {
    //LAB4:EXERCISE1 2111258 2111527 2113879
    /*
     ...
     */
     //LAB5 2111258 2111527 2113879 : (update LAB4 steps)
    /*
     * below fields(add in LAB5) in proc_struct need to be initialized
     *       uint32_t wait_state;                        // waiting state
     *       struct proc_struct *cptr, *yptr, *optr;     // relations between processes
     */
    //LAB6 2111258 2111527 2113879 : (update LAB5 steps)
    /*
     ...
     */
     ...
     //LAB8 2111258 2111527 2113879 : (update LAB6 steps)
      /*
     * below fields(add in LAB6) in proc_struct need to be initialized
...
proc_run(struct proc_struct *proc) {
    if (proc != current) {
         // LAB4:EXERCISE3 2111258 2111527 2113879
        /*
        ...
        */
       //LAB8 2111258 2111527 2113879 : (update LAB4 steps)
      /*
     * below fields(add in LAB6) in proc_struct need to be initialized
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2111258 2111527 2113879  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
