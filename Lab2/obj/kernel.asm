...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	27d010ef          	jal	ra,ffffffffc0201aca <memset>
...
ffffffffc020005a:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0201ae0 <etext+0x4>
...
ffffffffc020006a:	338010ef          	jal	ra,ffffffffc02013a2 <pmm_init>
...
ffffffffc02000a8:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000aa:	512010ef          	jal	ra,ffffffffc02015bc <vprintfmt>
    return cnt;
}
...
ffffffffc02000dc:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000de:	4de010ef          	jal	ra,ffffffffc02015bc <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200144:	9f050513          	addi	a0,a0,-1552 # ffffffffc0201b30 <etext+0x54>
void print_kerninfo(void) {
...
ffffffffc020015a:	9fa50513          	addi	a0,a0,-1542 # ffffffffc0201b50 <etext+0x74>
ffffffffc020015e:	f59ff0ef          	jal	ra,ffffffffc02000b6 <cprintf>
    cprintf("  etext  0x%016lx (virtual)\n", etext);
ffffffffc0200162:	00002597          	auipc	a1,0x2
ffffffffc0200166:	97a58593          	addi	a1,a1,-1670 # ffffffffc0201adc <etext>
ffffffffc020016a:	00002517          	auipc	a0,0x2
ffffffffc020016e:	a0650513          	addi	a0,a0,-1530 # ffffffffc0201b70 <etext+0x94>
...
ffffffffc0200182:	a1250513          	addi	a0,a0,-1518 # ffffffffc0201b90 <etext+0xb4>
...
ffffffffc0200196:	a1e50513          	addi	a0,a0,-1506 # ffffffffc0201bb0 <etext+0xd4>
...
ffffffffc02001c4:	a1050513          	addi	a0,a0,-1520 # ffffffffc0201bd0 <etext+0xf4>
}
...
ffffffffc02001d4:	93060613          	addi	a2,a2,-1744 # ffffffffc0201b00 <etext+0x24>
ffffffffc02001d8:	04e00593          	li	a1,78
ffffffffc02001dc:	00002517          	auipc	a0,0x2
ffffffffc02001e0:	93c50513          	addi	a0,a0,-1732 # ffffffffc0201b18 <etext+0x3c>
void print_stackframe(void) {
...
ffffffffc02002d6:	672010ef          	jal	ra,ffffffffc0201948 <readline>
...
ffffffffc02002e8:	7c4010ef          	jal	ra,ffffffffc0201aac <strchr>
...
ffffffffc020030c:	776010ef          	jal	ra,ffffffffc0201a82 <strcmp>
...
ffffffffc0200320:	762010ef          	jal	ra,ffffffffc0201a82 <strcmp>
...
ffffffffc0200386:	726010ef          	jal	ra,ffffffffc0201aac <strchr>
...
ffffffffc02003f8:	80450513          	addi	a0,a0,-2044 # ffffffffc0201bf8 <etext+0x11c>
...
ffffffffc0200424:	5fe010ef          	jal	ra,ffffffffc0201a22 <sbi_set_timer>
}
...
ffffffffc020044c:	5d60106f          	j	ffffffffc0201a22 <sbi_set_timer>
...
ffffffffc0200456:	5b00106f          	j	ffffffffc0201a06 <sbi_console_putchar>
...
ffffffffc020045a:	5e40106f          	j	ffffffffc0201a3e <sbi_console_getchar>
...
ffffffffc02008f2:	94268693          	addi	a3,a3,-1726 # ffffffffc0202230 <commands+0x630>
ffffffffc02008f6:	00002617          	auipc	a2,0x2
ffffffffc02008fa:	94260613          	addi	a2,a2,-1726 # ffffffffc0202238 <commands+0x638>
ffffffffc02008fe:	06d00593          	li	a1,109
ffffffffc0200902:	00002517          	auipc	a0,0x2
ffffffffc0200906:	94e50513          	addi	a0,a0,-1714 # ffffffffc0202250 <commands+0x650>
best_fit_alloc_pages(size_t n) {
...
ffffffffc0200962:	201000ef          	jal	ra,ffffffffc0201362 <nr_free_pages>
ffffffffc0200966:	37351d63          	bne	a0,s3,ffffffffc0200ce0 <best_fit_check+0x3d0>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020096a:	4505                	li	a0,1
ffffffffc020096c:	16d000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200978:	161000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200984:	155000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc02009be:	8ae70713          	addi	a4,a4,-1874 # ffffffffc0202268 <commands+0x668>
...
ffffffffc02009d2:	f5a68693          	addi	a3,a3,-166 # ffffffffc0202928 <nbase>
...
ffffffffc0200a32:	a007ad23          	sw	zero,-1510(a5) # ffffffffc0206448 <free_area+0x10>
    assert(alloc_page() == NULL);
ffffffffc0200a36:	0a3000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200a42:	0db000ef          	jal	ra,ffffffffc020131c <free_pages>
    free_page(p1);
ffffffffc0200a46:	4585                	li	a1,1
ffffffffc0200a48:	854e                	mv	a0,s3
ffffffffc0200a4a:	0d3000ef          	jal	ra,ffffffffc020131c <free_pages>
    free_page(p2);
ffffffffc0200a4e:	4585                	li	a1,1
ffffffffc0200a50:	8556                	mv	a0,s5
ffffffffc0200a52:	0cb000ef          	jal	ra,ffffffffc020131c <free_pages>
    assert(nr_free == 3);
...
ffffffffc0200a62:	077000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200a6e:	06b000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200a7a:	05f000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200a86:	053000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200a92:	08b000ef          	jal	ra,ffffffffc020131c <free_pages>
...
ffffffffc0200aa0:	039000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
ffffffffc0200aa4:	54a99e63          	bne	s3,a0,ffffffffc0201000 <best_fit_check+0x6f0>
    assert(alloc_page() == NULL);
ffffffffc0200aa8:	4505                	li	a0,1
ffffffffc0200aaa:	02f000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200ad2:	9767ad23          	sw	s6,-1670(a5) # ffffffffc0206448 <free_area+0x10>
    free_page(p);
ffffffffc0200ad6:	047000ef          	jal	ra,ffffffffc020131c <free_pages>
    free_page(p1);
ffffffffc0200ada:	4585                	li	a1,1
ffffffffc0200adc:	8556                	mv	a0,s5
ffffffffc0200ade:	03f000ef          	jal	ra,ffffffffc020131c <free_pages>
    free_page(p2);
ffffffffc0200ae2:	4585                	li	a1,1
ffffffffc0200ae4:	8552                	mv	a0,s4
ffffffffc0200ae6:	037000ef          	jal	ra,ffffffffc020131c <free_pages>
...
ffffffffc0200aec:	7ec000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b16:	9327b723          	sd	s2,-1746(a5) # ffffffffc0206440 <free_area+0x8>
    assert(alloc_page() == NULL);
ffffffffc0200b1a:	7be000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b34:	9007ac23          	sw	zero,-1768(a5) # ffffffffc0206448 <free_area+0x10>
    free_pages(p0 + 1, 2);
ffffffffc0200b38:	7e4000ef          	jal	ra,ffffffffc020131c <free_pages>
    free_pages(p0 + 4, 1);
ffffffffc0200b3c:	8562                	mv	a0,s8
ffffffffc0200b3e:	4585                	li	a1,1
ffffffffc0200b40:	7dc000ef          	jal	ra,ffffffffc020131c <free_pages>
    assert(alloc_pages(4) == NULL);
ffffffffc0200b44:	4511                	li	a0,4
ffffffffc0200b46:	792000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b66:	772000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b72:	766000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b82:	79a000ef          	jal	ra,ffffffffc020131c <free_pages>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0200b86:	4515                	li	a0,5
ffffffffc0200b88:	750000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200b94:	744000ef          	jal	ra,ffffffffc02012d8 <alloc_pages>
...
ffffffffc0200bbc:	8957b423          	sd	s5,-1912(a5) # ffffffffc0206440 <free_area+0x8>
    free_pages(p0, 5);
ffffffffc0200bc0:	75c000ef          	jal	ra,ffffffffc020131c <free_pages>
    return listelm->next;
...
ffffffffc0200c04:	67068693          	addi	a3,a3,1648 # ffffffffc0202270 <commands+0x670>
ffffffffc0200c08:	00001617          	auipc	a2,0x1
ffffffffc0200c0c:	63060613          	addi	a2,a2,1584 # ffffffffc0202238 <commands+0x638>
ffffffffc0200c10:	11800593          	li	a1,280
ffffffffc0200c14:	00001517          	auipc	a0,0x1
ffffffffc0200c18:	63c50513          	addi	a0,a0,1596 # ffffffffc0202250 <commands+0x650>
ffffffffc0200c1c:	f90ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200c20:	00001697          	auipc	a3,0x1
ffffffffc0200c24:	6e068693          	addi	a3,a3,1760 # ffffffffc0202300 <commands+0x700>
ffffffffc0200c28:	00001617          	auipc	a2,0x1
ffffffffc0200c2c:	61060613          	addi	a2,a2,1552 # ffffffffc0202238 <commands+0x638>
ffffffffc0200c30:	0e400593          	li	a1,228
ffffffffc0200c34:	00001517          	auipc	a0,0x1
ffffffffc0200c38:	61c50513          	addi	a0,a0,1564 # ffffffffc0202250 <commands+0x650>
ffffffffc0200c3c:	f70ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200c40:	00001697          	auipc	a3,0x1
ffffffffc0200c44:	6e868693          	addi	a3,a3,1768 # ffffffffc0202328 <commands+0x728>
ffffffffc0200c48:	00001617          	auipc	a2,0x1
ffffffffc0200c4c:	5f060613          	addi	a2,a2,1520 # ffffffffc0202238 <commands+0x638>
ffffffffc0200c50:	0e500593          	li	a1,229
ffffffffc0200c54:	00001517          	auipc	a0,0x1
ffffffffc0200c58:	5fc50513          	addi	a0,a0,1532 # ffffffffc0202250 <commands+0x650>
ffffffffc0200c5c:	f50ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200c60:	00001697          	auipc	a3,0x1
ffffffffc0200c64:	70868693          	addi	a3,a3,1800 # ffffffffc0202368 <commands+0x768>
ffffffffc0200c68:	00001617          	auipc	a2,0x1
ffffffffc0200c6c:	5d060613          	addi	a2,a2,1488 # ffffffffc0202238 <commands+0x638>
ffffffffc0200c70:	0e700593          	li	a1,231
ffffffffc0200c74:	00001517          	auipc	a0,0x1
ffffffffc0200c78:	5dc50513          	addi	a0,a0,1500 # ffffffffc0202250 <commands+0x650>
ffffffffc0200c7c:	f30ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200c80:	00001697          	auipc	a3,0x1
ffffffffc0200c84:	77068693          	addi	a3,a3,1904 # ffffffffc02023f0 <commands+0x7f0>
ffffffffc0200c88:	00001617          	auipc	a2,0x1
ffffffffc0200c8c:	5b060613          	addi	a2,a2,1456 # ffffffffc0202238 <commands+0x638>
ffffffffc0200c90:	10000593          	li	a1,256
ffffffffc0200c94:	00001517          	auipc	a0,0x1
ffffffffc0200c98:	5bc50513          	addi	a0,a0,1468 # ffffffffc0202250 <commands+0x650>
ffffffffc0200c9c:	f10ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200ca0:	00001697          	auipc	a3,0x1
ffffffffc0200ca4:	64068693          	addi	a3,a3,1600 # ffffffffc02022e0 <commands+0x6e0>
ffffffffc0200ca8:	00001617          	auipc	a2,0x1
ffffffffc0200cac:	59060613          	addi	a2,a2,1424 # ffffffffc0202238 <commands+0x638>
ffffffffc0200cb0:	0e200593          	li	a1,226
ffffffffc0200cb4:	00001517          	auipc	a0,0x1
ffffffffc0200cb8:	59c50513          	addi	a0,a0,1436 # ffffffffc0202250 <commands+0x650>
ffffffffc0200cbc:	ef0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(total == 0);
ffffffffc0200cc0:	00002697          	auipc	a3,0x2
ffffffffc0200cc4:	86068693          	addi	a3,a3,-1952 # ffffffffc0202520 <commands+0x920>
ffffffffc0200cc8:	00001617          	auipc	a2,0x1
ffffffffc0200ccc:	57060613          	addi	a2,a2,1392 # ffffffffc0202238 <commands+0x638>
ffffffffc0200cd0:	15a00593          	li	a1,346
ffffffffc0200cd4:	00001517          	auipc	a0,0x1
ffffffffc0200cd8:	57c50513          	addi	a0,a0,1404 # ffffffffc0202250 <commands+0x650>
ffffffffc0200cdc:	ed0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(total == nr_free_pages());
ffffffffc0200ce0:	00001697          	auipc	a3,0x1
ffffffffc0200ce4:	5a068693          	addi	a3,a3,1440 # ffffffffc0202280 <commands+0x680>
ffffffffc0200ce8:	00001617          	auipc	a2,0x1
ffffffffc0200cec:	55060613          	addi	a2,a2,1360 # ffffffffc0202238 <commands+0x638>
ffffffffc0200cf0:	11b00593          	li	a1,283
ffffffffc0200cf4:	00001517          	auipc	a0,0x1
ffffffffc0200cf8:	55c50513          	addi	a0,a0,1372 # ffffffffc0202250 <commands+0x650>
ffffffffc0200cfc:	eb0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200d00:	00001697          	auipc	a3,0x1
ffffffffc0200d04:	5c068693          	addi	a3,a3,1472 # ffffffffc02022c0 <commands+0x6c0>
ffffffffc0200d08:	00001617          	auipc	a2,0x1
ffffffffc0200d0c:	53060613          	addi	a2,a2,1328 # ffffffffc0202238 <commands+0x638>
ffffffffc0200d10:	0e100593          	li	a1,225
ffffffffc0200d14:	00001517          	auipc	a0,0x1
ffffffffc0200d18:	53c50513          	addi	a0,a0,1340 # ffffffffc0202250 <commands+0x650>
ffffffffc0200d1c:	e90ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200d20:	00001697          	auipc	a3,0x1
ffffffffc0200d24:	58068693          	addi	a3,a3,1408 # ffffffffc02022a0 <commands+0x6a0>
ffffffffc0200d28:	00001617          	auipc	a2,0x1
ffffffffc0200d2c:	51060613          	addi	a2,a2,1296 # ffffffffc0202238 <commands+0x638>
ffffffffc0200d30:	0e000593          	li	a1,224
ffffffffc0200d34:	00001517          	auipc	a0,0x1
ffffffffc0200d38:	51c50513          	addi	a0,a0,1308 # ffffffffc0202250 <commands+0x650>
ffffffffc0200d3c:	e70ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200d40:	00001697          	auipc	a3,0x1
ffffffffc0200d44:	68868693          	addi	a3,a3,1672 # ffffffffc02023c8 <commands+0x7c8>
ffffffffc0200d48:	00001617          	auipc	a2,0x1
ffffffffc0200d4c:	4f060613          	addi	a2,a2,1264 # ffffffffc0202238 <commands+0x638>
ffffffffc0200d50:	0fd00593          	li	a1,253
ffffffffc0200d54:	00001517          	auipc	a0,0x1
ffffffffc0200d58:	4fc50513          	addi	a0,a0,1276 # ffffffffc0202250 <commands+0x650>
ffffffffc0200d5c:	e50ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200d60:	00001697          	auipc	a3,0x1
ffffffffc0200d64:	58068693          	addi	a3,a3,1408 # ffffffffc02022e0 <commands+0x6e0>
ffffffffc0200d68:	00001617          	auipc	a2,0x1
ffffffffc0200d6c:	4d060613          	addi	a2,a2,1232 # ffffffffc0202238 <commands+0x638>
ffffffffc0200d70:	0fb00593          	li	a1,251
ffffffffc0200d74:	00001517          	auipc	a0,0x1
ffffffffc0200d78:	4dc50513          	addi	a0,a0,1244 # ffffffffc0202250 <commands+0x650>
ffffffffc0200d7c:	e30ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200d80:	00001697          	auipc	a3,0x1
ffffffffc0200d84:	54068693          	addi	a3,a3,1344 # ffffffffc02022c0 <commands+0x6c0>
ffffffffc0200d88:	00001617          	auipc	a2,0x1
ffffffffc0200d8c:	4b060613          	addi	a2,a2,1200 # ffffffffc0202238 <commands+0x638>
ffffffffc0200d90:	0fa00593          	li	a1,250
ffffffffc0200d94:	00001517          	auipc	a0,0x1
ffffffffc0200d98:	4bc50513          	addi	a0,a0,1212 # ffffffffc0202250 <commands+0x650>
ffffffffc0200d9c:	e10ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200da0:	00001697          	auipc	a3,0x1
ffffffffc0200da4:	50068693          	addi	a3,a3,1280 # ffffffffc02022a0 <commands+0x6a0>
ffffffffc0200da8:	00001617          	auipc	a2,0x1
ffffffffc0200dac:	49060613          	addi	a2,a2,1168 # ffffffffc0202238 <commands+0x638>
ffffffffc0200db0:	0f900593          	li	a1,249
ffffffffc0200db4:	00001517          	auipc	a0,0x1
ffffffffc0200db8:	49c50513          	addi	a0,a0,1180 # ffffffffc0202250 <commands+0x650>
ffffffffc0200dbc:	df0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(nr_free == 3);
ffffffffc0200dc0:	00001697          	auipc	a3,0x1
ffffffffc0200dc4:	62068693          	addi	a3,a3,1568 # ffffffffc02023e0 <commands+0x7e0>
ffffffffc0200dc8:	00001617          	auipc	a2,0x1
ffffffffc0200dcc:	47060613          	addi	a2,a2,1136 # ffffffffc0202238 <commands+0x638>
ffffffffc0200dd0:	0f700593          	li	a1,247
ffffffffc0200dd4:	00001517          	auipc	a0,0x1
ffffffffc0200dd8:	47c50513          	addi	a0,a0,1148 # ffffffffc0202250 <commands+0x650>
ffffffffc0200ddc:	dd0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200de0:	00001697          	auipc	a3,0x1
ffffffffc0200de4:	5e868693          	addi	a3,a3,1512 # ffffffffc02023c8 <commands+0x7c8>
ffffffffc0200de8:	00001617          	auipc	a2,0x1
ffffffffc0200dec:	45060613          	addi	a2,a2,1104 # ffffffffc0202238 <commands+0x638>
ffffffffc0200df0:	0f200593          	li	a1,242
ffffffffc0200df4:	00001517          	auipc	a0,0x1
ffffffffc0200df8:	45c50513          	addi	a0,a0,1116 # ffffffffc0202250 <commands+0x650>
ffffffffc0200dfc:	db0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200e00:	00001697          	auipc	a3,0x1
ffffffffc0200e04:	5a868693          	addi	a3,a3,1448 # ffffffffc02023a8 <commands+0x7a8>
ffffffffc0200e08:	00001617          	auipc	a2,0x1
ffffffffc0200e0c:	43060613          	addi	a2,a2,1072 # ffffffffc0202238 <commands+0x638>
ffffffffc0200e10:	0e900593          	li	a1,233
ffffffffc0200e14:	00001517          	auipc	a0,0x1
ffffffffc0200e18:	43c50513          	addi	a0,a0,1084 # ffffffffc0202250 <commands+0x650>
ffffffffc0200e1c:	d90ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0200e20:	00001697          	auipc	a3,0x1
ffffffffc0200e24:	56868693          	addi	a3,a3,1384 # ffffffffc0202388 <commands+0x788>
ffffffffc0200e28:	00001617          	auipc	a2,0x1
ffffffffc0200e2c:	41060613          	addi	a2,a2,1040 # ffffffffc0202238 <commands+0x638>
ffffffffc0200e30:	0e800593          	li	a1,232
ffffffffc0200e34:	00001517          	auipc	a0,0x1
ffffffffc0200e38:	41c50513          	addi	a0,a0,1052 # ffffffffc0202250 <commands+0x650>
ffffffffc0200e3c:	d70ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(count == 0);
ffffffffc0200e40:	00001697          	auipc	a3,0x1
ffffffffc0200e44:	6d068693          	addi	a3,a3,1744 # ffffffffc0202510 <commands+0x910>
ffffffffc0200e48:	00001617          	auipc	a2,0x1
ffffffffc0200e4c:	3f060613          	addi	a2,a2,1008 # ffffffffc0202238 <commands+0x638>
ffffffffc0200e50:	15900593          	li	a1,345
ffffffffc0200e54:	00001517          	auipc	a0,0x1
ffffffffc0200e58:	3fc50513          	addi	a0,a0,1020 # ffffffffc0202250 <commands+0x650>
ffffffffc0200e5c:	d50ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(nr_free == 0);
ffffffffc0200e60:	00001697          	auipc	a3,0x1
ffffffffc0200e64:	5c868693          	addi	a3,a3,1480 # ffffffffc0202428 <commands+0x828>
ffffffffc0200e68:	00001617          	auipc	a2,0x1
ffffffffc0200e6c:	3d060613          	addi	a2,a2,976 # ffffffffc0202238 <commands+0x638>
ffffffffc0200e70:	14e00593          	li	a1,334
ffffffffc0200e74:	00001517          	auipc	a0,0x1
ffffffffc0200e78:	3dc50513          	addi	a0,a0,988 # ffffffffc0202250 <commands+0x650>
ffffffffc0200e7c:	d30ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200e80:	00001697          	auipc	a3,0x1
ffffffffc0200e84:	54868693          	addi	a3,a3,1352 # ffffffffc02023c8 <commands+0x7c8>
ffffffffc0200e88:	00001617          	auipc	a2,0x1
ffffffffc0200e8c:	3b060613          	addi	a2,a2,944 # ffffffffc0202238 <commands+0x638>
ffffffffc0200e90:	14800593          	li	a1,328
ffffffffc0200e94:	00001517          	auipc	a0,0x1
ffffffffc0200e98:	3bc50513          	addi	a0,a0,956 # ffffffffc0202250 <commands+0x650>
ffffffffc0200e9c:	d10ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0200ea0:	00001697          	auipc	a3,0x1
ffffffffc0200ea4:	65068693          	addi	a3,a3,1616 # ffffffffc02024f0 <commands+0x8f0>
ffffffffc0200ea8:	00001617          	auipc	a2,0x1
ffffffffc0200eac:	39060613          	addi	a2,a2,912 # ffffffffc0202238 <commands+0x638>
ffffffffc0200eb0:	14700593          	li	a1,327
ffffffffc0200eb4:	00001517          	auipc	a0,0x1
ffffffffc0200eb8:	39c50513          	addi	a0,a0,924 # ffffffffc0202250 <commands+0x650>
ffffffffc0200ebc:	cf0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(p0 + 4 == p1);
ffffffffc0200ec0:	00001697          	auipc	a3,0x1
ffffffffc0200ec4:	62068693          	addi	a3,a3,1568 # ffffffffc02024e0 <commands+0x8e0>
ffffffffc0200ec8:	00001617          	auipc	a2,0x1
ffffffffc0200ecc:	37060613          	addi	a2,a2,880 # ffffffffc0202238 <commands+0x638>
ffffffffc0200ed0:	13f00593          	li	a1,319
ffffffffc0200ed4:	00001517          	auipc	a0,0x1
ffffffffc0200ed8:	37c50513          	addi	a0,a0,892 # ffffffffc0202250 <commands+0x650>
ffffffffc0200edc:	cd0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_pages(2) != NULL);      // best fit feature
ffffffffc0200ee0:	00001697          	auipc	a3,0x1
ffffffffc0200ee4:	5e868693          	addi	a3,a3,1512 # ffffffffc02024c8 <commands+0x8c8>
ffffffffc0200ee8:	00001617          	auipc	a2,0x1
ffffffffc0200eec:	35060613          	addi	a2,a2,848 # ffffffffc0202238 <commands+0x638>
ffffffffc0200ef0:	13e00593          	li	a1,318
ffffffffc0200ef4:	00001517          	auipc	a0,0x1
ffffffffc0200ef8:	35c50513          	addi	a0,a0,860 # ffffffffc0202250 <commands+0x650>
ffffffffc0200efc:	cb0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p1 = alloc_pages(1)) != NULL);
ffffffffc0200f00:	00001697          	auipc	a3,0x1
ffffffffc0200f04:	5a868693          	addi	a3,a3,1448 # ffffffffc02024a8 <commands+0x8a8>
ffffffffc0200f08:	00001617          	auipc	a2,0x1
ffffffffc0200f0c:	33060613          	addi	a2,a2,816 # ffffffffc0202238 <commands+0x638>
ffffffffc0200f10:	13d00593          	li	a1,317
ffffffffc0200f14:	00001517          	auipc	a0,0x1
ffffffffc0200f18:	33c50513          	addi	a0,a0,828 # ffffffffc0202250 <commands+0x650>
ffffffffc0200f1c:	c90ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(PageProperty(p0 + 1) && p0[1].property == 2);
ffffffffc0200f20:	00001697          	auipc	a3,0x1
ffffffffc0200f24:	55868693          	addi	a3,a3,1368 # ffffffffc0202478 <commands+0x878>
ffffffffc0200f28:	00001617          	auipc	a2,0x1
ffffffffc0200f2c:	31060613          	addi	a2,a2,784 # ffffffffc0202238 <commands+0x638>
ffffffffc0200f30:	13b00593          	li	a1,315
ffffffffc0200f34:	00001517          	auipc	a0,0x1
ffffffffc0200f38:	31c50513          	addi	a0,a0,796 # ffffffffc0202250 <commands+0x650>
ffffffffc0200f3c:	c70ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0200f40:	00001697          	auipc	a3,0x1
ffffffffc0200f44:	52068693          	addi	a3,a3,1312 # ffffffffc0202460 <commands+0x860>
ffffffffc0200f48:	00001617          	auipc	a2,0x1
ffffffffc0200f4c:	2f060613          	addi	a2,a2,752 # ffffffffc0202238 <commands+0x638>
ffffffffc0200f50:	13a00593          	li	a1,314
ffffffffc0200f54:	00001517          	auipc	a0,0x1
ffffffffc0200f58:	2fc50513          	addi	a0,a0,764 # ffffffffc0202250 <commands+0x650>
ffffffffc0200f5c:	c50ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f60:	00001697          	auipc	a3,0x1
ffffffffc0200f64:	46868693          	addi	a3,a3,1128 # ffffffffc02023c8 <commands+0x7c8>
ffffffffc0200f68:	00001617          	auipc	a2,0x1
ffffffffc0200f6c:	2d060613          	addi	a2,a2,720 # ffffffffc0202238 <commands+0x638>
ffffffffc0200f70:	12e00593          	li	a1,302
ffffffffc0200f74:	00001517          	auipc	a0,0x1
ffffffffc0200f78:	2dc50513          	addi	a0,a0,732 # ffffffffc0202250 <commands+0x650>
ffffffffc0200f7c:	c30ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(!PageProperty(p0));
ffffffffc0200f80:	00001697          	auipc	a3,0x1
ffffffffc0200f84:	4c868693          	addi	a3,a3,1224 # ffffffffc0202448 <commands+0x848>
ffffffffc0200f88:	00001617          	auipc	a2,0x1
ffffffffc0200f8c:	2b060613          	addi	a2,a2,688 # ffffffffc0202238 <commands+0x638>
ffffffffc0200f90:	12500593          	li	a1,293
ffffffffc0200f94:	00001517          	auipc	a0,0x1
ffffffffc0200f98:	2bc50513          	addi	a0,a0,700 # ffffffffc0202250 <commands+0x650>
ffffffffc0200f9c:	c10ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(p0 != NULL);
ffffffffc0200fa0:	00001697          	auipc	a3,0x1
ffffffffc0200fa4:	49868693          	addi	a3,a3,1176 # ffffffffc0202438 <commands+0x838>
ffffffffc0200fa8:	00001617          	auipc	a2,0x1
ffffffffc0200fac:	29060613          	addi	a2,a2,656 # ffffffffc0202238 <commands+0x638>
ffffffffc0200fb0:	12400593          	li	a1,292
ffffffffc0200fb4:	00001517          	auipc	a0,0x1
ffffffffc0200fb8:	29c50513          	addi	a0,a0,668 # ffffffffc0202250 <commands+0x650>
ffffffffc0200fbc:	bf0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(nr_free == 0);
ffffffffc0200fc0:	00001697          	auipc	a3,0x1
ffffffffc0200fc4:	46868693          	addi	a3,a3,1128 # ffffffffc0202428 <commands+0x828>
ffffffffc0200fc8:	00001617          	auipc	a2,0x1
ffffffffc0200fcc:	27060613          	addi	a2,a2,624 # ffffffffc0202238 <commands+0x638>
ffffffffc0200fd0:	10600593          	li	a1,262
ffffffffc0200fd4:	00001517          	auipc	a0,0x1
ffffffffc0200fd8:	27c50513          	addi	a0,a0,636 # ffffffffc0202250 <commands+0x650>
ffffffffc0200fdc:	bd0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fe0:	00001697          	auipc	a3,0x1
ffffffffc0200fe4:	3e868693          	addi	a3,a3,1000 # ffffffffc02023c8 <commands+0x7c8>
ffffffffc0200fe8:	00001617          	auipc	a2,0x1
ffffffffc0200fec:	25060613          	addi	a2,a2,592 # ffffffffc0202238 <commands+0x638>
ffffffffc0200ff0:	10400593          	li	a1,260
ffffffffc0200ff4:	00001517          	auipc	a0,0x1
ffffffffc0200ff8:	25c50513          	addi	a0,a0,604 # ffffffffc0202250 <commands+0x650>
ffffffffc0200ffc:	bb0ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201000:	00001697          	auipc	a3,0x1
ffffffffc0201004:	40868693          	addi	a3,a3,1032 # ffffffffc0202408 <commands+0x808>
ffffffffc0201008:	00001617          	auipc	a2,0x1
ffffffffc020100c:	23060613          	addi	a2,a2,560 # ffffffffc0202238 <commands+0x638>
ffffffffc0201010:	10300593          	li	a1,259
ffffffffc0201014:	00001517          	auipc	a0,0x1
ffffffffc0201018:	23c50513          	addi	a0,a0,572 # ffffffffc0202250 <commands+0x650>
...
ffffffffc0201188:	3ac68693          	addi	a3,a3,940 # ffffffffc0202530 <commands+0x930>
ffffffffc020118c:	00001617          	auipc	a2,0x1
ffffffffc0201190:	0ac60613          	addi	a2,a2,172 # ffffffffc0202238 <commands+0x638>
ffffffffc0201194:	09d00593          	li	a1,157
ffffffffc0201198:	00001517          	auipc	a0,0x1
ffffffffc020119c:	0b850513          	addi	a0,a0,184 # ffffffffc0202250 <commands+0x650>
ffffffffc02011a0:	a0cff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(n > 0);
ffffffffc02011a4:	00001697          	auipc	a3,0x1
ffffffffc02011a8:	08c68693          	addi	a3,a3,140 # ffffffffc0202230 <commands+0x630>
ffffffffc02011ac:	00001617          	auipc	a2,0x1
ffffffffc02011b0:	08c60613          	addi	a2,a2,140 # ffffffffc0202238 <commands+0x638>
ffffffffc02011b4:	09a00593          	li	a1,154
ffffffffc02011b8:	00001517          	auipc	a0,0x1
ffffffffc02011bc:	09850513          	addi	a0,a0,152 # ffffffffc0202250 <commands+0x650>
...
ffffffffc02011c6:	e406                	sd	ra,8(sp)
    assert(n > 0);
ffffffffc02011c8:	c9e5                	beqz	a1,ffffffffc02012b8 <best_fit_init_memmap+0xf4>
    for (; p != base + n; p ++) {
...
ffffffffc02011d4:	02d50963          	beq	a0,a3,ffffffffc0201206 <best_fit_init_memmap+0x42>
    return (((*(volatile unsigned long *)addr) >> nr) & 1);
ffffffffc02011d8:	6518                	ld	a4,8(a0)
        assert(PageReserved(p));
ffffffffc02011da:	87aa                	mv	a5,a0
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
ffffffffc02011dc:	5675                	li	a2,-3
ffffffffc02011de:	8b05                	andi	a4,a4,1
ffffffffc02011e0:	e709                	bnez	a4,ffffffffc02011ea <best_fit_init_memmap+0x26>
ffffffffc02011e2:	a85d                	j	ffffffffc0201298 <best_fit_init_memmap+0xd4>
    return (((*(volatile unsigned long *)addr) >> nr) & 1);
ffffffffc02011e4:	6798                	ld	a4,8(a5)
ffffffffc02011e6:	8b05                	andi	a4,a4,1
ffffffffc02011e8:	cb45                	beqz	a4,ffffffffc0201298 <best_fit_init_memmap+0xd4>
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
ffffffffc02011ea:	00878713          	addi	a4,a5,8
ffffffffc02011ee:	60c7302f          	amoand.d	zero,a2,(a4)
        p->flags = p->property=0;
ffffffffc02011f2:	0007a823          	sw	zero,16(a5)
ffffffffc02011f6:	0007b423          	sd	zero,8(a5)
ffffffffc02011fa:	0007a023          	sw	zero,0(a5)
    for (; p != base + n; p ++) {
ffffffffc02011fe:	02878793          	addi	a5,a5,40
ffffffffc0201202:	fed791e3          	bne	a5,a3,ffffffffc02011e4 <best_fit_init_memmap+0x20>
    base->property = n;
ffffffffc0201206:	2581                	sext.w	a1,a1
ffffffffc0201208:	c90c                	sw	a1,16(a0)
    __op_bit(or, __NOP, nr, ((volatile unsigned long *)addr));
ffffffffc020120a:	4789                	li	a5,2
ffffffffc020120c:	00850713          	addi	a4,a0,8
ffffffffc0201210:	40f7302f          	amoor.d	zero,a5,(a4)
    nr_free += n;
ffffffffc0201214:	00005697          	auipc	a3,0x5
ffffffffc0201218:	22468693          	addi	a3,a3,548 # ffffffffc0206438 <free_area>
ffffffffc020121c:	4a98                	lw	a4,16(a3)
    return list->next == list;
ffffffffc020121e:	669c                	ld	a5,8(a3)
ffffffffc0201220:	9db9                	addw	a1,a1,a4
ffffffffc0201222:	00005717          	auipc	a4,0x5
ffffffffc0201226:	22b72323          	sw	a1,550(a4) # ffffffffc0206448 <free_area+0x10>
    if (list_empty(&free_list)) {
ffffffffc020122a:	04d78a63          	beq	a5,a3,ffffffffc020127e <best_fit_init_memmap+0xba>
            struct Page* page = le2page(le, page_link);
ffffffffc020122e:	fe878713          	addi	a4,a5,-24
ffffffffc0201232:	628c                	ld	a1,0(a3)
    if (list_empty(&free_list)) {
ffffffffc0201234:	4801                	li	a6,0
ffffffffc0201236:	01850613          	addi	a2,a0,24
            if (base < page) 
ffffffffc020123a:	00e56a63          	bltu	a0,a4,ffffffffc020124e <best_fit_init_memmap+0x8a>
    return listelm->next;
ffffffffc020123e:	6798                	ld	a4,8(a5)
            else if (list_next(le) == &free_list) 
ffffffffc0201240:	02d70563          	beq	a4,a3,ffffffffc020126a <best_fit_init_memmap+0xa6>
        while ((le = list_next(le)) != &free_list) {
ffffffffc0201244:	87ba                	mv	a5,a4
            struct Page* page = le2page(le, page_link);
ffffffffc0201246:	fe878713          	addi	a4,a5,-24
            if (base < page) 
ffffffffc020124a:	fee57ae3          	bleu	a4,a0,ffffffffc020123e <best_fit_init_memmap+0x7a>
ffffffffc020124e:	00080663          	beqz	a6,ffffffffc020125a <best_fit_init_memmap+0x96>
ffffffffc0201252:	00005717          	auipc	a4,0x5
ffffffffc0201256:	1eb73323          	sd	a1,486(a4) # ffffffffc0206438 <free_area>
    __list_add(elm, listelm->prev, listelm);
ffffffffc020125a:	6398                	ld	a4,0(a5)
}
ffffffffc020125c:	60a2                	ld	ra,8(sp)
    prev->next = next->prev = elm;
ffffffffc020125e:	e390                	sd	a2,0(a5)
ffffffffc0201260:	e710                	sd	a2,8(a4)
    elm->next = next;
ffffffffc0201262:	f11c                	sd	a5,32(a0)
    elm->prev = prev;
ffffffffc0201264:	ed18                	sd	a4,24(a0)
ffffffffc0201266:	0141                	addi	sp,sp,16
ffffffffc0201268:	8082                	ret
    prev->next = next->prev = elm;
ffffffffc020126a:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc020126c:	f114                	sd	a3,32(a0)
ffffffffc020126e:	6798                	ld	a4,8(a5)
    elm->prev = prev;
ffffffffc0201270:	ed1c                	sd	a5,24(a0)
                list_add(le, &(base->page_link));
ffffffffc0201272:	85b2                	mv	a1,a2
        while ((le = list_next(le)) != &free_list) {
ffffffffc0201274:	00d70e63          	beq	a4,a3,ffffffffc0201290 <best_fit_init_memmap+0xcc>
ffffffffc0201278:	4805                	li	a6,1
ffffffffc020127a:	87ba                	mv	a5,a4
ffffffffc020127c:	b7e9                	j	ffffffffc0201246 <best_fit_init_memmap+0x82>
}
ffffffffc020127e:	60a2                	ld	ra,8(sp)
        list_add(&free_list, &(base->page_link));
ffffffffc0201280:	01850713          	addi	a4,a0,24
    prev->next = next->prev = elm;
ffffffffc0201284:	e398                	sd	a4,0(a5)
ffffffffc0201286:	e798                	sd	a4,8(a5)
    elm->next = next;
ffffffffc0201288:	f11c                	sd	a5,32(a0)
    elm->prev = prev;
ffffffffc020128a:	ed1c                	sd	a5,24(a0)
}
...
ffffffffc0201294:	0141                	addi	sp,sp,16
ffffffffc0201296:	8082                	ret
        assert(PageReserved(p));
ffffffffc0201298:	00001697          	auipc	a3,0x1
ffffffffc020129c:	2c068693          	addi	a3,a3,704 # ffffffffc0202558 <commands+0x958>
ffffffffc02012a0:	00001617          	auipc	a2,0x1
ffffffffc02012a4:	f9860613          	addi	a2,a2,-104 # ffffffffc0202238 <commands+0x638>
ffffffffc02012a8:	04a00593          	li	a1,74
ffffffffc02012ac:	00001517          	auipc	a0,0x1
ffffffffc02012b0:	fa450513          	addi	a0,a0,-92 # ffffffffc0202250 <commands+0x650>
ffffffffc02012b4:	8f8ff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(n > 0);
ffffffffc02012b8:	00001697          	auipc	a3,0x1
ffffffffc02012bc:	f7868693          	addi	a3,a3,-136 # ffffffffc0202230 <commands+0x630>
ffffffffc02012c0:	00001617          	auipc	a2,0x1
ffffffffc02012c4:	f7860613          	addi	a2,a2,-136 # ffffffffc0202238 <commands+0x638>
ffffffffc02012c8:	04700593          	li	a1,71
ffffffffc02012cc:	00001517          	auipc	a0,0x1
ffffffffc02012d0:	f8450513          	addi	a0,a0,-124 # ffffffffc0202250 <commands+0x650>
ffffffffc02012d4:	8d8ff0ef          	jal	ra,ffffffffc02003ac <__panic>

ffffffffc02012d8 <alloc_pages>:
#include <defs.h>
#include <intr.h>
#include <riscv.h>
...
ffffffffc02012d8:	100027f3          	csrr	a5,sstatus
ffffffffc02012dc:	8b89                	andi	a5,a5,2
ffffffffc02012de:	eb89                	bnez	a5,ffffffffc02012f0 <alloc_pages+0x18>
...
ffffffffc02012e4:	17878793          	addi	a5,a5,376 # ffffffffc0206458 <pmm_manager>
ffffffffc02012e8:	639c                	ld	a5,0(a5)
ffffffffc02012ea:	0187b303          	ld	t1,24(a5)
ffffffffc02012ee:	8302                	jr	t1
struct Page *alloc_pages(size_t n) {
ffffffffc02012f0:	1141                	addi	sp,sp,-16
ffffffffc02012f2:	e406                	sd	ra,8(sp)
ffffffffc02012f4:	e022                	sd	s0,0(sp)
ffffffffc02012f6:	842a                	mv	s0,a0
        intr_disable();
ffffffffc02012f8:	96cff0ef          	jal	ra,ffffffffc0200464 <intr_disable>
        page = pmm_manager->alloc_pages(n);
ffffffffc02012fc:	00005797          	auipc	a5,0x5
ffffffffc0201300:	15c78793          	addi	a5,a5,348 # ffffffffc0206458 <pmm_manager>
ffffffffc0201304:	639c                	ld	a5,0(a5)
ffffffffc0201306:	8522                	mv	a0,s0
ffffffffc0201308:	6f9c                	ld	a5,24(a5)
ffffffffc020130a:	9782                	jalr	a5
...
static inline void __intr_restore(bool flag) {
    if (flag) {
        intr_enable();
ffffffffc020130e:	950ff0ef          	jal	ra,ffffffffc020045e <intr_enable>
    }
    local_intr_restore(intr_flag);
    return page;
}
ffffffffc0201312:	8522                	mv	a0,s0
ffffffffc0201314:	60a2                	ld	ra,8(sp)
ffffffffc0201316:	6402                	ld	s0,0(sp)
ffffffffc0201318:	0141                	addi	sp,sp,16
ffffffffc020131a:	8082                	ret

ffffffffc020131c <free_pages>:
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020131c:	100027f3          	csrr	a5,sstatus
ffffffffc0201320:	8b89                	andi	a5,a5,2
ffffffffc0201322:	eb89                	bnez	a5,ffffffffc0201334 <free_pages+0x18>
...
ffffffffc0201328:	13478793          	addi	a5,a5,308 # ffffffffc0206458 <pmm_manager>
ffffffffc020132c:	639c                	ld	a5,0(a5)
ffffffffc020132e:	0207b303          	ld	t1,32(a5)
ffffffffc0201332:	8302                	jr	t1
void free_pages(struct Page *base, size_t n) {
ffffffffc0201334:	1101                	addi	sp,sp,-32
ffffffffc0201336:	ec06                	sd	ra,24(sp)
ffffffffc0201338:	e822                	sd	s0,16(sp)
ffffffffc020133a:	e426                	sd	s1,8(sp)
ffffffffc020133c:	842a                	mv	s0,a0
ffffffffc020133e:	84ae                	mv	s1,a1
        intr_disable();
ffffffffc0201340:	924ff0ef          	jal	ra,ffffffffc0200464 <intr_disable>
        pmm_manager->free_pages(base, n);
ffffffffc0201344:	00005797          	auipc	a5,0x5
ffffffffc0201348:	11478793          	addi	a5,a5,276 # ffffffffc0206458 <pmm_manager>
ffffffffc020134c:	639c                	ld	a5,0(a5)
ffffffffc020134e:	85a6                	mv	a1,s1
ffffffffc0201350:	8522                	mv	a0,s0
ffffffffc0201352:	739c                	ld	a5,32(a5)
ffffffffc0201354:	9782                	jalr	a5
    }
    local_intr_restore(intr_flag);
}
ffffffffc0201356:	6442                	ld	s0,16(sp)
ffffffffc0201358:	60e2                	ld	ra,24(sp)
ffffffffc020135a:	64a2                	ld	s1,8(sp)
ffffffffc020135c:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc020135e:	900ff06f          	j	ffffffffc020045e <intr_enable>

ffffffffc0201362 <nr_free_pages>:
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0201362:	100027f3          	csrr	a5,sstatus
ffffffffc0201366:	8b89                	andi	a5,a5,2
ffffffffc0201368:	eb89                	bnez	a5,ffffffffc020137a <nr_free_pages+0x18>
...
ffffffffc0201374:	0287b303          	ld	t1,40(a5)
...
ffffffffc020137e:	e022                	sd	s0,0(sp)
        intr_disable();
ffffffffc0201380:	8e4ff0ef          	jal	ra,ffffffffc0200464 <intr_disable>
        ret = pmm_manager->nr_free_pages();
ffffffffc0201384:	00005797          	auipc	a5,0x5
ffffffffc0201388:	0d478793          	addi	a5,a5,212 # ffffffffc0206458 <pmm_manager>
...
ffffffffc0201392:	842a                	mv	s0,a0
        intr_enable();
ffffffffc0201394:	8caff0ef          	jal	ra,ffffffffc020045e <intr_enable>
    }
    local_intr_restore(intr_flag);
    return ret;
}
...
ffffffffc02013a2 <pmm_init>:
    pmm_manager = &best_fit_pmm_manager;
ffffffffc02013a2:	00001797          	auipc	a5,0x1
ffffffffc02013a6:	1c678793          	addi	a5,a5,454 # ffffffffc0202568 <best_fit_pmm_manager>
    cprintf("memory management: %s\n", pmm_manager->name);
ffffffffc02013aa:	638c                	ld	a1,0(a5)
...
ffffffffc02013b2:	20a50513          	addi	a0,a0,522 # ffffffffc02025b8 <best_fit_pmm_manager+0x50>
void pmm_init(void) {
ffffffffc02013b6:	ec06                	sd	ra,24(sp)
    pmm_manager = &best_fit_pmm_manager;
ffffffffc02013b8:	00005717          	auipc	a4,0x5
ffffffffc02013bc:	0af73023          	sd	a5,160(a4) # ffffffffc0206458 <pmm_manager>
void pmm_init(void) {
ffffffffc02013c0:	e822                	sd	s0,16(sp)
ffffffffc02013c2:	e426                	sd	s1,8(sp)
    pmm_manager = &best_fit_pmm_manager;
ffffffffc02013c4:	00005417          	auipc	s0,0x5
ffffffffc02013c8:	09440413          	addi	s0,s0,148 # ffffffffc0206458 <pmm_manager>
    cprintf("memory management: %s\n", pmm_manager->name);
ffffffffc02013cc:	cebfe0ef          	jal	ra,ffffffffc02000b6 <cprintf>
    pmm_manager->init();
ffffffffc02013d0:	601c                	ld	a5,0(s0)
ffffffffc02013d2:	679c                	ld	a5,8(a5)
ffffffffc02013d4:	9782                	jalr	a5
    va_pa_offset = PHYSICAL_MEMORY_OFFSET;
ffffffffc02013d6:	57f5                	li	a5,-3
ffffffffc02013d8:	07fa                	slli	a5,a5,0x1e
    cprintf("physcial memory map:\n");
ffffffffc02013da:	00001517          	auipc	a0,0x1
ffffffffc02013de:	1f650513          	addi	a0,a0,502 # ffffffffc02025d0 <best_fit_pmm_manager+0x68>
    va_pa_offset = PHYSICAL_MEMORY_OFFSET;
ffffffffc02013e2:	00005717          	auipc	a4,0x5
ffffffffc02013e6:	06f73f23          	sd	a5,126(a4) # ffffffffc0206460 <va_pa_offset>
    cprintf("physcial memory map:\n");
ffffffffc02013ea:	ccdfe0ef          	jal	ra,ffffffffc02000b6 <cprintf>
    cprintf("  memory: 0x%016lx, [0x%016lx, 0x%016lx].\n", mem_size, mem_begin,
ffffffffc02013ee:	46c5                	li	a3,17
ffffffffc02013f0:	06ee                	slli	a3,a3,0x1b
ffffffffc02013f2:	40100613          	li	a2,1025
ffffffffc02013f6:	16fd                	addi	a3,a3,-1
ffffffffc02013f8:	0656                	slli	a2,a2,0x15
ffffffffc02013fa:	07e005b7          	lui	a1,0x7e00
ffffffffc02013fe:	00001517          	auipc	a0,0x1
ffffffffc0201402:	1ea50513          	addi	a0,a0,490 # ffffffffc02025e8 <best_fit_pmm_manager+0x80>
ffffffffc0201406:	cb1fe0ef          	jal	ra,ffffffffc02000b6 <cprintf>
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc020140a:	777d                	lui	a4,0xfffff
ffffffffc020140c:	00006797          	auipc	a5,0x6
ffffffffc0201410:	06378793          	addi	a5,a5,99 # ffffffffc020746f <end+0xfff>
ffffffffc0201414:	8ff9                	and	a5,a5,a4
    npage = maxpa / PGSIZE;
ffffffffc0201416:	00088737          	lui	a4,0x88
ffffffffc020141a:	00005697          	auipc	a3,0x5
ffffffffc020141e:	fee6bf23          	sd	a4,-2(a3) # ffffffffc0206418 <npage>
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc0201422:	4601                	li	a2,0
ffffffffc0201424:	00005717          	auipc	a4,0x5
ffffffffc0201428:	04f73223          	sd	a5,68(a4) # ffffffffc0206468 <pages>
    for (size_t i = 0; i < npage - nbase; i++) {
ffffffffc020142c:	4681                	li	a3,0
ffffffffc020142e:	00005897          	auipc	a7,0x5
ffffffffc0201432:	fea88893          	addi	a7,a7,-22 # ffffffffc0206418 <npage>
ffffffffc0201436:	00005597          	auipc	a1,0x5
ffffffffc020143a:	03258593          	addi	a1,a1,50 # ffffffffc0206468 <pages>
ffffffffc020143e:	4805                	li	a6,1
ffffffffc0201440:	fff80537          	lui	a0,0xfff80
ffffffffc0201444:	a011                	j	ffffffffc0201448 <pmm_init+0xa6>
ffffffffc0201446:	619c                	ld	a5,0(a1)
        SetPageReserved(pages + i);
ffffffffc0201448:	97b2                	add	a5,a5,a2
ffffffffc020144a:	07a1                	addi	a5,a5,8
ffffffffc020144c:	4107b02f          	amoor.d	zero,a6,(a5)
    for (size_t i = 0; i < npage - nbase; i++) {
ffffffffc0201450:	0008b703          	ld	a4,0(a7)
ffffffffc0201454:	0685                	addi	a3,a3,1
ffffffffc0201456:	02860613          	addi	a2,a2,40
ffffffffc020145a:	00a707b3          	add	a5,a4,a0
ffffffffc020145e:	fef6e4e3          	bltu	a3,a5,ffffffffc0201446 <pmm_init+0xa4>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0201462:	6190                	ld	a2,0(a1)
ffffffffc0201464:	00271793          	slli	a5,a4,0x2
ffffffffc0201468:	97ba                	add	a5,a5,a4
ffffffffc020146a:	fec006b7          	lui	a3,0xfec00
ffffffffc020146e:	078e                	slli	a5,a5,0x3
ffffffffc0201470:	96b2                	add	a3,a3,a2
ffffffffc0201472:	96be                	add	a3,a3,a5
ffffffffc0201474:	c02007b7          	lui	a5,0xc0200
ffffffffc0201478:	08f6e863          	bltu	a3,a5,ffffffffc0201508 <pmm_init+0x166>
ffffffffc020147c:	00005497          	auipc	s1,0x5
ffffffffc0201480:	fe448493          	addi	s1,s1,-28 # ffffffffc0206460 <va_pa_offset>
ffffffffc0201484:	609c                	ld	a5,0(s1)
    if (freemem < mem_end) {
ffffffffc0201486:	45c5                	li	a1,17
ffffffffc0201488:	05ee                	slli	a1,a1,0x1b
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc020148a:	8e9d                	sub	a3,a3,a5
    if (freemem < mem_end) {
ffffffffc020148c:	04b6e963          	bltu	a3,a1,ffffffffc02014de <pmm_init+0x13c>
...
static void check_alloc_page(void) {
    pmm_manager->check();
ffffffffc0201490:	601c                	ld	a5,0(s0)
ffffffffc0201492:	7b9c                	ld	a5,48(a5)
ffffffffc0201494:	9782                	jalr	a5
    cprintf("check_alloc_page() succeeded!\n");
ffffffffc0201496:	00001517          	auipc	a0,0x1
ffffffffc020149a:	1ea50513          	addi	a0,a0,490 # ffffffffc0202680 <best_fit_pmm_manager+0x118>
ffffffffc020149e:	c19fe0ef          	jal	ra,ffffffffc02000b6 <cprintf>
    satp_virtual = (pte_t*)boot_page_table_sv39;
ffffffffc02014a2:	00004697          	auipc	a3,0x4
ffffffffc02014a6:	b5e68693          	addi	a3,a3,-1186 # ffffffffc0205000 <boot_page_table_sv39>
ffffffffc02014aa:	00005797          	auipc	a5,0x5
ffffffffc02014ae:	f6d7bb23          	sd	a3,-138(a5) # ffffffffc0206420 <satp_virtual>
    satp_physical = PADDR(satp_virtual);
ffffffffc02014b2:	c02007b7          	lui	a5,0xc0200
ffffffffc02014b6:	06f6e563          	bltu	a3,a5,ffffffffc0201520 <pmm_init+0x17e>
ffffffffc02014ba:	609c                	ld	a5,0(s1)
}
ffffffffc02014bc:	6442                	ld	s0,16(sp)
ffffffffc02014be:	60e2                	ld	ra,24(sp)
ffffffffc02014c0:	64a2                	ld	s1,8(sp)
    cprintf("satp virtual address: 0x%016lx\nsatp physical address: 0x%016lx\n", satp_virtual, satp_physical);
ffffffffc02014c2:	85b6                	mv	a1,a3
    satp_physical = PADDR(satp_virtual);
ffffffffc02014c4:	8e9d                	sub	a3,a3,a5
ffffffffc02014c6:	00005797          	auipc	a5,0x5
ffffffffc02014ca:	f8d7b523          	sd	a3,-118(a5) # ffffffffc0206450 <satp_physical>
    cprintf("satp virtual address: 0x%016lx\nsatp physical address: 0x%016lx\n", satp_virtual, satp_physical);
ffffffffc02014ce:	00001517          	auipc	a0,0x1
ffffffffc02014d2:	1d250513          	addi	a0,a0,466 # ffffffffc02026a0 <best_fit_pmm_manager+0x138>
ffffffffc02014d6:	8636                	mv	a2,a3
}
ffffffffc02014d8:	6105                	addi	sp,sp,32
    cprintf("satp virtual address: 0x%016lx\nsatp physical address: 0x%016lx\n", satp_virtual, satp_physical);
ffffffffc02014da:	bddfe06f          	j	ffffffffc02000b6 <cprintf>
    mem_begin = ROUNDUP(freemem, PGSIZE);
ffffffffc02014de:	6785                	lui	a5,0x1
ffffffffc02014e0:	17fd                	addi	a5,a5,-1
ffffffffc02014e2:	96be                	add	a3,a3,a5
...
static inline struct Page *pa2page(uintptr_t pa) {
    if (PPN(pa) >= npage) {
ffffffffc02014e8:	00c6d793          	srli	a5,a3,0xc
ffffffffc02014ec:	04e7f663          	bleu	a4,a5,ffffffffc0201538 <pmm_init+0x196>
    pmm_manager->init_memmap(base, n);
ffffffffc02014f0:	6018                	ld	a4,0(s0)
        panic("pa2page called with invalid pa");
    }
    return &pages[PPN(pa) - nbase];
ffffffffc02014f2:	97aa                	add	a5,a5,a0
ffffffffc02014f4:	00279513          	slli	a0,a5,0x2
ffffffffc02014f8:	953e                	add	a0,a0,a5
ffffffffc02014fa:	6b1c                	ld	a5,16(a4)
        init_memmap(pa2page(mem_begin), (mem_end - mem_begin) / PGSIZE);
ffffffffc02014fc:	8d95                	sub	a1,a1,a3
ffffffffc02014fe:	050e                	slli	a0,a0,0x3
    pmm_manager->init_memmap(base, n);
ffffffffc0201500:	81b1                	srli	a1,a1,0xc
ffffffffc0201502:	9532                	add	a0,a0,a2
ffffffffc0201504:	9782                	jalr	a5
ffffffffc0201506:	b769                	j	ffffffffc0201490 <pmm_init+0xee>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0201508:	00001617          	auipc	a2,0x1
ffffffffc020150c:	11060613          	addi	a2,a2,272 # ffffffffc0202618 <best_fit_pmm_manager+0xb0>
ffffffffc0201510:	06f00593          	li	a1,111
ffffffffc0201514:	00001517          	auipc	a0,0x1
ffffffffc0201518:	12c50513          	addi	a0,a0,300 # ffffffffc0202640 <best_fit_pmm_manager+0xd8>
ffffffffc020151c:	e91fe0ef          	jal	ra,ffffffffc02003ac <__panic>
    satp_physical = PADDR(satp_virtual);
ffffffffc0201520:	00001617          	auipc	a2,0x1
ffffffffc0201524:	0f860613          	addi	a2,a2,248 # ffffffffc0202618 <best_fit_pmm_manager+0xb0>
ffffffffc0201528:	08a00593          	li	a1,138
ffffffffc020152c:	00001517          	auipc	a0,0x1
ffffffffc0201530:	11450513          	addi	a0,a0,276 # ffffffffc0202640 <best_fit_pmm_manager+0xd8>
ffffffffc0201534:	e79fe0ef          	jal	ra,ffffffffc02003ac <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201538:	00001617          	auipc	a2,0x1
ffffffffc020153c:	11860613          	addi	a2,a2,280 # ffffffffc0202650 <best_fit_pmm_manager+0xe8>
ffffffffc0201540:	06b00593          	li	a1,107
ffffffffc0201544:	00001517          	auipc	a0,0x1
ffffffffc0201548:	12c50513          	addi	a0,a0,300 # ffffffffc0202670 <best_fit_pmm_manager+0x108>
ffffffffc020154c:	e61fe0ef          	jal	ra,ffffffffc02003ac <__panic>

ffffffffc0201550 <printnum>:
 * */
static void
...
ffffffffc0201550:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0201554:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0201556:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020155a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020155c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0201560:	f022                	sd	s0,32(sp)
ffffffffc0201562:	ec26                	sd	s1,24(sp)
ffffffffc0201564:	e84a                	sd	s2,16(sp)
ffffffffc0201566:	f406                	sd	ra,40(sp)
ffffffffc0201568:	e44e                	sd	s3,8(sp)
ffffffffc020156a:	84aa                	mv	s1,a0
ffffffffc020156c:	892e                	mv	s2,a1
ffffffffc020156e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0201572:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0201574:	03067e63          	bleu	a6,a2,ffffffffc02015b0 <printnum+0x60>
ffffffffc0201578:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc020157a:	00805763          	blez	s0,ffffffffc0201588 <printnum+0x38>
ffffffffc020157e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0201580:	85ca                	mv	a1,s2
ffffffffc0201582:	854e                	mv	a0,s3
ffffffffc0201584:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0201586:	fc65                	bnez	s0,ffffffffc020157e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0201588:	1a02                	slli	s4,s4,0x20
ffffffffc020158a:	020a5a13          	srli	s4,s4,0x20
ffffffffc020158e:	00001797          	auipc	a5,0x1
ffffffffc0201592:	2e278793          	addi	a5,a5,738 # ffffffffc0202870 <error_string+0x38>
ffffffffc0201596:	9a3e                	add	s4,s4,a5
}
ffffffffc0201598:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020159a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc020159e:	70a2                	ld	ra,40(sp)
ffffffffc02015a0:	69a2                	ld	s3,8(sp)
ffffffffc02015a2:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02015a4:	85ca                	mv	a1,s2
ffffffffc02015a6:	8326                	mv	t1,s1
}
ffffffffc02015a8:	6942                	ld	s2,16(sp)
ffffffffc02015aa:	64e2                	ld	s1,24(sp)
ffffffffc02015ac:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02015ae:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02015b0:	03065633          	divu	a2,a2,a6
ffffffffc02015b4:	8722                	mv	a4,s0
ffffffffc02015b6:	f9bff0ef          	jal	ra,ffffffffc0201550 <printnum>
ffffffffc02015ba:	b7f9                	j	ffffffffc0201588 <printnum+0x38>

ffffffffc02015bc <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02015bc:	7119                	addi	sp,sp,-128
ffffffffc02015be:	f4a6                	sd	s1,104(sp)
ffffffffc02015c0:	f0ca                	sd	s2,96(sp)
ffffffffc02015c2:	e8d2                	sd	s4,80(sp)
ffffffffc02015c4:	e4d6                	sd	s5,72(sp)
ffffffffc02015c6:	e0da                	sd	s6,64(sp)
ffffffffc02015c8:	fc5e                	sd	s7,56(sp)
ffffffffc02015ca:	f862                	sd	s8,48(sp)
ffffffffc02015cc:	f06a                	sd	s10,32(sp)
ffffffffc02015ce:	fc86                	sd	ra,120(sp)
ffffffffc02015d0:	f8a2                	sd	s0,112(sp)
ffffffffc02015d2:	ecce                	sd	s3,88(sp)
ffffffffc02015d4:	f466                	sd	s9,40(sp)
ffffffffc02015d6:	ec6e                	sd	s11,24(sp)
ffffffffc02015d8:	892a                	mv	s2,a0
ffffffffc02015da:	84ae                	mv	s1,a1
ffffffffc02015dc:	8d32                	mv	s10,a2
ffffffffc02015de:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02015e0:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02015e2:	00001a17          	auipc	s4,0x1
ffffffffc02015e6:	0fea0a13          	addi	s4,s4,254 # ffffffffc02026e0 <best_fit_pmm_manager+0x178>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02015ea:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02015ee:	00001c17          	auipc	s8,0x1
ffffffffc02015f2:	24ac0c13          	addi	s8,s8,586 # ffffffffc0202838 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02015f6:	000d4503          	lbu	a0,0(s10)
ffffffffc02015fa:	02500793          	li	a5,37
ffffffffc02015fe:	001d0413          	addi	s0,s10,1
ffffffffc0201602:	00f50e63          	beq	a0,a5,ffffffffc020161e <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0201606:	c521                	beqz	a0,ffffffffc020164e <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0201608:	02500993          	li	s3,37
ffffffffc020160c:	a011                	j	ffffffffc0201610 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc020160e:	c121                	beqz	a0,ffffffffc020164e <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0201610:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0201612:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0201614:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0201616:	fff44503          	lbu	a0,-1(s0)
ffffffffc020161a:	ff351ae3          	bne	a0,s3,ffffffffc020160e <vprintfmt+0x52>
ffffffffc020161e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0201622:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0201626:	4981                	li	s3,0
ffffffffc0201628:	4801                	li	a6,0
        width = precision = -1;
ffffffffc020162a:	5cfd                	li	s9,-1
ffffffffc020162c:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020162e:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0201632:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201634:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0201638:	0ff6f693          	andi	a3,a3,255
ffffffffc020163c:	00140d13          	addi	s10,s0,1
ffffffffc0201640:	20d5e563          	bltu	a1,a3,ffffffffc020184a <vprintfmt+0x28e>
ffffffffc0201644:	068a                	slli	a3,a3,0x2
ffffffffc0201646:	96d2                	add	a3,a3,s4
ffffffffc0201648:	4294                	lw	a3,0(a3)
ffffffffc020164a:	96d2                	add	a3,a3,s4
ffffffffc020164c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020164e:	70e6                	ld	ra,120(sp)
ffffffffc0201650:	7446                	ld	s0,112(sp)
ffffffffc0201652:	74a6                	ld	s1,104(sp)
ffffffffc0201654:	7906                	ld	s2,96(sp)
ffffffffc0201656:	69e6                	ld	s3,88(sp)
ffffffffc0201658:	6a46                	ld	s4,80(sp)
ffffffffc020165a:	6aa6                	ld	s5,72(sp)
ffffffffc020165c:	6b06                	ld	s6,64(sp)
ffffffffc020165e:	7be2                	ld	s7,56(sp)
ffffffffc0201660:	7c42                	ld	s8,48(sp)
ffffffffc0201662:	7ca2                	ld	s9,40(sp)
ffffffffc0201664:	7d02                	ld	s10,32(sp)
ffffffffc0201666:	6de2                	ld	s11,24(sp)
ffffffffc0201668:	6109                	addi	sp,sp,128
ffffffffc020166a:	8082                	ret
    if (lflag >= 2) {
ffffffffc020166c:	4705                	li	a4,1
ffffffffc020166e:	008a8593          	addi	a1,s5,8
ffffffffc0201672:	01074463          	blt	a4,a6,ffffffffc020167a <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0201676:	26080363          	beqz	a6,ffffffffc02018dc <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc020167a:	000ab603          	ld	a2,0(s5)
ffffffffc020167e:	46c1                	li	a3,16
ffffffffc0201680:	8aae                	mv	s5,a1
ffffffffc0201682:	a06d                	j	ffffffffc020172c <vprintfmt+0x170>
            goto reswitch;
...
ffffffffc020168a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020168c:	b765                	j	ffffffffc0201634 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc020168e:	000aa503          	lw	a0,0(s5)
ffffffffc0201692:	85a6                	mv	a1,s1
ffffffffc0201694:	0aa1                	addi	s5,s5,8
ffffffffc0201696:	9902                	jalr	s2
            break;
ffffffffc0201698:	bfb9                	j	ffffffffc02015f6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020169a:	4705                	li	a4,1
ffffffffc020169c:	008a8993          	addi	s3,s5,8
ffffffffc02016a0:	01074463          	blt	a4,a6,ffffffffc02016a8 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc02016a4:	22080463          	beqz	a6,ffffffffc02018cc <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc02016a8:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc02016ac:	24044463          	bltz	s0,ffffffffc02018f4 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc02016b0:	8622                	mv	a2,s0
ffffffffc02016b2:	8ace                	mv	s5,s3
ffffffffc02016b4:	46a9                	li	a3,10
ffffffffc02016b6:	a89d                	j	ffffffffc020172c <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc02016b8:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02016bc:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc02016be:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc02016c0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02016c4:	8fb5                	xor	a5,a5,a3
ffffffffc02016c6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02016ca:	1ad74363          	blt	a4,a3,ffffffffc0201870 <vprintfmt+0x2b4>
ffffffffc02016ce:	00369793          	slli	a5,a3,0x3
ffffffffc02016d2:	97e2                	add	a5,a5,s8
ffffffffc02016d4:	639c                	ld	a5,0(a5)
ffffffffc02016d6:	18078d63          	beqz	a5,ffffffffc0201870 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc02016da:	86be                	mv	a3,a5
ffffffffc02016dc:	00001617          	auipc	a2,0x1
ffffffffc02016e0:	24460613          	addi	a2,a2,580 # ffffffffc0202920 <error_string+0xe8>
ffffffffc02016e4:	85a6                	mv	a1,s1
ffffffffc02016e6:	854a                	mv	a0,s2
ffffffffc02016e8:	240000ef          	jal	ra,ffffffffc0201928 <printfmt>
ffffffffc02016ec:	b729                	j	ffffffffc02015f6 <vprintfmt+0x3a>
            lflag ++;
ffffffffc02016ee:	00144603          	lbu	a2,1(s0)
ffffffffc02016f2:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02016f4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02016f6:	bf3d                	j	ffffffffc0201634 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc02016f8:	4705                	li	a4,1
ffffffffc02016fa:	008a8593          	addi	a1,s5,8
ffffffffc02016fe:	01074463          	blt	a4,a6,ffffffffc0201706 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0201702:	1e080263          	beqz	a6,ffffffffc02018e6 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0201706:	000ab603          	ld	a2,0(s5)
ffffffffc020170a:	46a1                	li	a3,8
ffffffffc020170c:	8aae                	mv	s5,a1
ffffffffc020170e:	a839                	j	ffffffffc020172c <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0201710:	03000513          	li	a0,48
...
ffffffffc020171c:	07800513          	li	a0,120
ffffffffc0201720:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0201722:	0aa1                	addi	s5,s5,8
ffffffffc0201724:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0201728:	6782                	ld	a5,0(sp)
ffffffffc020172a:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020172c:	876e                	mv	a4,s11
ffffffffc020172e:	85a6                	mv	a1,s1
ffffffffc0201730:	854a                	mv	a0,s2
ffffffffc0201732:	e1fff0ef          	jal	ra,ffffffffc0201550 <printnum>
            break;
ffffffffc0201736:	b5c1                	j	ffffffffc02015f6 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0201738:	000ab603          	ld	a2,0(s5)
ffffffffc020173c:	0aa1                	addi	s5,s5,8
ffffffffc020173e:	1c060663          	beqz	a2,ffffffffc020190a <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0201742:	00160413          	addi	s0,a2,1
ffffffffc0201746:	17b05c63          	blez	s11,ffffffffc02018be <vprintfmt+0x302>
ffffffffc020174a:	02d00593          	li	a1,45
ffffffffc020174e:	14b79263          	bne	a5,a1,ffffffffc0201892 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0201752:	00064783          	lbu	a5,0(a2)
ffffffffc0201756:	0007851b          	sext.w	a0,a5
ffffffffc020175a:	c905                	beqz	a0,ffffffffc020178a <vprintfmt+0x1ce>
ffffffffc020175c:	000cc563          	bltz	s9,ffffffffc0201766 <vprintfmt+0x1aa>
ffffffffc0201760:	3cfd                	addiw	s9,s9,-1
ffffffffc0201762:	036c8263          	beq	s9,s6,ffffffffc0201786 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0201766:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0201768:	18098463          	beqz	s3,ffffffffc02018f0 <vprintfmt+0x334>
ffffffffc020176c:	3781                	addiw	a5,a5,-32
ffffffffc020176e:	18fbf163          	bleu	a5,s7,ffffffffc02018f0 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0201772:	03f00513          	li	a0,63
...
ffffffffc0201780:	0007851b          	sext.w	a0,a5
ffffffffc0201784:	fd61                	bnez	a0,ffffffffc020175c <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0201786:	e7b058e3          	blez	s11,ffffffffc02015f6 <vprintfmt+0x3a>
...
ffffffffc0201792:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0201794:	e60d81e3          	beqz	s11,ffffffffc02015f6 <vprintfmt+0x3a>
...
ffffffffc02017a0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02017a2:	fe0d94e3          	bnez	s11,ffffffffc020178a <vprintfmt+0x1ce>
ffffffffc02017a6:	bd81                	j	ffffffffc02015f6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02017a8:	4705                	li	a4,1
ffffffffc02017aa:	008a8593          	addi	a1,s5,8
ffffffffc02017ae:	01074463          	blt	a4,a6,ffffffffc02017b6 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc02017b2:	12080063          	beqz	a6,ffffffffc02018d2 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc02017b6:	000ab603          	ld	a2,0(s5)
ffffffffc02017ba:	46a9                	li	a3,10
ffffffffc02017bc:	8aae                	mv	s5,a1
ffffffffc02017be:	b7bd                	j	ffffffffc020172c <vprintfmt+0x170>
ffffffffc02017c0:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc02017c4:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02017c8:	846a                	mv	s0,s10
ffffffffc02017ca:	b5ad                	j	ffffffffc0201634 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc02017cc:	85a6                	mv	a1,s1
ffffffffc02017ce:	02500513          	li	a0,37
ffffffffc02017d2:	9902                	jalr	s2
            break;
ffffffffc02017d4:	b50d                	j	ffffffffc02015f6 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc02017d6:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc02017da:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02017de:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02017e0:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc02017e2:	e40dd9e3          	bgez	s11,ffffffffc0201634 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc02017e6:	8de6                	mv	s11,s9
ffffffffc02017e8:	5cfd                	li	s9,-1
ffffffffc02017ea:	b5a9                	j	ffffffffc0201634 <vprintfmt+0x78>
            goto reswitch;
ffffffffc02017ec:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc02017f0:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02017f4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02017f6:	bd3d                	j	ffffffffc0201634 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc02017f8:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc02017fc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201800:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0201802:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0201806:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020180a:	fcd56ce3          	bltu	a0,a3,ffffffffc02017e2 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc020180e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0201810:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0201814:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0201818:	0196873b          	addw	a4,a3,s9
ffffffffc020181c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0201820:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0201824:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0201828:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc020182c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0201830:	fcd57fe3          	bleu	a3,a0,ffffffffc020180e <vprintfmt+0x252>
ffffffffc0201834:	b77d                	j	ffffffffc02017e2 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0201836:	fffdc693          	not	a3,s11
ffffffffc020183a:	96fd                	srai	a3,a3,0x3f
ffffffffc020183c:	00ddfdb3          	and	s11,s11,a3
ffffffffc0201840:	00144603          	lbu	a2,1(s0)
ffffffffc0201844:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201846:	846a                	mv	s0,s10
ffffffffc0201848:	b3f5                	j	ffffffffc0201634 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc020184a:	85a6                	mv	a1,s1
ffffffffc020184c:	02500513          	li	a0,37
ffffffffc0201850:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0201852:	fff44703          	lbu	a4,-1(s0)
ffffffffc0201856:	02500793          	li	a5,37
ffffffffc020185a:	8d22                	mv	s10,s0
ffffffffc020185c:	d8f70de3          	beq	a4,a5,ffffffffc02015f6 <vprintfmt+0x3a>
ffffffffc0201860:	02500713          	li	a4,37
ffffffffc0201864:	1d7d                	addi	s10,s10,-1
ffffffffc0201866:	fffd4783          	lbu	a5,-1(s10)
ffffffffc020186a:	fee79de3          	bne	a5,a4,ffffffffc0201864 <vprintfmt+0x2a8>
ffffffffc020186e:	b361                	j	ffffffffc02015f6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0201870:	00001617          	auipc	a2,0x1
ffffffffc0201874:	0a060613          	addi	a2,a2,160 # ffffffffc0202910 <error_string+0xd8>
ffffffffc0201878:	85a6                	mv	a1,s1
ffffffffc020187a:	854a                	mv	a0,s2
ffffffffc020187c:	0ac000ef          	jal	ra,ffffffffc0201928 <printfmt>
ffffffffc0201880:	bb9d                	j	ffffffffc02015f6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0201882:	00001617          	auipc	a2,0x1
ffffffffc0201886:	08660613          	addi	a2,a2,134 # ffffffffc0202908 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc020188a:	00001417          	auipc	s0,0x1
ffffffffc020188e:	07f40413          	addi	s0,s0,127 # ffffffffc0202909 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0201892:	8532                	mv	a0,a2
ffffffffc0201894:	85e6                	mv	a1,s9
ffffffffc0201896:	e032                	sd	a2,0(sp)
ffffffffc0201898:	e43e                	sd	a5,8(sp)
ffffffffc020189a:	1c2000ef          	jal	ra,ffffffffc0201a5c <strnlen>
ffffffffc020189e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02018a2:	6602                	ld	a2,0(sp)
ffffffffc02018a4:	01b05d63          	blez	s11,ffffffffc02018be <vprintfmt+0x302>
ffffffffc02018a8:	67a2                	ld	a5,8(sp)
ffffffffc02018aa:	2781                	sext.w	a5,a5
ffffffffc02018ac:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02018ae:	6522                	ld	a0,8(sp)
ffffffffc02018b0:	85a6                	mv	a1,s1
ffffffffc02018b2:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc02018ba:	fe0d9ae3          	bnez	s11,ffffffffc02018ae <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02018be:	00064783          	lbu	a5,0(a2)
ffffffffc02018c2:	0007851b          	sext.w	a0,a5
ffffffffc02018c6:	e8051be3          	bnez	a0,ffffffffc020175c <vprintfmt+0x1a0>
ffffffffc02018ca:	b335                	j	ffffffffc02015f6 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02018cc:	000aa403          	lw	s0,0(s5)
ffffffffc02018d0:	bbf1                	j	ffffffffc02016ac <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02018d2:	000ae603          	lwu	a2,0(s5)
ffffffffc02018d6:	46a9                	li	a3,10
ffffffffc02018d8:	8aae                	mv	s5,a1
ffffffffc02018da:	bd89                	j	ffffffffc020172c <vprintfmt+0x170>
ffffffffc02018dc:	000ae603          	lwu	a2,0(s5)
ffffffffc02018e0:	46c1                	li	a3,16
ffffffffc02018e2:	8aae                	mv	s5,a1
ffffffffc02018e4:	b5a1                	j	ffffffffc020172c <vprintfmt+0x170>
ffffffffc02018e6:	000ae603          	lwu	a2,0(s5)
ffffffffc02018ea:	46a1                	li	a3,8
ffffffffc02018ec:	8aae                	mv	s5,a1
ffffffffc02018ee:	bd3d                	j	ffffffffc020172c <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02018f0:	9902                	jalr	s2
ffffffffc02018f2:	b559                	j	ffffffffc0201778 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02018f4:	85a6                	mv	a1,s1
ffffffffc02018f6:	02d00513          	li	a0,45
ffffffffc02018fa:	e03e                	sd	a5,0(sp)
ffffffffc02018fc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02018fe:	8ace                	mv	s5,s3
ffffffffc0201900:	40800633          	neg	a2,s0
ffffffffc0201904:	46a9                	li	a3,10
ffffffffc0201906:	6782                	ld	a5,0(sp)
ffffffffc0201908:	b515                	j	ffffffffc020172c <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc020190a:	01b05663          	blez	s11,ffffffffc0201916 <vprintfmt+0x35a>
ffffffffc020190e:	02d00693          	li	a3,45
ffffffffc0201912:	f6d798e3          	bne	a5,a3,ffffffffc0201882 <vprintfmt+0x2c6>
ffffffffc0201916:	00001417          	auipc	s0,0x1
ffffffffc020191a:	ff340413          	addi	s0,s0,-13 # ffffffffc0202909 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020191e:	02800513          	li	a0,40
ffffffffc0201922:	02800793          	li	a5,40
ffffffffc0201926:	bd1d                	j	ffffffffc020175c <vprintfmt+0x1a0>

ffffffffc0201928 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0201928:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020192a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020192e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0201930:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0201932:	ec06                	sd	ra,24(sp)
ffffffffc0201934:	f83a                	sd	a4,48(sp)
ffffffffc0201936:	fc3e                	sd	a5,56(sp)
ffffffffc0201938:	e0c2                	sd	a6,64(sp)
ffffffffc020193a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020193c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020193e:	c7fff0ef          	jal	ra,ffffffffc02015bc <vprintfmt>
}
ffffffffc0201942:	60e2                	ld	ra,24(sp)
ffffffffc0201944:	6161                	addi	sp,sp,80
ffffffffc0201946:	8082                	ret

ffffffffc0201948 <readline>:
...
ffffffffc0201948:	715d                	addi	sp,sp,-80
ffffffffc020194a:	e486                	sd	ra,72(sp)
ffffffffc020194c:	e0a2                	sd	s0,64(sp)
ffffffffc020194e:	fc26                	sd	s1,56(sp)
ffffffffc0201950:	f84a                	sd	s2,48(sp)
ffffffffc0201952:	f44e                	sd	s3,40(sp)
ffffffffc0201954:	f052                	sd	s4,32(sp)
ffffffffc0201956:	ec56                	sd	s5,24(sp)
ffffffffc0201958:	e85a                	sd	s6,16(sp)
ffffffffc020195a:	e45e                	sd	s7,8(sp)
    if (prompt != NULL) {
ffffffffc020195c:	c901                	beqz	a0,ffffffffc020196c <readline+0x24>
        cprintf("%s", prompt);
ffffffffc020195e:	85aa                	mv	a1,a0
ffffffffc0201960:	00001517          	auipc	a0,0x1
ffffffffc0201964:	fc050513          	addi	a0,a0,-64 # ffffffffc0202920 <error_string+0xe8>
ffffffffc0201968:	f4efe0ef          	jal	ra,ffffffffc02000b6 <cprintf>
readline(const char *prompt) {
...
ffffffffc020196e:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0201970:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0201972:	4aa9                	li	s5,10
ffffffffc0201974:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0201976:	00004b97          	auipc	s7,0x4
ffffffffc020197a:	69ab8b93          	addi	s7,s7,1690 # ffffffffc0206010 <edata>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020197e:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0201982:	facfe0ef          	jal	ra,ffffffffc020012e <getchar>
ffffffffc0201986:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc0201988:	00054b63          	bltz	a0,ffffffffc020199e <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020198c:	00a95b63          	ble	a0,s2,ffffffffc02019a2 <readline+0x5a>
ffffffffc0201990:	029a5463          	ble	s1,s4,ffffffffc02019b8 <readline+0x70>
        c = getchar();
ffffffffc0201994:	f9afe0ef          	jal	ra,ffffffffc020012e <getchar>
ffffffffc0201998:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc020199a:	fe0559e3          	bgez	a0,ffffffffc020198c <readline+0x44>
            return NULL;
ffffffffc020199e:	4501                	li	a0,0
ffffffffc02019a0:	a099                	j	ffffffffc02019e6 <readline+0x9e>
        else if (c == '\b' && i > 0) {
ffffffffc02019a2:	03341463          	bne	s0,s3,ffffffffc02019ca <readline+0x82>
ffffffffc02019a6:	e8b9                	bnez	s1,ffffffffc02019fc <readline+0xb4>
        c = getchar();
ffffffffc02019a8:	f86fe0ef          	jal	ra,ffffffffc020012e <getchar>
ffffffffc02019ac:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02019ae:	fe0548e3          	bltz	a0,ffffffffc020199e <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02019b2:	fea958e3          	ble	a0,s2,ffffffffc02019a2 <readline+0x5a>
ffffffffc02019b6:	4481                	li	s1,0
            cputchar(c);
ffffffffc02019b8:	8522                	mv	a0,s0
ffffffffc02019ba:	f30fe0ef          	jal	ra,ffffffffc02000ea <cputchar>
            buf[i ++] = c;
ffffffffc02019be:	009b87b3          	add	a5,s7,s1
ffffffffc02019c2:	00878023          	sb	s0,0(a5)
ffffffffc02019c6:	2485                	addiw	s1,s1,1
ffffffffc02019c8:	bf6d                	j	ffffffffc0201982 <readline+0x3a>
        else if (c == '\n' || c == '\r') {
ffffffffc02019ca:	01540463          	beq	s0,s5,ffffffffc02019d2 <readline+0x8a>
ffffffffc02019ce:	fb641ae3          	bne	s0,s6,ffffffffc0201982 <readline+0x3a>
            cputchar(c);
ffffffffc02019d2:	8522                	mv	a0,s0
ffffffffc02019d4:	f16fe0ef          	jal	ra,ffffffffc02000ea <cputchar>
            buf[i] = '\0';
ffffffffc02019d8:	00004517          	auipc	a0,0x4
ffffffffc02019dc:	63850513          	addi	a0,a0,1592 # ffffffffc0206010 <edata>
...
ffffffffc02019e8:	6406                	ld	s0,64(sp)
ffffffffc02019ea:	74e2                	ld	s1,56(sp)
ffffffffc02019ec:	7942                	ld	s2,48(sp)
ffffffffc02019ee:	79a2                	ld	s3,40(sp)
ffffffffc02019f0:	7a02                	ld	s4,32(sp)
ffffffffc02019f2:	6ae2                	ld	s5,24(sp)
ffffffffc02019f4:	6b42                	ld	s6,16(sp)
ffffffffc02019f6:	6ba2                	ld	s7,8(sp)
ffffffffc02019f8:	6161                	addi	sp,sp,80
ffffffffc02019fa:	8082                	ret
            cputchar(c);
ffffffffc02019fc:	4521                	li	a0,8
ffffffffc02019fe:	eecfe0ef          	jal	ra,ffffffffc02000ea <cputchar>
            i --;
ffffffffc0201a02:	34fd                	addiw	s1,s1,-1
ffffffffc0201a04:	bfbd                	j	ffffffffc0201982 <readline+0x3a>

ffffffffc0201a06 <sbi_console_putchar>:
    );
    return ret_val;
}
...
ffffffffc0201a06:	00004797          	auipc	a5,0x4
ffffffffc0201a0a:	60278793          	addi	a5,a5,1538 # ffffffffc0206008 <SBI_CONSOLE_PUTCHAR>
    __asm__ volatile (
ffffffffc0201a0e:	6398                	ld	a4,0(a5)
ffffffffc0201a10:	4781                	li	a5,0
...
ffffffffc0201a22:	00005797          	auipc	a5,0x5
ffffffffc0201a26:	a0678793          	addi	a5,a5,-1530 # ffffffffc0206428 <SBI_SET_TIMER>
    __asm__ volatile (
ffffffffc0201a2a:	6398                	ld	a4,0(a5)
ffffffffc0201a2c:	4781                	li	a5,0
...
ffffffffc0201a42:	5c278793          	addi	a5,a5,1474 # ffffffffc0206000 <SBI_CONSOLE_GETCHAR>
    __asm__ volatile (
ffffffffc0201a46:	639c                	ld	a5,0(a5)
ffffffffc0201a48:	4501                	li	a0,0
ffffffffc0201a4a:	88be                	mv	a7,a5
ffffffffc0201a4c:	852a                	mv	a0,a0
ffffffffc0201a4e:	85aa                	mv	a1,a0
ffffffffc0201a50:	862a                	mv	a2,a0
ffffffffc0201a52:	00000073          	ecall
ffffffffc0201a56:	852a                	mv	a0,a0
ffffffffc0201a58:	2501                	sext.w	a0,a0
ffffffffc0201a5a:	8082                	ret

ffffffffc0201a5c <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0201a5c:	c185                	beqz	a1,ffffffffc0201a7c <strnlen+0x20>
ffffffffc0201a5e:	00054783          	lbu	a5,0(a0)
ffffffffc0201a62:	cf89                	beqz	a5,ffffffffc0201a7c <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0201a64:	4781                	li	a5,0
ffffffffc0201a66:	a021                	j	ffffffffc0201a6e <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0201a68:	00074703          	lbu	a4,0(a4)
ffffffffc0201a6c:	c711                	beqz	a4,ffffffffc0201a78 <strnlen+0x1c>
        cnt ++;
ffffffffc0201a6e:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0201a70:	00f50733          	add	a4,a0,a5
ffffffffc0201a74:	fef59ae3          	bne	a1,a5,ffffffffc0201a68 <strnlen+0xc>
    }
    return cnt;
}
...
ffffffffc0201a7e:	853e                	mv	a0,a5
ffffffffc0201a80:	8082                	ret

ffffffffc0201a82 <strcmp>:
int
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0201a82:	00054783          	lbu	a5,0(a0)
ffffffffc0201a86:	0005c703          	lbu	a4,0(a1)
ffffffffc0201a8a:	cb91                	beqz	a5,ffffffffc0201a9e <strcmp+0x1c>
ffffffffc0201a8c:	00e79c63          	bne	a5,a4,ffffffffc0201aa4 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0201a90:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0201a92:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc0201a96:	0585                	addi	a1,a1,1
ffffffffc0201a98:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0201a9c:	fbe5                	bnez	a5,ffffffffc0201a8c <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0201a9e:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0201aa0:	9d19                	subw	a0,a0,a4
ffffffffc0201aa2:	8082                	ret
ffffffffc0201aa4:	0007851b          	sext.w	a0,a5
ffffffffc0201aa8:	9d19                	subw	a0,a0,a4
ffffffffc0201aaa:	8082                	ret

ffffffffc0201aac <strchr>:
...
ffffffffc0201ab0:	cb91                	beqz	a5,ffffffffc0201ac4 <strchr+0x18>
        if (*s == c) {
ffffffffc0201ab2:	00b79563          	bne	a5,a1,ffffffffc0201abc <strchr+0x10>
ffffffffc0201ab6:	a809                	j	ffffffffc0201ac8 <strchr+0x1c>
ffffffffc0201ab8:	00b78763          	beq	a5,a1,ffffffffc0201ac6 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc0201abc:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0201abe:	00054783          	lbu	a5,0(a0)
ffffffffc0201ac2:	fbfd                	bnez	a5,ffffffffc0201ab8 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0201aca:	ca01                	beqz	a2,ffffffffc0201ada <memset+0x10>
ffffffffc0201acc:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0201ace:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0201ad0:	0785                	addi	a5,a5,1
ffffffffc0201ad2:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0201ad6:	fec79de3          	bne	a5,a2,ffffffffc0201ad0 <memset+0x6>
    }
    return s;
